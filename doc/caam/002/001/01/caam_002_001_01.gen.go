...
type ATMCommandParameters2Choice struct {
	ATMReqrdGblSts  ATMStatus1Code             `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 ATMReqrdGblSts,omitempty"`
	XpctdMsgFctn    MessageFunction8Code       `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 XpctdMsgFctn,omitempty"`
	ReqrdCfgtnParam ATMConfigurationParameter1 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 ReqrdCfgtnParam,omitempty"`
	ReqrdSctySchme  ATMSecurityScheme2Code     `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 ReqrdSctySchme,omitempty"`
	SctyDvc         ATMCommandParameters1      `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 SctyDvc,omitempty"`
	Key             ATMConfigurationParameter2 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 Key,omitempty"`
}
...
type GeographicLocation1Choice struct {
	GeogcCordints GeographicCoordinates1 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 GeogcCordints,omitempty"`
	UTMCordints   UTMCoordinates1        `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 UTMCordints,omitempty"`
}
...
type Recipient4Choice struct {
	KeyTrnsprt KeyTransport4  `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 KeyTrnsprt,omitempty"`
	KEK        KEK4           `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 KEK,omitempty"`
	KeyIdr     KEKIdentifier2 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 KeyIdr,omitempty"`
}
...
type Recipient5Choice struct {
	IssrAndSrlNb IssuerAndSerialNumber1 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 IssrAndSrlNb,omitempty"`
	KeyIdr       KEKIdentifier2         `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.01 KeyIdr,omitempty"`
}
