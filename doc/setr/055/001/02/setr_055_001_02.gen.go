...
type CancellationReason31Choice struct {
	Cd    ConfirmationCancellationReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.055.001.02 Cd,omitempty"`
	Prtry GenericIdentification47             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.055.001.02 Prtry,omitempty"`
}
...
type PartyIdentification90Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.055.001.02 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.055.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.055.001.02 NmAndAdr,omitempty"`
}
