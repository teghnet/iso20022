...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 PrtryIdSrc,omitempty"`
}
...
type CashAccountIdentification1Choice struct {
	IBAN     IBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 IBAN,omitempty"`
	BBAN     BBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 BBAN,omitempty"`
	UPIC     UPICIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 UPIC,omitempty"`
	DmstAcct SimpleIdentificationInformation `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 DmstAcct,omitempty"`
}

type Charge18 struct {
	Tp             ChargeType11Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Tp,omitempty"`
...
type ClearingSystemMemberIdentificationChoice struct {
	USCHU  CHIPSUniversalIdentifier                       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 USCHU,omitempty"`
	NZNCC  NewZealandNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 NZNCC,omitempty"`
	IENSC  IrishNSCIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 IENSC,omitempty"`
	GBSC   UKDomesticSortCodeIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 GBSC,omitempty"`
	USCH   CHIPSParticipantIdentifier                     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 USCH,omitempty"`
	CHBC   SwissBCIdentifier                              `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 CHBC,omitempty"`
	USFW   FedwireRoutingNumberIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 USFW,omitempty"`
	PTNCC  PortugueseNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 PTNCC,omitempty"`
	RUCB   RussianCentralBankIdentificationCodeIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 RUCB,omitempty"`
	ITNCC  ItalianDomesticIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 ITNCC,omitempty"`
	ATBLZ  AustrianBankleitzahlIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 ATBLZ,omitempty"`
	CACPA  CanadianPaymentsARNIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 CACPA,omitempty"`
	CHSIC  SwissSICIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 CHSIC,omitempty"`
	DEBLZ  GermanBankleitzahlIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 DEBLZ,omitempty"`
	ESNCC  SpanishDomesticInterbankingIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 ESNCC,omitempty"`
	ZANCC  SouthAfricanNCCIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 ZANCC,omitempty"`
	HKNCC  HongKongBankIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 HKNCC,omitempty"`
	AUBSBx ExtensiveBranchNetworkIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 AUBSBx,omitempty"`
	AUBSBs SmallNetworkIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 AUBSBs,omitempty"`
}
...
type CommissionWaiver3 struct {
	InstrBsis       WaivingInstruction1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 InstrBsis,omitempty"`
	XtndedInstrBsis Extended350Code         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 XtndedInstrBsis,omitempty"`
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 DtTm,omitempty"`
}
...
type FinancialInstitutionIdentification3Choice struct {
	NmAndAdr    NameAndAddress5                          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 NmAndAdr,omitempty"`
	BIC         BICIdentifier                            `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 BIC,omitempty"`
	ClrSysMmbId ClearingSystemMemberIdentificationChoice `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 ClrSysMmbId,omitempty"`
	PrtryId     SimpleIdentificationInformation          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 PrtryId,omitempty"`
}
...
type FundOrderType3 struct {
	OrdrTp       FundOrderType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 OrdrTp,omitempty"`
	XtndedOrdrTp Extended350Code    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 XtndedOrdrTp,omitempty"`
}
...
type GenericIdentification11 struct {
	Id         Max35Text                     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Id"`
	IdTp       PersonIdentificationType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 IdTp,omitempty"`
	XtndedIdTp Extended350Code               `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 XtndedIdTp,omitempty"`
	Issr       Max35Text                     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Issr,omitempty"`
}
...
type InvestmentFundsOrderBreakdown1 struct {
	OrdrBrkdwnTp       FundOrderType5Code      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 OrdrBrkdwnTp,omitempty"`
	XtndedOrdrBrkdwnTp Extended350Code         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 XtndedOrdrBrkdwnTp,omitempty"`
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 NmAndAdr,omitempty"`
}
...
type PaymentInstrument11Choice struct {
	CdtTrfDtls   CreditTransfer6     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 CdtTrfDtls,omitempty"`
	ChqDtls      Cheque3             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 ChqDtls,omitempty"`
	BkrsDrftDtls Cheque3             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 BkrsDrftDtls,omitempty"`
	CshAcctDtls  InvestmentAccount20 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 CshAcctDtls,omitempty"`
}
...
type PlaceOfTradeIdentification1Choice struct {
	...
	Xchg        MICIdentifier    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Xchg,omitempty"`
	Pty         AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Pty,omitempty"`
	OverTheCntr Max35Text        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 OverTheCntr,omitempty"`
}
...
type ProfitAndLoss1Choice struct {
	Prft ActiveCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Prft,omitempty"`
	Loss ActiveCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Loss,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 OthrPrtryId,omitempty"`
}
...
type Tax14 struct {
	Tp             TaxType11Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Tp,omitempty"`
	XtndedTp       Extended350Code                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 XtndedTp,omitempty"`
	Amt            ActiveCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Amt"`
	Rate           float64                          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Rate,omitempty"`
	Ctry           CountryCode                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Ctry,omitempty"`
...
type UnitPrice10 struct {
	Tp                         TypeOfPrice10Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 Tp,omitempty"`
	XtndedTp                   Extended350Code                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.003.001.03 XtndedTp,omitempty"`
