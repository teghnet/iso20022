...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 PrtryIdSrc,omitempty"`
}
...
type CashAccountIdentification1Choice struct {
	IBAN     IBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 IBAN,omitempty"`
	BBAN     BBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 BBAN,omitempty"`
	UPIC     UPICIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 UPIC,omitempty"`
	DmstAcct SimpleIdentificationInformation `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 DmstAcct,omitempty"`
}

type CashInOrOut6Choice struct {
	CshInPmtInstrm  PaymentInstrument12Choice `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CshInPmtInstrm,omitempty"`
	CshOutPmtInstrm PaymentInstrument11Choice `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CshOutPmtInstrm,omitempty"`
}

type Charge18 struct {
	Tp             ChargeType11Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Tp,omitempty"`
...
type ClearingSystemMemberIdentificationChoice struct {
	USCHU  CHIPSUniversalIdentifier                       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 USCHU,omitempty"`
	NZNCC  NewZealandNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 NZNCC,omitempty"`
	IENSC  IrishNSCIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 IENSC,omitempty"`
	GBSC   UKDomesticSortCodeIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 GBSC,omitempty"`
	USCH   CHIPSParticipantIdentifier                     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 USCH,omitempty"`
	CHBC   SwissBCIdentifier                              `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CHBC,omitempty"`
	USFW   FedwireRoutingNumberIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 USFW,omitempty"`
	PTNCC  PortugueseNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 PTNCC,omitempty"`
	RUCB   RussianCentralBankIdentificationCodeIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 RUCB,omitempty"`
	ITNCC  ItalianDomesticIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ITNCC,omitempty"`
	ATBLZ  AustrianBankleitzahlIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ATBLZ,omitempty"`
	CACPA  CanadianPaymentsARNIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CACPA,omitempty"`
	CHSIC  SwissSICIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CHSIC,omitempty"`
	DEBLZ  GermanBankleitzahlIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 DEBLZ,omitempty"`
	ESNCC  SpanishDomesticInterbankingIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ESNCC,omitempty"`
	ZANCC  SouthAfricanNCCIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ZANCC,omitempty"`
	HKNCC  HongKongBankIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 HKNCC,omitempty"`
	AUBSBx ExtensiveBranchNetworkIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 AUBSBx,omitempty"`
	AUBSBs SmallNetworkIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 AUBSBs,omitempty"`
}
...
type CommissionWaiver3 struct {
	InstrBsis       WaivingInstruction1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 InstrBsis,omitempty"`
	XtndedInstrBsis Extended350Code         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 XtndedInstrBsis,omitempty"`
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 DtTm,omitempty"`
}
...
type FinancialInstitutionIdentification3Choice struct {
	NmAndAdr    NameAndAddress5                          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 NmAndAdr,omitempty"`
	BIC         BICIdentifier                            `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 BIC,omitempty"`
	ClrSysMmbId ClearingSystemMemberIdentificationChoice `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ClrSysMmbId,omitempty"`
	PrtryId     SimpleIdentificationInformation          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 PrtryId,omitempty"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 NmAndAdr,omitempty"`
}
...
type PaymentInstrument11Choice struct {
	CdtTrfDtls   CreditTransfer6     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CdtTrfDtls,omitempty"`
	ChqDtls      Cheque3             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ChqDtls,omitempty"`
	BkrsDrftDtls Cheque3             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 BkrsDrftDtls,omitempty"`
	CshAcctDtls  InvestmentAccount20 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CshAcctDtls,omitempty"`
}

type PaymentInstrument12Choice struct {
	PmtCardDtls  PaymentCard2        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 PmtCardDtls,omitempty"`
	CdtTrfDtls   CreditTransfer6     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CdtTrfDtls,omitempty"`
	DrctDbtDtls  DirectDebitMandate4 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 DrctDbtDtls,omitempty"`
	ChqDtls      Cheque3             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ChqDtls,omitempty"`
	BkrsDrftDtls Cheque3             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 BkrsDrftDtls,omitempty"`
	CshAcctDtls  InvestmentAccount20 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CshAcctDtls,omitempty"`
}
...
type ProfitAndLoss1Choice struct {
	Prft ActiveCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Prft,omitempty"`
	Loss ActiveCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Loss,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 OthrPrtryId,omitempty"`
}
...
type Tax14 struct {
	Tp             TaxType11Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Tp,omitempty"`
	XtndedTp       Extended350Code                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 XtndedTp,omitempty"`
	Amt            ActiveCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Amt"`
	Rate           float64                          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Rate,omitempty"`
...
type UnitPrice10 struct {
	Tp                         TypeOfPrice10Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 Tp,omitempty"`
	XtndedTp                   Extended350Code                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.056.001.01 XtndedTp,omitempty"`
