...
type AccountIdentification4Choice struct {
	IBAN IBAN2007Identifier            `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 IBAN,omitempty"`
	Othr GenericAccountIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Othr,omitempty"`
}
...
type AccountSchemeName1Choice struct {
	Cd    ExternalAccountIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry Max35Text                          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type CancellationRight1Choice struct {
	Cd    CancellationRight1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type ChargeBasis2Choice struct {
	Cd    TaxationBasis5Code      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type ChargeType5Choice struct {
	Cd    InvestmentFundFee1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type ClearingSystemMemberIdentificationChoice struct {
	USCHU  CHIPSUniversalIdentifier                       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 USCHU,omitempty"`
	NZNCC  NewZealandNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 NZNCC,omitempty"`
	IENSC  IrishNSCIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 IENSC,omitempty"`
	GBSC   UKDomesticSortCodeIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 GBSC,omitempty"`
	USCH   CHIPSParticipantIdentifier                     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 USCH,omitempty"`
	CHBC   SwissBCIdentifier                              `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 CHBC,omitempty"`
	USFW   FedwireRoutingNumberIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 USFW,omitempty"`
	PTNCC  PortugueseNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 PTNCC,omitempty"`
	RUCB   RussianCentralBankIdentificationCodeIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 RUCB,omitempty"`
	ITNCC  ItalianDomesticIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 ITNCC,omitempty"`
	ATBLZ  AustrianBankleitzahlIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 ATBLZ,omitempty"`
	CACPA  CanadianPaymentsARNIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 CACPA,omitempty"`
	CHSIC  SwissSICIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 CHSIC,omitempty"`
	DEBLZ  GermanBankleitzahlIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 DEBLZ,omitempty"`
	ESNCC  SpanishDomesticInterbankingIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 ESNCC,omitempty"`
	ZANCC  SouthAfricanNCCIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 ZANCC,omitempty"`
	HKNCC  HongKongBankIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 HKNCC,omitempty"`
	AUBSBx ExtensiveBranchNetworkIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 AUBSBx,omitempty"`
	AUBSBs SmallNetworkIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 AUBSBs,omitempty"`
}
...
type CustomerConductClassification1Choice struct {
	Cd    ConductClassification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}

type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 DtTm,omitempty"`
}

type DateFormat42Choice struct {
	YrMnth    ISOYearMonth `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 YrMnth,omitempty"`
	YrMnthDay ISODate      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 YrMnthDay,omitempty"`
}
...
type ExemptionReason1Choice struct {
	Cd    TaxExemptReason1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type FinancialInstitutionIdentification8Choice struct {
	NmAndAdr    NameAndAddress5                          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 NmAndAdr,omitempty"`
	BICFI       BICFIIdentifier                          `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 BICFI,omitempty"`
	ClrSysMmbId ClearingSystemMemberIdentificationChoice `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 ClrSysMmbId,omitempty"`
	PrtryId     Max35Text                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 PrtryId,omitempty"`
}
...
type FinancialInstrumentQuantity27Choice struct {
	UnitsNb float64                           `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 UnitsNb,omitempty"`
	GrssAmt ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 GrssAmt,omitempty"`
	NetAmt  ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 NetAmt,omitempty"`
}
...
type FundOrderType4Choice struct {
	Cd    FundOrderType8Code      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type InvestmentAccountType1Choice struct {
	Cd    FundCashAccount2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type InvestmentFundRole2Choice struct {
	Cd    InvestmentFundRole2Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type OrderBreakdownType1Choice struct {
	Cd    FundOrderType5Code      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type OrderWaiverReason3Choice struct {
	Cd    OrderWaiverReason1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}

type OtherIdentification3Choice struct {
	Cd    PartyIdentificationType7Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type PartyIdentification90Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 NmAndAdr,omitempty"`
}
...
type PaymentInstrument20Choice struct {
	PmtCardDtls  PaymentCard25       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 PmtCardDtls,omitempty"`
	CdtTrfDtls   CreditTransfer8     `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 CdtTrfDtls,omitempty"`
	DrctDbtDtls  DirectDebitMandate6 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 DrctDbtDtls,omitempty"`
	ChqDtls      Cheque9             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 ChqDtls,omitempty"`
	BkrsDrftDtls Cheque9             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 BkrsDrftDtls,omitempty"`
	CshAcctDtls  InvestmentAccount60 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 CshAcctDtls,omitempty"`
}
...
type PlaceOfTradeIdentification1Choice struct {
	...
	Xchg        MICIdentifier    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Xchg,omitempty"`
	Pty         AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Pty,omitempty"`
	OverTheCntr Max35Text        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 OverTheCntr,omitempty"`
}
...
type SafekeepingPlaceFormat8Choice struct {
	Id      SafekeepingPlaceTypeAndText6             `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Id,omitempty"`
	Ctry    CountryCode                              `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndAnyBICIdentifier1 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 TpAndId,omitempty"`
	Prtry   GenericIdentification78                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type SecurityIdentification25Choice struct {
	ISIN        ISINOct2015Identifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 TckrSymb,omitempty"`
	Blmbrg      Bloomberg2Identifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification7      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 OthrPrtryId,omitempty"`
}
...
type SettlementTransactionCondition30Choice struct {
	Cd    SettlementTransactionCondition11Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification30              `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}

type SignatureType1Choice struct {
	Cd    SignatureType2Code      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type SourceOfCash1Choice struct {
	Cd    SourceOfCash1Code       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type TaxBasis1Choice struct {
	Cd    TaxationBasis2Code      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type TaxType3Choice struct {
	Cd    TaxType17Code           `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type TradeTransactionCondition8Choice struct {
	Cd    TradeTransactionCondition5Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification30        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type TransactionChannelType1Choice struct {
	Cd    TransactionChannel2Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
...
type WaivingInstruction2Choice struct {
	Cd    WaivingInstruction1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.010.001.04 Prtry,omitempty"`
}
