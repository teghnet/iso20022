...
type ConfirmationRejectedReason1Choice struct {
	Cd    RejectedConfirmationStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Cd,omitempty"`
	Prtry GenericIdentification1                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Prtry,omitempty"`
}
...
type ConfirmationStatus1Choice struct {
	ConfRjctd   []ConfirmationRejectedStatus2 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 ConfRjctd,omitempty"`
	AmdmntRjctd []ConfirmationRejectedStatus2 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 AmdmntRjctd,omitempty"`
	Sts         OrderConfirmationStatus1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Sts,omitempty"`
}
...
type DateFormat42Choice struct {
	YrMnth    ISOYearMonth `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 YrMnth,omitempty"`
	YrMnthDay ISODate      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 YrMnthDay,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Prtry,omitempty"`
}
...
type PartyIdentification90Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 NmAndAdr,omitempty"`
}
...
type References61Choice struct {
	RltdRef []AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 RltdRef,omitempty"`
	OthrRef []AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 OthrRef,omitempty"`
}
...
type SecurityIdentification25Choice struct {
	ISIN        ISINOct2015Identifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 TckrSymb,omitempty"`
	Blmbrg      Bloomberg2Identifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification7      `xml:"urn:iso:std:iso:20022:tech:xsd:setr.057.001.02 OthrPrtryId,omitempty"`
}
