...
type AccountIdentification3Choice struct {
	IBAN      IBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 IBAN,omitempty"`
	BBAN      BBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 BBAN,omitempty"`
	UPIC      UPICIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 UPIC,omitempty"`
	PrtryAcct SimpleIdentificationInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 PrtryAcct,omitempty"`
}
...
type AffirmationStatus7Choice struct {
	Cd    AffirmationStatus1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Cd,omitempty"`
	Prtry GenericIdentification38 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Prtry,omitempty"`
}
...
type DocumentNumber4Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 LngNb,omitempty"`
	PrtryNb GenericIdentification38           `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 PrtryNb,omitempty"`
}
...
type IdentificationReference8Choice struct {
	InstgPtyTxId      Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 InstgPtyTxId,omitempty"`
	ExctgPtyTxId      Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 ExctgPtyTxId,omitempty"`
	MktInfrstrctrTxId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 MktInfrstrctrTxId,omitempty"`
	ClntOrdrLkId      Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 ClntOrdrLkId,omitempty"`
	PoolId            Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 PoolId,omitempty"`
	BlckId            Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 BlckId,omitempty"`
	AllcnId           Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 AllcnId,omitempty"`
	IndvAllcnId       Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 IndvAllcnId,omitempty"`
	ScndryAllcnId     Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 ScndryAllcnId,omitempty"`
	IndxId            Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 IndxId,omitempty"`
	CmonId            Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 CmonId,omitempty"`
	CmplcId           Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 CmplcId,omitempty"`
	CollTxId          Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 CollTxId,omitempty"`
}

type IdentificationType40Choice struct {
	Cd    TypeOfIdentification2Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Cd,omitempty"`
	Prtry GenericIdentification29   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Prtry,omitempty"`
}

type InvestorCapacity3Choice struct {
	Cd    Eligibility1Code        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Cd,omitempty"`
	Prtry GenericIdentification38 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Prtry,omitempty"`
}
...
type PartyIdentification32Choice struct {
	BIC      AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 BIC,omitempty"`
	PrtryId  GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress13        `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 NmAndAdr,omitempty"`
}
...
type PurposeCode5Choice struct {
	Cd    SecuritiesAccountPurposeType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Cd,omitempty"`
	Prtry GenericIdentification38           `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Prtry,omitempty"`
}
...
type TradingPartyCapacity1Choice struct {
	Cd    TradingCapacity4Code    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Cd,omitempty"`
	Prtry GenericIdentification38 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Prtry,omitempty"`
}

type TradingPartyCapacity2Choice struct {
	Cd    TradingCapacity6Code    `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Cd,omitempty"`
	Prtry GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Prtry,omitempty"`
}
...
type UnaffirmedReason2Choice struct {
	Cd    UnaffirmedReason1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Cd,omitempty"`
	Prtry GenericIdentification38 `xml:"urn:iso:std:iso:20022:tech:xsd:setr.030.001.01 Prtry,omitempty"`
}
