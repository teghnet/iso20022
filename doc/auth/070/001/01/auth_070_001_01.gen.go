...
type OrganisationIdentification9Choice struct {
	LEI    LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 LEI,omitempty"`
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 ClntId,omitempty"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 AnyBIC,omitempty"`
}
...
type TradeData6Choice struct {
	DataSetActn ReportPeriodActivity1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 DataSetActn,omitempty"`
	Rpt         []TradeReport6Choice      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 Rpt,omitempty"`
}

type TradeReport6Choice struct {
	New     CollateralMarginCorrection3   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 New,omitempty"`
	Err     CollateralMarginError2        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 Err,omitempty"`
	Crrctn  CollateralMarginCorrection3   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 Crrctn,omitempty"`
	TradUpd CollateralMarginMarginUpdate2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.070.001.01 TradUpd,omitempty"`
}
