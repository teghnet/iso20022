...
type AssetClassCommodity2Choice struct {
	Agrcltrl AssetClassSubProductAgriculturalType1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Agrcltrl,omitempty"`
	Nrgy     AssetClassSubProductEnergyType1Code        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Nrgy,omitempty"`
	Envttl   AssetClassSubProductEnvironmentalType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Envttl,omitempty"`
	Frght    AssetClassSubProductFreight1Code           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Frght,omitempty"`
	Indx     NoReasonCode                               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Indx,omitempty"`
	Metl     AssetClassSubProductMetal1Code             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Metl,omitempty"`
	Extc     NoReasonCode                               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Extc,omitempty"`
	Othr     NoReasonCode                               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Othr,omitempty"`
}
...
type Cleared9Choice struct {
	Clrd    ClearingPartyAndTime8 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Clrd,omitempty"`
	NonClrd NoReasonCode          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 NonClrd,omitempty"`
}
...
type CounterpartyTradeNature4Choice struct {
	FI           []FinancialPartySectorType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 FI,omitempty"`
	NFI          NonFinancialInstitutionSector1  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 NFI,omitempty"`
	CntrlCntrPty NoReasonCode                    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 CntrlCntrPty,omitempty"`
	Othr         NoReasonCode                    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Othr,omitempty"`
}

type CounterpartyTradeNature5Choice struct {
	FI           []FinancialPartySectorType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 FI,omitempty"`
	NFI          NonFinancialInstitutionSector2  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 NFI,omitempty"`
	CntrlCntrPty NoReasonCode                    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 CntrlCntrPty,omitempty"`
	Othr         NoReasonCode                    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Othr,omitempty"`
}
...
type DeliveryInterconnectionPoint1Choice struct {
	Cd    EICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Cd,omitempty"`
	Prtry Max52Text     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Prtry,omitempty"`
}

type DerivativePartyIdentification1Choice struct {
	Ctry        CountryCode            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Ctry,omitempty"`
	CtrySubDvsn CountrySubDivisionCode `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 CtrySubDvsn,omitempty"`
	LEI         LEIIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 LEI,omitempty"`
}
...
type EnergyQuantityUnit1Choice struct {
	Cd    EnergyQuantityUnit1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Cd,omitempty"`
	Prtry Max52Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Prtry,omitempty"`
}
...
type ExchangeRateBasis1Choice struct {
	CcyPair ExchangeRateBasis1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 CcyPair,omitempty"`
	Prtry   Max52Text          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Prtry,omitempty"`
}
...
type FinancialInstrumentQuantity30Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Unit,omitempty"`
	NmnlVal  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 NmnlVal,omitempty"`
	MntryVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 MntryVal,omitempty"`
}
...
type FloatingRateIdentification3Choice struct {
	Cd    BenchmarkCurveName3Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Cd,omitempty"`
	Prtry Max350Text              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Prtry,omitempty"`
}
...
type InterestRate21Choice struct {
	Fxd  FixedRate6    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Fxd,omitempty"`
	Fltg FloatingRate5 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Fltg,omitempty"`
}
...
type InterestRateFrequency2Choice struct {
	Term  InterestRateContractTerm3 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Term,omitempty"`
	Prtry Max52Text                 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Prtry,omitempty"`
}
...
type OrganisationIdentification7Choice struct {
	LEI  LEIIdentifier                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 LEI,omitempty"`
	Othr OrganisationIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Othr,omitempty"`
}

type OrganisationIdentification8Choice struct {
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 ClntId,omitempty"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 AnyBIC,omitempty"`
}
...
type ProductClassification1Choice struct {
	ClssfctnFinInstrm CFIOct2015Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 ClssfctnFinInstrm,omitempty"`
	UnqPdctIdr        Max52Text            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 UnqPdctIdr,omitempty"`
}
...
type Quantity46Choice struct {
	Qty  float64   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Qty,omitempty"`
	Desc Max52Text `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Desc,omitempty"`
}
...
type SecuritiesTransactionPrice10Choice struct {
	MntryVal AmountAndDirection54        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 MntryVal,omitempty"`
	Unit     float64                     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Unit,omitempty"`
	Pctg     float64                     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Pctg,omitempty"`
	Yld      float64                     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Yld,omitempty"`
	PdgPric  PriceStatus1Code            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 PdgPric,omitempty"`
	Othr     SecuritiesTransactionPrice4 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Othr,omitempty"`
}

type SecuritiesTransactionPrice3Choice struct {
	MntryVal AmountAndDirection56 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 MntryVal,omitempty"`
	Unit     float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Unit,omitempty"`
	Pctg     float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Pctg,omitempty"`
	Yld      float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Yld,omitempty"`
	PdgPric  PriceStatus1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 PdgPric,omitempty"`
...
type SecurityIdentification18Choice struct {
	ISIN            ISINOct2015Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 ISIN,omitempty"`
	AltrntvInstrmId Max52Text             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 AltrntvInstrmId,omitempty"`
}
...
type SecurityIdentification34Choice struct {
	...
	AltrntvInstrmId Max52Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 AltrntvInstrmId,omitempty"`
	UnqPdctIdr      Max52Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 UnqPdctIdr,omitempty"`
	BsktCnsttnts    []SecurityIdentification18Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 BsktCnsttnts,omitempty"`
	Indx            SecurityIdentification35Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Indx,omitempty"`
	IdNotAvlbl      UnderlyingIdentification1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 IdNotAvlbl,omitempty"`
}

type SecurityIdentification35Choice struct {
	ISIN ISINOct2015Identifier   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 ISIN,omitempty"`
	Nm   Max350Text              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Nm,omitempty"`
	Indx BenchmarkCurveName3Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Indx,omitempty"`
}
...
type TradeConfirmation1Choice struct {
	Confd    TradeConfirmation2    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Confd,omitempty"`
	NonConfd TradeNonConfirmation1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 NonConfd,omitempty"`
}
...
type TradeConfirmation2Choice struct {
	Confd    TradeConfirmation3    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Confd,omitempty"`
	NonConfd TradeNonConfirmation1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 NonConfd,omitempty"`
}
...
type TradeData17Choice struct {
	DataSetActn ReportPeriodActivity1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 DataSetActn,omitempty"`
	Rpt         []TradeReport12Choice     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Rpt,omitempty"`
	Stat        []TradeStateReport10      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Stat,omitempty"`
}
...
type TradePositionReport7Choice struct {
	New          TradeNewPosition5              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 New,omitempty"`
	Mod          TradeDataReport1               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Mod,omitempty"`
	Crrctn       TradeDataReport1               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Crrctn,omitempty"`
	EarlyTermntn TradePositionEarlyTermination5 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 EarlyTermntn,omitempty"`
	ValtnUpd     TradePositionValuationUpdate5  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 ValtnUpd,omitempty"`
	Err          TradeDataReport1               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Err,omitempty"`
	Othr         TradePositionOther5            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Othr,omitempty"`
}
...
type TradeReport12Choice struct {
	Pos TradePositionReport7Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Pos,omitempty"`
	Tx  TradeTransactionReport8Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Tx,omitempty"`
}
...
type TradeTransactionReport8Choice struct {
	New          TradeNewTransaction10             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 New,omitempty"`
	Mod          TradeDataReport1                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Mod,omitempty"`
	Crrctn       TradeDataReport1                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Crrctn,omitempty"`
	EarlyTermntn TradeTransactionEarlyTermination5 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 EarlyTermntn,omitempty"`
	PosCmpnt     TradePositionComponent5           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 PosCmpnt,omitempty"`
	ValtnUpd     TradeTransactionValuationUpdate5  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 ValtnUpd,omitempty"`
	Cmprssn      TradeDataReport1                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Cmprssn,omitempty"`
	Err          TradeDataReport1                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Err,omitempty"`
	Othr         TradeTransactionOther6            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Othr,omitempty"`
}
...
type TrancheIndicator2Choice struct {
	Trnchd  Tranche2     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Trnchd,omitempty"`
	Utrnchd NoReasonCode `xml:"urn:iso:std:iso:20022:tech:xsd:auth.030.001.01 Utrnchd,omitempty"`
}
