...
type OrganisationIdentification9Choice struct {
	LEI    LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.085.001.01 LEI,omitempty"`
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.085.001.01 ClntId,omitempty"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.085.001.01 AnyBIC,omitempty"`
}
...
type TradeData13Choice struct {
	DataSetActn ReportPeriodActivity1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.085.001.01 DataSetActn,omitempty"`
	Stat        []CollateralMarginNew7    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.085.001.01 Stat,omitempty"`
}
