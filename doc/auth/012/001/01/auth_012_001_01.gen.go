...
type CounterpartyIdentification2Choice struct {
	LEI  LEIIdentifier                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 LEI,omitempty"`
	Othr ReportedPartyIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 Othr,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 DtTm,omitempty"`
}
...
type NameOrSector1Choice struct {
	Nm   Max70Text `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 Nm,omitempty"`
	Sctr string    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 Sctr,omitempty"`
}
...
type SecuredCollateral2Choice struct {
	SnglColl  CollateralValuation6   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 SnglColl,omitempty"`
	MltplColl []CollateralValuation6 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 MltplColl,omitempty"`
	PoolColl  CollateralValuation6   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 PoolColl,omitempty"`
	OthrColl  []CollateralValuation7 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 OthrColl,omitempty"`
}

type SecuredMarketReport3Choice struct {
	DataSetActn ReportPeriodActivity1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 DataSetActn,omitempty"`
	Tx          []SecuredMarketTransaction3 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.012.001.01 Tx,omitempty"`
}
