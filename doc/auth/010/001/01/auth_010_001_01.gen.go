...
type PartyIdentification23Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 PrtryId,omitempty"`
}
...
type RegulatoryTransactionReportStatusV01 struct {
	...
	RptSts    ReportStatusAndReason1             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 RptSts,omitempty"`
	IndvTxSts []TradeTransactionStatusAndReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 IndvTxSts,omitempty"`
}

type RejectedStatusReason9Choice struct {
	Rsn          RejectedStatusReason9Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 Rsn,omitempty"`
	XtndedRsn    Extended350Code           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 DataSrcSchme,omitempty"`
}
...
type ReportStatusAndReason1 struct {
	...
	Sts     Status2Code                   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 Sts,omitempty"`
	Rjctd   []RejectedStatusReason9Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.010.001.01 Rjctd,omitempty"`
}
