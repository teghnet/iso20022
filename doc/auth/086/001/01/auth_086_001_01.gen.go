...
type OrganisationIdentification9Choice struct {
	LEI    LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.086.001.01 LEI,omitempty"`
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.086.001.01 ClntId,omitempty"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.086.001.01 AnyBIC,omitempty"`
}
...
type ReuseValue1Choice struct {
	Actl   ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.086.001.01 Actl,omitempty"`
	Estmtd ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.086.001.01 Estmtd,omitempty"`
}
...
type TradeData12Choice struct {
	DataSetActn ReportPeriodActivity1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.086.001.01 DataSetActn,omitempty"`
	Rpt         []ReuseDataReportCorrection9 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.086.001.01 Rpt,omitempty"`
}
