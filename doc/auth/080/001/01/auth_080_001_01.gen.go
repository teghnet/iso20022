...
type AgreementType1Choice struct {
	Tp    ExternalAgreementType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Tp,omitempty"`
	Prtry Max35Text                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Prtry,omitempty"`
}
...
type AssetClassCommodity5Choice struct {
	Agrcltrl          AssetClassCommodityAgricultural5Choice         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Agrcltrl,omitempty"`
	Nrgy              AssetClassCommodityEnergy2Choice               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Nrgy,omitempty"`
	Envttl            AssetClassCommodityEnvironmental2Choice        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Envttl,omitempty"`
	Frtlzr            AssetClassCommodityFertilizer3Choice           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Frtlzr,omitempty"`
	Frght             AssetClassCommodityFreight3Choice              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Frght,omitempty"`
	IndstrlPdct       AssetClassCommodityIndustrialProduct1Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 IndstrlPdct,omitempty"`
	Metl              AssetClassCommodityMetal1Choice                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Metl,omitempty"`
	OthrC10           AssetClassCommodityOtherC102Choice             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 OthrC10,omitempty"`
	Ppr               AssetClassCommodityPaper3Choice                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Ppr,omitempty"`
	Plprpln           AssetClassCommodityPolypropylene3Choice        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Plprpln,omitempty"`
	Infltn            AssetClassCommodityInflation1                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Infltn,omitempty"`
	MultiCmmdtyExtc   AssetClassCommodityMultiCommodityExotic1       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 MultiCmmdtyExtc,omitempty"`
	OffclEcnmcSttstcs AssetClassCommodityOfficialEconomicStatistics1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 OffclEcnmcSttstcs,omitempty"`
	Othr              AssetClassCommodityOther1                      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}

type AssetClassCommodityAgricultural5Choice struct {
	GrnOilSeed AgriculturalCommodityOilSeed1   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 GrnOilSeed,omitempty"`
	Soft       AgriculturalCommoditySoft1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Soft,omitempty"`
	Ptt        AgriculturalCommodityPotato1    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Ptt,omitempty"`
	OlvOil     AgriculturalCommodityOliveOil2  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 OlvOil,omitempty"`
	Dairy      AgriculturalCommodityDairy1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Dairy,omitempty"`
	Frstry     AgriculturalCommodityForestry1  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Frstry,omitempty"`
	Sfd        AgriculturalCommoditySeafood1   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Sfd,omitempty"`
	LiveStock  AgriculturalCommodityLiveStock1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 LiveStock,omitempty"`
	Grn        AgriculturalCommodityGrain2     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Grn,omitempty"`
	Othr       AgriculturalCommodityOther1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}

type AssetClassCommodityEnergy2Choice struct {
	Elctrcty  EnergyCommodityElectricity1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Elctrcty,omitempty"`
	NtrlGas   EnergyCommodityNaturalGas2      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 NtrlGas,omitempty"`
	Oil       EnergyCommodityOil2             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Oil,omitempty"`
	Coal      EnergyCommodityCoal1            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Coal,omitempty"`
	IntrNrgy  EnergyCommodityInterEnergy1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 IntrNrgy,omitempty"`
	RnwblNrgy EnergyCommodityRenewableEnergy1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 RnwblNrgy,omitempty"`
	LghtEnd   EnergyCommodityLightEnd1        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 LghtEnd,omitempty"`
	Dstllts   EnergyCommodityDistillates1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Dstllts,omitempty"`
	Othr      EnergyCommodityOther1           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}

type AssetClassCommodityEnvironmental2Choice struct {
	Emssns   EnvironmentalCommodityEmission2      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Emssns,omitempty"`
	Wthr     EnvironmentalCommodityWeather1       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Wthr,omitempty"`
	CrbnRltd EnvironmentalCommodityCarbonRelated1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 CrbnRltd,omitempty"`
	Othr     EnvironmentCommodityOther1           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}

type AssetClassCommodityFertilizer3Choice struct {
	Ammn             FertilizerCommodityAmmonia1                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Ammn,omitempty"`
	DmmnmPhspht      FertilizerCommodityDiammoniumPhosphate1    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 DmmnmPhspht,omitempty"`
	Ptsh             FertilizerCommodityPotash1                 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Ptsh,omitempty"`
	Slphr            FertilizerCommoditySulphur1                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Slphr,omitempty"`
	Urea             FertilizerCommodityUrea1                   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Urea,omitempty"`
	UreaAndAmmnmNtrt FertilizerCommodityUreaAndAmmoniumNitrate1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 UreaAndAmmnmNtrt,omitempty"`
	Othr             FertilizerCommodityOther1                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}

type AssetClassCommodityFreight3Choice struct {
	Dry       FreightCommodityDry2           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Dry,omitempty"`
	Wet       FreightCommodityWet2           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Wet,omitempty"`
	CntnrShip FreightCommodityContainerShip1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 CntnrShip,omitempty"`
	Othr      FreightCommodityOther1         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}

type AssetClassCommodityIndustrialProduct1Choice struct {
	Cnstrctn IndustrialProductCommodityConstruction1  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Cnstrctn,omitempty"`
	Manfctg  IndustrialProductCommodityManufacturing1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Manfctg,omitempty"`
}
...
type AssetClassCommodityMetal1Choice struct {
	NonPrcs MetalCommodityNonPrecious1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 NonPrcs,omitempty"`
	Prcs    MetalCommodityPrecious1    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Prcs,omitempty"`
}
...
type AssetClassCommodityOtherC102Choice struct {
	Dlvrbl    OtherC10CommodityDeliverable2    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Dlvrbl,omitempty"`
	NonDlvrbl OtherC10CommodityNonDeliverable2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 NonDlvrbl,omitempty"`
}

type AssetClassCommodityPaper3Choice struct {
	CntnrBrd PaperCommodityContainerBoard1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 CntnrBrd,omitempty"`
	Nwsprnt  PaperCommodityNewsprint1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Nwsprnt,omitempty"`
	Pulp     PaperCommodityPulp1           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Pulp,omitempty"`
	RcvrdPpr PaperCommodityRecoveredPaper1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 RcvrdPpr,omitempty"`
	Othr     PaperCommodityRecoveredPaper2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}

type AssetClassCommodityPolypropylene3Choice struct {
	Plstc PolypropyleneCommodityPlastic1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Plstc,omitempty"`
	Othr  PolypropyleneCommodityOther1   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Othr,omitempty"`
}
...
type BenchmarkCurveName10Choice struct {
	Indx BenchmarkCurveName3Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Indx,omitempty"`
	Nm   Max350Text              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Nm,omitempty"`
}
...
type Cleared4Choice struct {
	Clrd    NoReasonCode `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Clrd,omitempty"`
	NonClrd NoReasonCode `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 NonClrd,omitempty"`
}
...
type InterestComputationMethodFormat6Choice struct {
	Cd    InterestComputationMethod1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Cd,omitempty"`
	Prtry Max35Text                      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Prtry,omitempty"`
}
...
type OrganisationIdentification9Choice struct {
	LEI    LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 LEI,omitempty"`
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 ClntId,omitempty"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 AnyBIC,omitempty"`
}
...
type ReconciliationMatchedStatus6Choice struct {
	Mtchd    NoReasonCode          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Mtchd,omitempty"`
	NotMtchd ReconciliationResult7 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 NotMtchd,omitempty"`
}
...
type ReconciliationStatus5Choice struct {
	NoRcncltnReqrd NoReasonCode                       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 NoRcncltnReqrd,omitempty"`
	RptgData       ReconciliationMatchedStatus6Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 RptgData,omitempty"`
}
...
type SecuritiesLendingType3Choice struct {
	Cd    ExternalSecuritiesLendingType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Cd,omitempty"`
	Prtry Max35Text                          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Prtry,omitempty"`
}

type SecuritiesTransactionPrice11Choice struct {
	MntryVal AmountAndDirection53 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 MntryVal,omitempty"`
	Pctg     float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Pctg,omitempty"`
	Yld      float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Yld,omitempty"`
	BsisPts  float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 BsisPts,omitempty"`
}
...
type SecurityIdentification26Choice struct {
	Id       ISINOct2015Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Id,omitempty"`
	NotAvlbl NotAvailable1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 NotAvlbl,omitempty"`
}
...
type TradeData14Choice struct {
	DataSetActn ReportPeriodActivity1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 DataSetActn,omitempty"`
	Rpt         []TradeData21             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.080.001.01 Rpt,omitempty"`
}
