...
type OrganisationIdentification9Choice struct {
	LEI    LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 LEI,omitempty"`
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 ClntId,omitempty"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 AnyBIC,omitempty"`
}
...
type ReuseDataReport3Choice struct {
	New          ReuseDataReportNew3        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 New,omitempty"`
	Err          ReuseDataReportError3      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 Err,omitempty"`
	Crrctn       ReuseDataReportCorrection7 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 Crrctn,omitempty"`
	CollReuseUpd ReuseDataReportCorrection7 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 CollReuseUpd,omitempty"`
}
...
type ReuseValue1Choice struct {
	Actl   ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 Actl,omitempty"`
	Estmtd ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 Estmtd,omitempty"`
}
...
type TradeData9Choice struct {
	DataSetActn ReportPeriodActivity1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 DataSetActn,omitempty"`
	Rpt         []ReuseDataReport3Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.071.001.01 Rpt,omitempty"`
}
