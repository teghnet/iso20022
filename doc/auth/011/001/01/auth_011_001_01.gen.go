...
type PartyIdentification23Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 PrtryId,omitempty"`
}
...
type RegulatoryTransactionReportCancellationStatusV01 struct {
	...
	RptCxlSts    ReportStatusAndReason2             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 RptCxlSts,omitempty"`
	IndvTxCxlSts []TradeTransactionStatusAndReason2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 IndvTxCxlSts,omitempty"`
}

type RejectedCancellationStatusReason1Choice struct {
	Rsn          RejectedCancellationStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 Rsn,omitempty"`
	XtndedRsn    Extended350Code                       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 DataSrcSchme,omitempty"`
}
...
type ReportStatusAndReason2 struct {
	...
	Sts     Status2Code                               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 Sts,omitempty"`
	Rjctd   []RejectedCancellationStatusReason1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.011.001.01 Rjctd,omitempty"`
}
