...
type DateOrBlankQuery2Choice struct {
	Rg      DatePeriod1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 Rg,omitempty"`
	NotRptd NotReported1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 NotRptd,omitempty"`
}
...
type PartyIdentification121Choice struct {
	...
	LglNttyIdr LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 LglNttyIdr,omitempty"`
	NmAndAdr   NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 NmAndAdr,omitempty"`
	PrtryId    GenericIdentification1  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 PrtryId,omitempty"`
}
...
type SecuritiesTradeVenueCriteria1Choice struct {
	MIC    []MICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 MIC,omitempty"`
	AnyMIC AnyMIC1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 AnyMIC,omitempty"`
}
...
type TradeQueryExecutionFrequency1Choice struct {
	Daly   NoReasonCode `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 Daly,omitempty"`
	Wkly   WeekDay2Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 Wkly,omitempty"`
	Mnthly float64      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 Mnthly,omitempty"`
}
...
type TradeReportQuery8Choice struct {
	AdHocQry TradeQueryCriteria8  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 AdHocQry,omitempty"`
	RcrntQry TradeRecurrentQuery3 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.094.001.01 RcrntQry,omitempty"`
}
