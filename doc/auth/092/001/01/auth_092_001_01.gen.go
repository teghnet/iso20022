...
type StatisticsPerCounterparty2Choice struct {
	DataSetActn ReportPeriodActivity1Code            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.092.001.01 DataSetActn,omitempty"`
	Rpt         []DetailedStatisticsPerCounterparty6 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.092.001.01 Rpt,omitempty"`
}
