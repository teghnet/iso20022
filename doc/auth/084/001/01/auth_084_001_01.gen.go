...
type AgreementType1Choice struct {
	Tp    ExternalAgreementType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 Tp,omitempty"`
	Prtry Max35Text                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 Prtry,omitempty"`
}
...
type OrganisationIdentification9Choice struct {
	LEI    LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 LEI,omitempty"`
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 ClntId,omitempty"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 AnyBIC,omitempty"`
}
...
type TradeData11Choice struct {
	DataSetActn ReportPeriodActivity1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 DataSetActn,omitempty"`
	Rpt         []TradeData20             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 Rpt,omitempty"`
}
...
type TransactionIdentification1Choice struct {
	Tx        TradeTransactionIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 Tx,omitempty"`
	MrgnRptg  TradeTransactionIdentification8 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 MrgnRptg,omitempty"`
	CollReuse TradeTransactionIdentification9 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 CollReuse,omitempty"`
}

type ValidationRuleSchemeName1Choice struct {
	Cd    ExternalValidationRuleIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 Cd,omitempty"`
	Prtry Max35Text                                 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.084.001.01 Prtry,omitempty"`
}
