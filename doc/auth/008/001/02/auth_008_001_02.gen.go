...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 PrtryIdSrc,omitempty"`
}
...
type OffMarket1Choice struct {
	OffMktInd    OffMarket1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 OffMktInd,omitempty"`
	SystmtcIntlr AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 SystmtcIntlr,omitempty"`
}
...
type PartyIdentification11Choice struct {
	BICOrBEI    AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 BICOrBEI,omitempty"`
	CntrlCtrPty MICIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 CntrlCtrPty,omitempty"`
	PrtryId     GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 PrtryId,omitempty"`
}
...
type PartyIdentification24Choice struct {
	BICOrBEI AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 BICOrBEI,omitempty"`
	MIC      MICIdentifier    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 MIC,omitempty"`
}
...
type PlaceOfTradeIdentification2Choice struct {
	MktId  MICIdentifier    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 MktId,omitempty"`
	OffMkt OffMarket1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 OffMkt,omitempty"`
}
...
type PriceRateOrAmountChoice struct {
	Rate float64                                    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 Rate,omitempty"`
	Amt  ActiveOrHistoricCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 Amt,omitempty"`
}
...
type SecurityClassificationType1Choice struct {
	CFI           CFIIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 CFI,omitempty"`
	AltrnClssfctn GenericIdentification3 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 AltrnClssfctn,omitempty"`
}

type SecurityIdentification6Choice struct {
	ISIN       ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 ISIN,omitempty"`
	OthrId     AlternateSecurityIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 OthrId,omitempty"`
	InstrmDesc SecurityInstrumentDescription2   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 InstrmDesc,omitempty"`
}
...
type UnitOrFaceAmountChoice struct {
	Unit    float64           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 Unit,omitempty"`
	FaceAmt CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.008.001.02 FaceAmt,omitempty"`
}
