...
type AssetClassAttributes1Choice struct {
	Intrst DerivativeInterest2        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Intrst,omitempty"`
	FX     DerivativeForeignExchange2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 FX,omitempty"`
	Both   AssetClassAttributes1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Both,omitempty"`
}
...
type BenchmarkCurveName5Choice struct {
	Indx BenchmarkCurveName2Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Indx,omitempty"`
	Nm   Max25Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Nm,omitempty"`
}
...
type ExecutingParty1Choice struct {
	Prsn PersonIdentification12 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Prsn,omitempty"`
	Algo Max50Text              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Algo,omitempty"`
	Clnt NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Clnt,omitempty"`
}
...
type FinancialInstrumentAttributes3Choice struct {
	...
	Othr SecurityInstrumentDescription13 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Othr,omitempty"`
}
...
type FinancialInstrumentIdentification7Choice struct {
	Sngl FinancialInstrumentIdentification6Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Sngl,omitempty"`
	Bskt BasketDescription3                       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Bskt,omitempty"`
}

type FinancialInstrumentQuantity25Choice struct {
	Unit     float64                           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Unit,omitempty"`
	NmnlVal  ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 NmnlVal,omitempty"`
	MntryVal ActiveOrHistoricCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 MntryVal,omitempty"`
}
...
type PersonIdentificationSchemeName1Choice struct {
	Cd    ExternalPersonIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Cd,omitempty"`
	Prtry Max35Text                         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Prtry,omitempty"`
}

type PersonOrOrganisation1Choice struct {
	LEI  LEIIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 LEI,omitempty"`
	MIC  MICIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 MIC,omitempty"`
	Prsn PersonIdentification10 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Prsn,omitempty"`
	Intl InternalPartyRole1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Intl,omitempty"`
}
...
type ReportingTransactionType1Choice struct {
	New         SecuritiesTransactionReport4 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 New,omitempty"`
	Cxl         SecuritiesTransactionReport2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Cxl,omitempty"`
	SplmtryData []SupplementaryData1         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 SplmtryData,omitempty"`
}
...
type SecuritiesTransactionPrice2Choice struct {
	MntryVal AmountAndDirection61 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 MntryVal,omitempty"`
	Pctg     float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Pctg,omitempty"`
	Yld      float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Yld,omitempty"`
	BsisPts  float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 BsisPts,omitempty"`
}

type SecuritiesTransactionPrice4Choice struct {
	Pric   SecuritiesTransactionPrice2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Pric,omitempty"`
	NoPric SecuritiesTransactionPrice1       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 NoPric,omitempty"`
}
...
type UnderlyingIdentification2Choice struct {
	Swp  SwapLegIdentification2                   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Swp,omitempty"`
	Othr FinancialInstrumentIdentification7Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.016.001.01 Othr,omitempty"`
}
