...
type BenchmarkCurveName5Choice struct {
	Indx BenchmarkCurveName2Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Indx,omitempty"`
	Nm   Max25Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Nm,omitempty"`
}
...
type CommodityDerivate2Choice struct {
	Frght CommodityDerivate5 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Frght,omitempty"`
	Nrgy  CommodityDerivate6 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Nrgy,omitempty"`
}
...
type CreditDefaultSwapsDerivative3Choice struct {
	SnglNmCdtDfltSwp      CreditDefaultSwapSingleName2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 SnglNmCdtDfltSwp,omitempty"`
	CdtDfltSwpIndx        CreditDefaultSwapIndex2      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 CdtDfltSwpIndx,omitempty"`
	SnglNmCdtDfltSwpDeriv CreditDefaultSwapDerivative4 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 SnglNmCdtDfltSwpDeriv,omitempty"`
	CdtDfltSwpIndxDeriv   CreditDefaultSwapDerivative3 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 CdtDfltSwpIndxDeriv,omitempty"`
}
...
type Derivative2Choice struct {
	Cmmdty       CommodityDerivate4                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Cmmdty,omitempty"`
	IntrstRate   InterestRateDerivative5             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 IntrstRate,omitempty"`
	FX           ForeignExchangeDerivative2          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 FX,omitempty"`
	Eqty         EquityDerivative2                   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Eqty,omitempty"`
	CtrctForDiff ContractForDifference2              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 CtrctForDiff,omitempty"`
	Cdt          CreditDefaultSwapsDerivative3Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Cdt,omitempty"`
	EmssnAllwnc  EmissionAllowanceProductType1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 EmssnAllwnc,omitempty"`
}

type DerivativePartyIdentification1Choice struct {
	Ctry        CountryCode            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Ctry,omitempty"`
	CtrySubDvsn CountrySubDivisionCode `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 CtrySubDvsn,omitempty"`
	LEI         LEIIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 LEI,omitempty"`
}
...
type EquityDerivative3Choice struct {
	Bskt   UnderlyingEquityType3Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Bskt,omitempty"`
	Indx   UnderlyingEquityType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Indx,omitempty"`
	SnglNm UnderlyingEquityType5Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 SnglNm,omitempty"`
	Othr   UnderlyingEquityType6Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Othr,omitempty"`
}
...
type InflationIndex1Choice struct {
	ISIN ISINOct2015Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 ISIN,omitempty"`
	Nm   Max25Text             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Nm,omitempty"`
}
...
type InterestRateDerivative2Choice struct {
	SwpRltd SwapType1Code                   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 SwpRltd,omitempty"`
	Othr    UnderlyingInterestRateType3Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Othr,omitempty"`
}
...
type Period4Choice struct {
	Dt       ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Dt,omitempty"`
	FrDt     ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 FrDt,omitempty"`
	ToDt     ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 ToDt,omitempty"`
	FrDtToDt Period2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 FrDtToDt,omitempty"`
}
...
type TradingVenueIdentification1Choice struct {
	MktIdCd          MICIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 MktIdCd,omitempty"`
	NtlCmptntAuthrty CountryCode                 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 NtlCmptntAuthrty,omitempty"`
	Othr             TradingVenueIdentification2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.033.001.01 Othr,omitempty"`
}
