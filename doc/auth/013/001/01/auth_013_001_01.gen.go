...
type CounterpartyIdentification2Choice struct {
	LEI  LEIIdentifier                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 LEI,omitempty"`
	Othr ReportedPartyIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 Othr,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 DtTm,omitempty"`
}
...
type NameOrSector1Choice struct {
	Nm   Max70Text `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 Nm,omitempty"`
	Sctr string    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 Sctr,omitempty"`
}
...
type OptionDateOrPeriod1Choice struct {
	EarlstExrcDt ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 EarlstExrcDt,omitempty"`
	NtcePrd      float64 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 NtcePrd,omitempty"`
}
...
type UnsecuredMarketReport3Choice struct {
	DataSetActn ReportPeriodActivity1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 DataSetActn,omitempty"`
	Tx          []UnsecuredMarketTransaction3 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.01 Tx,omitempty"`
}
