...
type CounterpartyIdentification3Choice struct {
	LEI         LEIIdentifier      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 LEI,omitempty"`
	SctrAndLctn SectorAndLocation1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 SctrAndLctn,omitempty"`
	NmAndLctn   NameAndLocation1   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 NmAndLctn,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 DtTm,omitempty"`
}
...
type OptionDateOrPeriod1Choice struct {
	EarlstExrcDt ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 EarlstExrcDt,omitempty"`
	NtcePrd      float64 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 NtcePrd,omitempty"`
}
...
type UnsecuredMarketReport4Choice struct {
	DataSetActn ReportPeriodActivity3Code     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 DataSetActn,omitempty"`
	Tx          []UnsecuredMarketTransaction4 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.013.001.02 Tx,omitempty"`
}
