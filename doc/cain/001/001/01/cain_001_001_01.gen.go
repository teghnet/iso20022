...
type AccountIdentification30Choice struct {
	Card   Min8Max28NumericText `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 Card,omitempty"`
	MSISDN Max16Text            `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 MSISDN,omitempty"`
	EMail  Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 EMail,omitempty"`
	IBAN   IBANIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 IBAN,omitempty"`
	BBAN   BBANIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 BBAN,omitempty"`
	UPIC   UPICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 UPIC,omitempty"`
	Dmst   Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 Dmst,omitempty"`
	Othr   Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 Othr,omitempty"`
}
...
type PartyIdentification72Choice struct {
	AnyBIC  AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 AnyBIC,omitempty"`
	PrtryId GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 PrtryId,omitempty"`
}
...
type Recipient4Choice struct {
	KeyTrnsprt KeyTransport4  `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 KeyTrnsprt,omitempty"`
	KEK        KEK4           `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 KEK,omitempty"`
	KeyIdr     KEKIdentifier2 `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 KeyIdr,omitempty"`
}

type Recipient5Choice struct {
	IssrAndSrlNb IssuerAndSerialNumber1 `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 IssrAndSrlNb,omitempty"`
	KeyIdr       KEKIdentifier2         `xml:"urn:iso:std:iso:20022:tech:xsd:cain.001.001.01 KeyIdr,omitempty"`
}
