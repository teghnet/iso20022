...
type AccountIdentification3Choice struct {
	IBAN      IBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 IBAN,omitempty"`
	BBAN      BBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 BBAN,omitempty"`
	UPIC      UPICIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 UPIC,omitempty"`
	PrtryAcct SimpleIdentificationInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 PrtryAcct,omitempty"`
}
...
type CashAccountType2 struct {
	Cd    CashAccountType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 Cd,omitempty"`
	Prtry Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 Prtry,omitempty"`
}
...
type ClearingSystemMemberIdentification2Choice struct {
	...
	NZNCC       NewZealandNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 NZNCC,omitempty"`
	IENSC       IrishNSCIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 IENSC,omitempty"`
	GBSC        UKDomesticSortCodeIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 GBSC,omitempty"`
	USCH        CHIPSParticipantIdentifier                     `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 USCH,omitempty"`
	CHBC        SwissBCIdentifier                              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 CHBC,omitempty"`
	USFW        FedwireRoutingNumberIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 USFW,omitempty"`
	PTNCC       PortugueseNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 PTNCC,omitempty"`
	RUCB        RussianCentralBankIdentificationCodeIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 RUCB,omitempty"`
	ITNCC       ItalianDomesticIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 ITNCC,omitempty"`
	ATBLZ       AustrianBankleitzahlIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 ATBLZ,omitempty"`
	CACPA       CanadianPaymentsARNIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 CACPA,omitempty"`
	CHSIC       SwissSICIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 CHSIC,omitempty"`
	DEBLZ       GermanBankleitzahlIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 DEBLZ,omitempty"`
	ESNCC       SpanishDomesticInterbankingIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 ESNCC,omitempty"`
	ZANCC       SouthAfricanNCCIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 ZANCC,omitempty"`
	HKNCC       HongKongBankIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 HKNCC,omitempty"`
	AUBSBx      ExtensiveBranchNetworkIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 AUBSBx,omitempty"`
	AUBSBs      SmallNetworkIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 AUBSBs,omitempty"`
	INIFSC      IndianFinancialSystemCodeIdentifier            `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 INIFSC,omitempty"`
	GRHEBIC     HellenicBankIdentificationCodeIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 GRHEBIC,omitempty"`
	PLKNR       PolishNationalClearingCodeIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 PLKNR,omitempty"`
	OthrClrCdId Max35Text                                      `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 OthrClrCdId,omitempty"`
}
...
type FinancingRateOrAmountChoice struct {
	Amt  ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 Amt,omitempty"`
	Rate float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 Rate,omitempty"`
}
...
type Party2Choice struct {
	OrgId  OrganisationIdentification2 `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 OrgId,omitempty"`
	PrvtId []PersonIdentification3     `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 PrvtId,omitempty"`
}
...
type PersonIdentification3 struct {
	DrvrsLicNb      Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 DrvrsLicNb,omitempty"`
	CstmrNb         Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 CstmrNb,omitempty"`
	SclSctyNb       Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 SclSctyNb,omitempty"`
	AlnRegnNb       Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 AlnRegnNb,omitempty"`
	PsptNb          Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 PsptNb,omitempty"`
	TaxIdNb         Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 TaxIdNb,omitempty"`
	IdntyCardNb     Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 IdntyCardNb,omitempty"`
	MplyrIdNb       Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 MplyrIdNb,omitempty"`
	DtAndPlcOfBirth DateAndPlaceOfBirth    `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 DtAndPlcOfBirth,omitempty"`
	OthrId          GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 OthrId,omitempty"`
	Issr            Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 Issr,omitempty"`
}
...
type StatusReason4Choice struct {
	Cd    FinancingStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 Cd,omitempty"`
	Prtry Max35Text                  `xml:"urn:iso:std:iso:20022:tech:xsd:tsin.002.001.01 Prtry,omitempty"`
}
