...
type BeneficiaryCertificationType9Choice struct {
	Cd    BeneficiaryCertificationType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Cd,omitempty"`
	Prtry GenericIdentification30           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 DtTm,omitempty"`
}

type DatePeriod1Choice struct {
	Dt       ISODate      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Dt,omitempty"`
	DtMnth   ISOYearMonth `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 DtMnth,omitempty"`
	FrDtToDt Period2      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 FrDtToDt,omitempty"`
}
...
type FinancialInstrumentAggregateBalance1Choice struct {
	HldgsInd bool                                 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 HldgsInd,omitempty"`
	HldgBal  FinancialInstrumentAggregateBalance2 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 HldgBal,omitempty"`
}
...
type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 AmtsdVal,omitempty"`
}
...
type Frequency22Choice struct {
	Cd    EventFrequency7Code     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}
...
type Number3Choice struct {
	Shrt Exact3NumericText `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Shrt,omitempty"`
	Lng  Exact5NumericText `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Lng,omitempty"`
}
...
type OtherIdentification4Choice struct {
	Cd    PersonIdentificationType6Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Cd,omitempty"`
	Prtry GenericIdentification36       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}
...
type PartyIdentification71Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 AnyBIC,omitempty"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 NmAndAdr,omitempty"`
}
...
type PriceRateOrAmountChoice struct {
	Rate float64                                    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Rate,omitempty"`
	Amt  ActiveOrHistoricCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Amt,omitempty"`
}
...
type Role5Choice struct {
	Cd    InvestmentFundRole2Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Cd,omitempty"`
	Prtry GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}
...
type SubBalanceQuantity5Choice struct {
	Qty   FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Qty,omitempty"`
	Prtry GenericIdentification56            `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}

type SubBalanceType9Choice struct {
	Cd    SecuritiesBalanceType14Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Cd,omitempty"`
	Prtry GenericIdentification30     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}
...
type UpdateType4Choice struct {
	Cd    StatementUpdateType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Cd,omitempty"`
	Prtry GenericIdentification30  `xml:"urn:iso:std:iso:20022:tech:xsd:semt.041.001.02 Prtry,omitempty"`
}
