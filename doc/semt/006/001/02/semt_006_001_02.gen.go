...
type AccountIdentificationFormatChoice struct {
	SmplId    AccountIdentification1          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 SmplId,omitempty"`
	IdAndPurp AccountIdentificationAndPurpose `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 IdAndPurp,omitempty"`
	IdAsDSS   AccountIdentification3          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 IdAsDSS,omitempty"`
}
...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 PrtryIdSrc,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 DtTm,omitempty"`
}
...
type InvestmentFundTransaction3 struct {
	TxTp                TransactionType2Code          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 TxTp,omitempty"`
	XtndedTxTp          Extended350Code               `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 XtndedTxTp,omitempty"`
	CorpActnEvtTp       CorporateActionEventType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 CorpActnEvtTp,omitempty"`
	XtndedCorpActnEvtTp Extended350Code               `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 XtndedCorpActnEvtTp,omitempty"`
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Strd,omitempty"`
}
...
type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 NmAndAdr,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 NmAndAdr,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 OthrPrtryId,omitempty"`
}
...
type UnitPrice11 struct {
	Tp       TypeOfPrice10Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 Tp,omitempty"`
	XtndedTp Extended350Code   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.006.001.02 XtndedTp,omitempty"`
