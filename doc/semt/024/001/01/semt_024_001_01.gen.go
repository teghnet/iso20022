...
type BalanceType6Choice struct {
	Cd    BalanceType13Code       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
}

type BalanceType7Choice struct {
	Cd    FinancialAssetBalanceType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry GenericIdentification30        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
	Acct  AccountIdentification5         `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Acct,omitempty"`
}

type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 DtTm,omitempty"`
}
...
type Frequency8Choice struct {
	Cd    EventFrequency1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
}
...
type PortfolioBalance1 struct {
	SummryBal []BalanceDetails5 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 SummryBal,omitempty"`
	DtldBal   []BalanceDetails6 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 DtldBal,omitempty"`
}
...
type StatementBasis6Choice struct {
	Cd    StatementBasis1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
}

type StatementSource1Choice struct {
	Cd    StatementSource1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
}
...
type TypeOfPrice27Choice struct {
	Cd    TypeOfPrice30Code       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
}
...
type UpdateType4Choice struct {
	Cd    StatementUpdateType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Cd,omitempty"`
	Prtry GenericIdentification30  `xml:"urn:iso:std:iso:20022:tech:xsd:semt.024.001.01 Prtry,omitempty"`
}
