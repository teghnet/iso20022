...
type PartyIdentification114Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 AnyBIC,omitempty"`
	PrtryId GenericIdentification84 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 PrtryId,omitempty"`
}
...
type References53Choice struct {
	SctiesSttlmTxConfId           SettlementTypeAndIdentification22 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesSttlmTxConfId,omitempty"`
	IntraPosMvmntConfId           RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 IntraPosMvmntConfId,omitempty"`
	SctiesBalAcctgRptId           RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesBalAcctgRptId,omitempty"`
	SctiesBalCtdyRptId            RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesBalCtdyRptId,omitempty"`
	IntraPosMvmntPstngRptId       RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 IntraPosMvmntPstngRptId,omitempty"`
	SctiesFincgConfId             SettlementTypeAndIdentification22 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesFincgConfId,omitempty"`
	SctiesTxPdgRptId              RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesTxPdgRptId,omitempty"`
	SctiesTxPstngRptId            RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesTxPstngRptId,omitempty"`
	SctiesSttlmTxAllgmtRptId      RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesSttlmTxAllgmtRptId,omitempty"`
	SctiesSttlmTxAllgmtNtfctnTxId SettlementTypeAndIdentification22 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesSttlmTxAllgmtNtfctnTxId,omitempty"`
	PrtflTrfNtfctnId              RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 PrtflTrfNtfctnId,omitempty"`
	SctiesSttlmTxGnrtnNtfctnId    SettlementTypeAndIdentification22 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 SctiesSttlmTxGnrtnNtfctnId,omitempty"`
	OthrMsgId                     RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 OthrMsgId,omitempty"`
	TtlPrtflValtnRptId            RestrictedFINXMax16Text           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.002.05 TtlPrtflValtnRptId,omitempty"`
}
