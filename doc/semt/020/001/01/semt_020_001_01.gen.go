...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 DtTm,omitempty"`
}
...
type PartyIdentification10Choice struct {
	BICOrBEI AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 NmAndAdr,omitempty"`
}
...
type References3Choice struct {
	SctiesSttlmTxConfId           Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesSttlmTxConfId,omitempty"`
	IntraPosMvmntConfId           Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 IntraPosMvmntConfId,omitempty"`
	SctiesBalAcctgRptId           Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesBalAcctgRptId,omitempty"`
	SctiesBalCtdyRptId            Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesBalCtdyRptId,omitempty"`
	IntraPosMvmntPstngRptId       Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 IntraPosMvmntPstngRptId,omitempty"`
	SctiesFincgConfId             Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesFincgConfId,omitempty"`
	SctiesTxPdgRptId              Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesTxPdgRptId,omitempty"`
	SctiesTxPstngRptId            Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesTxPstngRptId,omitempty"`
	SctiesSttlmTxAllgmtRptId      Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesSttlmTxAllgmtRptId,omitempty"`
	SctiesSttlmTxAllgmtNtfctnTxId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesSttlmTxAllgmtNtfctnTxId,omitempty"`
	PrtflTrfNtfctnId              Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 PrtflTrfNtfctnId,omitempty"`
	SctiesSttlmTxGnrtnNtfctnId    Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 SctiesSttlmTxGnrtnNtfctnId,omitempty"`
	OthrMsgId                     Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:semt.020.001.01 OthrMsgId,omitempty"`
}
