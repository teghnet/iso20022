...
type AccountIdentificationFormatChoice struct {
	SmplId    AccountIdentification1          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 SmplId,omitempty"`
	IdAndPurp AccountIdentificationAndPurpose `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 IdAndPurp,omitempty"`
	IdAsDSS   AccountIdentification3          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 IdAsDSS,omitempty"`
}
...
type AdditionalBalanceInformation2 struct {
	...
	SubBalTp       SecuritiesBalanceType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 SubBalTp,omitempty"`
	XtndedSubBalTp Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 XtndedSubBalTp,omitempty"`
}
...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 PrtryIdSrc,omitempty"`
}
...
type BalanceQuantity1Choice struct {
	Qty      FinancialInstrumentQuantityChoice `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Qty,omitempty"`
	QtyAsDSS GenericIdentification6            `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 QtyAsDSS,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 DtTm,omitempty"`
}
...
type FinancialInstrumentQuantityChoice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 AmtsdVal,omitempty"`
}
...
type FrequencyCodeAndDSSCode1Choice struct {
	FrqcyAsCd  EventFrequency1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 FrqcyAsCd,omitempty"`
	FrqcyAsDSS GenericIdentification7 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 FrqcyAsDSS,omitempty"`
}
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Strd,omitempty"`
}
...
type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 NmAndAdr,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 NmAndAdr,omitempty"`
}
...
type PriceInformation2 struct {
	...
	Tp        TypeOfPrice11Code                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Tp,omitempty"`
	XtndedTp  Extended350Code                  `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 XtndedTp,omitempty"`
...
type PriceRateOrAmountOrUnknownChoice struct {
	Rate     float64                                    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Rate,omitempty"`
	Amt      ActiveOrHistoricCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Amt,omitempty"`
	UknwnInd bool                                       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 UknwnInd,omitempty"`
}
...
type PriceSourceFormatChoice struct {
	LclMktPlc    MICIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 LclMktPlc,omitempty"`
	NonLclMktPlc PriceSource            `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 NonLclMktPlc,omitempty"`
	PlcAsDSS     GenericIdentification5 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 PlcAsDSS,omitempty"`
}
...
type SafekeepingPlaceFormatChoice struct {
	Id       SafekeepingPlaceAsCodeAndPartyIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Id,omitempty"`
	IdAsDSS  GenericIdentification5                       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 IdAsDSS,omitempty"`
	IdAsCtry CountryCode                                  `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 IdAsCtry,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 OthrPrtryId,omitempty"`
}
...
type StatementBasisCodeAndDSSCodeChoice struct {
	StmtBsisAsCd  StatementBasis1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 StmtBsisAsCd,omitempty"`
	StmtBsisAsDSS GenericIdentification7 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 StmtBsisAsDSS,omitempty"`
}
...
type StatementUpdateTypeCodeAndDSSCodeChoice struct {
	StmtUpdTpAsCd  StatementUpdateTypeCode `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 StmtUpdTpAsCd,omitempty"`
	StmtUpdTpAsDSS GenericIdentification7  `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 StmtUpdTpAsDSS,omitempty"`
}
...
type SubBalanceInformation2 struct {
	Qty                SubBalanceQuantity1Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Qty"`
	SubBalTp           SecuritiesBalanceType1Code      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 SubBalTp,omitempty"`
	XtndedSubBalTp     Extended350Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 XtndedSubBalTp,omitempty"`
	AddtlBalBrkdwnDtls []AdditionalBalanceInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 AddtlBalBrkdwnDtls,omitempty"`
}
...
type SubBalanceQuantity1Choice struct {
	Qty          FinancialInstrumentQuantityChoice `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 Qty,omitempty"`
	QtyAsDSS     GenericIdentification6            `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 QtyAsDSS,omitempty"`
	QtyAndAvlbty QuantityAndAvailability           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.003.001.02 QtyAndAvlbty,omitempty"`
}
