...
type AccountIdentification3Choice struct {
	IBAN      IBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 IBAN,omitempty"`
	BBAN      BBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 BBAN,omitempty"`
	UPIC      UPICIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 UPIC,omitempty"`
	PrtryAcct SimpleIdentificationInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 PrtryAcct,omitempty"`
}
...
type CashAccountIdentification2Choice struct {
	IBAN  IBANIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 IBAN,omitempty"`
	Prtry Max34Text      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Prtry,omitempty"`
}
...
type DateAndDateTime1Choice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 DtTm,omitempty"`
}
...
type Frequency4Choice struct {
	Cd    EventFrequency4Code     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Prtry,omitempty"`
}
...
type IdentificationType40Choice struct {
	Cd    TypeOfIdentification2Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Cd,omitempty"`
	Prtry GenericIdentification29   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Prtry,omitempty"`
}

type InvestorCapacity3Choice struct {
	Cd    Eligibility1Code        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Cd,omitempty"`
	Prtry GenericIdentification38 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Prtry,omitempty"`
}
...
type PartyIdentification32Choice struct {
	BIC      AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 BIC,omitempty"`
	PrtryId  GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress13        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 NmAndAdr,omitempty"`
}
...
type PurposeCode5Choice struct {
	Cd    SecuritiesAccountPurposeType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Cd,omitempty"`
	Prtry GenericIdentification38           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Prtry,omitempty"`
}
...
type StatementUpdateTypeCodeAndDSSCodeChoice struct {
	StmtUpdTpAsCd  StatementUpdateTypeCode `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 StmtUpdTpAsCd,omitempty"`
	StmtUpdTpAsDSS GenericIdentification7  `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 StmtUpdTpAsDSS,omitempty"`
}
...
type TradingPartyCapacity1Choice struct {
	Cd    TradingCapacity4Code    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Cd,omitempty"`
	Prtry GenericIdentification38 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Prtry,omitempty"`
}

type TradingPartyCapacity2Choice struct {
	Cd    TradingCapacity6Code    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Cd,omitempty"`
	Prtry GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.023.001.01 Prtry,omitempty"`
}
