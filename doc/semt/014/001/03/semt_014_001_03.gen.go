...
type AcknowledgedAcceptedStatus7Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []AcknowledgementReason3 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Rsn,omitempty"`
}
...
type AcknowledgementReason4Choice struct {
	Cd    AcknowledgementReason5Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
...
type CancellationReason12Choice struct {
	Cd    CancelledStatusReason13Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification20     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
...
type CancellationStatus7Choice struct {
	NoSpcfdRsn NoReasonCode          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []CancellationReason5 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Rsn,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 DtTm,omitempty"`
}
...
type FailingReason4Choice struct {
	Cd    FailingReason3Code      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}

type FailingStatus4Choice struct {
	NoSpcfdRsn NoReasonCode     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []FailingReason4 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Rsn,omitempty"`
}

type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 AmtsdVal,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
...
type IntraPositionProcessingStatus3Choice struct {
	Rjctd      RejectionOrRepairStatus15Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Rjctd,omitempty"`
	Rpr        RejectionOrRepairStatus15Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Rpr,omitempty"`
	Canc       CancellationStatus7Choice         `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Canc,omitempty"`
	AckdAccptd AcknowledgedAcceptedStatus7Choice `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 AckdAccptd,omitempty"`
	Prtry      ProprietaryStatusAndReason1       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
...
type PartyIdentification36Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 AnyBIC,omitempty"`
	PrtryId GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 PrtryId,omitempty"`
}
...
type PendingReason16Choice struct {
	Cd    PendingReason10Code     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
...
type PendingStatus12Choice struct {
	NoSpcfdRsn NoReasonCode     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []PendingReason8 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Rsn,omitempty"`
}
...
type RejectionAndRepairReason14Choice struct {
	Cd    RejectionReason29Code   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
...
type RejectionOrRepairStatus15Choice struct {
	NoSpcfdRsn NoReasonCode                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionOrRepairReason14 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Rsn,omitempty"`
}
...
type SecuritiesBalanceType2Choice struct {
	Cd    SecuritiesBalanceType13Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification20     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
...
type SettlementStatus9Choice struct {
	Pdg   PendingStatus12Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Pdg,omitempty"`
	Flng  FailingStatus4Choice        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Flng,omitempty"`
	Prtry ProprietaryStatusAndReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.001.03 Prtry,omitempty"`
}
