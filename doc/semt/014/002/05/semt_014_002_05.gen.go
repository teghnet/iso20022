...
type AcknowledgedAcceptedStatus25Choice struct {
	NoSpcfdRsn NoReasonCode              `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 NoSpcfdRsn,omitempty"`
	Rsn        []AcknowledgementReason13 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Rsn,omitempty"`
}
...
type AcknowledgementReason16Choice struct {
	Cd    AcknowledgementReason5Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}
...
type CancellationReason24Choice struct {
	Cd    CancelledStatusReason13Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Cd,omitempty"`
	Prtry GenericIdentification47     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}

type CancellationStatus17Choice struct {
	NoSpcfdRsn NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 NoSpcfdRsn,omitempty"`
	Rsn        []CancellationReason14 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Rsn,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 DtTm,omitempty"`
}
...
type FailingReason10Choice struct {
	Cd    FailingReason3Code      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}
...
type FailingStatus11Choice struct {
	NoSpcfdRsn NoReasonCode     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 NoSpcfdRsn,omitempty"`
	Rsn        []FailingReason9 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Rsn,omitempty"`
}

type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 AmtsdVal,omitempty"`
}
...
type IdentificationSource4Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Cd,omitempty"`
	Prtry RestrictedFINExact2Text                            `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}
...
type IntraPositionProcessingStatus6Choice struct {
	Rjctd      RejectionOrRepairStatus33Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Rjctd,omitempty"`
	Rpr        RejectionOrRepairStatus33Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Rpr,omitempty"`
	Canc       CancellationStatus17Choice         `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Canc,omitempty"`
	AckdAccptd AcknowledgedAcceptedStatus25Choice `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 AckdAccptd,omitempty"`
	Prtry      ProprietaryStatusAndReason7        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}
...
type PartyIdentification103Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 AnyBIC,omitempty"`
	PrtryId GenericIdentification84 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 PrtryId,omitempty"`
}
...
type PendingReason36Choice struct {
	Cd    PendingReason10Code     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}

type PendingStatus45Choice struct {
	NoSpcfdRsn NoReasonCode      `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 NoSpcfdRsn,omitempty"`
	Rsn        []PendingReason19 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Rsn,omitempty"`
}
...
type RejectionAndRepairReason27Choice struct {
	Cd    RejectionReason29Code   `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}
...
type RejectionOrRepairStatus33Choice struct {
	NoSpcfdRsn NoReasonCode                `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionOrRepairReason27 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Rsn,omitempty"`
}
...
type SecuritiesBalanceType11Choice struct {
	Cd    SecuritiesBalanceType13Code `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Cd,omitempty"`
	Prtry GenericIdentification47     `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}
...
type SettlementStatus20Choice struct {
	Pdg   PendingStatus45Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Pdg,omitempty"`
	Flng  FailingStatus11Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Flng,omitempty"`
	Prtry ProprietaryStatusAndReason7 `xml:"urn:iso:std:iso:20022:tech:xsd:semt.014.002.05 Prtry,omitempty"`
}
