...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 PrtryIdSrc,omitempty"`
}
...
type Charge16 struct {
	Tp       ChargeType10Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Tp,omitempty"`
	XtndedTp Extended350Code                  `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 XtndedTp,omitempty"`
	Amt      ActiveCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Amt,omitempty"`
	Rate     float64                          `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Rate,omitempty"`
}
...
type Commission9 struct {
	Tp       CommissionType6Code                        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Tp,omitempty"`
	XtndedTp Extended350Code                            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 XtndedTp,omitempty"`
	Amt      ActiveOrHistoricCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Amt,omitempty"`
	Rate     float64                                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Rate,omitempty"`
}
...
type DataFormat2Choice struct {
	Strd  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Strd,omitempty"`
	Ustrd Max140Text             `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Ustrd,omitempty"`
}

type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 DtTm,omitempty"`
}
...
type FundCashInBreakdown2 struct {
	...
	InvstmtFndTxInTp       InvestmentFundTransactionInType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 InvstmtFndTxInTp,omitempty"`
	XtndedInvstmtFndTxInTp Extended350Code                      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 XtndedInvstmtFndTxInTp,omitempty"`
	OrgnlOrdrQtyTp         OrderQuantityType2Code               `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 OrgnlOrdrQtyTp,omitempty"`
	XtndedOrgnlOrdrQtyTp   Extended350Code                      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 XtndedOrgnlOrdrQtyTp,omitempty"`
...
type FundCashOutBreakdown2 struct {
	...
	UnitsNb                 FinancialInstrumentQuantity1          `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 UnitsNb,omitempty"`
	NewAmtInd               bool                                  `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 NewAmtInd,omitempty"`
	InvstmtFndTxOutTp       InvestmentFundTransactionOutType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 InvstmtFndTxOutTp,omitempty"`
	XtndedInvstmtFndTxOutTp Extended350Code                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 XtndedInvstmtFndTxOutTp,omitempty"`
	OrgnlOrdrQtyTp          OrderQuantityType2Code                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 OrgnlOrdrQtyTp,omitempty"`
	XtndedOrgnlOrdrQtyTp    Extended350Code                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 XtndedOrgnlOrdrQtyTp,omitempty"`
	ChrgDtls                []Charge16                            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 ChrgDtls,omitempty"`
	ComssnDtls              []Commission9                         `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 ComssnDtls,omitempty"`
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 NmAndAdr,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.042.001.03 OthrPrtryId,omitempty"`
}
