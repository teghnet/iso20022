...
type ErrorHandling1Choice struct {
	Cd    ErrorHandling1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 Cd,omitempty"`
	Prtry Max4AlphaNumericText `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 Prtry,omitempty"`
}
...
type ExchangeRateReportOrError1Choice struct {
	CcyXchgRpt []CurrencyExchangeReport3 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 CcyXchgRpt,omitempty"`
	OprlErr    []ErrorHandling3          `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 OprlErr,omitempty"`
}

type ExchangeRateReportOrError2Choice struct {
	BizErr  []ErrorHandling3  `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 BizErr,omitempty"`
	CcyXchg CurrencyExchange7 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 CcyXchg,omitempty"`
}
...
type RequestType4Choice struct {
	PmtCtrl ExternalPaymentControlRequestType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 PmtCtrl,omitempty"`
	Enqry   ExternalEnquiryRequestType1Code        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 Enqry,omitempty"`
	Prtry   GenericIdentification1                 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.017.001.04 Prtry,omitempty"`
}
