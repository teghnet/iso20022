...
type AccountIdentification3Choice struct {
	IBAN      IBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 IBAN,omitempty"`
	BBAN      BBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 BBAN,omitempty"`
	UPIC      UPICIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 UPIC,omitempty"`
	PrtryAcct SimpleIdentificationInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 PrtryAcct,omitempty"`
}
...
type BalanceType2Choice struct {
	Cd    BalanceType9Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
...
type CashAccountType2 struct {
	Cd    CashAccountType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
	Prtry Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}
...
type CashBalanceAvailabilityDate1 struct {
	NbOfDays Max15PlusSignedNumericText `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 NbOfDays,omitempty"`
	ActlDt   ISODate                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 ActlDt,omitempty"`
}
...
type ChargeTypeChoice struct {
	Cd      ChargeType1Code      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
	PrtryCd Max4AlphaNumericText `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 PrtryCd,omitempty"`
}
...
type ClearingSystemMemberIdentification3Choice struct {
	Id    ExternalClearingSystemMemberCode `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Id,omitempty"`
	Prtry Max35Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}
...
type CreditorReferenceType1 struct {
	Cd    DocumentType3Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
	Prtry Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 DtTm,omitempty"`
}
...
type FinancialInstitutionIdentification5Choice struct {
	BIC         BICIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 BIC,omitempty"`
	ClrSysMmbId ClearingSystemMemberIdentification3Choice `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 ClrSysMmbId,omitempty"`
	NmAndAdr    NameAndAddress7                           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 NmAndAdr,omitempty"`
	PrtryId     GenericIdentification3                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 PrtryId,omitempty"`
	CmbndId     FinancialInstitutionIdentification3       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 CmbndId,omitempty"`
}

type FinancialInstrumentQuantityChoice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 AmtsdVal,omitempty"`
}
...
type ImpliedCurrencyAmountRangeChoice struct {
	FrAmt   AmountRangeBoundary1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 FrAmt,omitempty"`
	ToAmt   AmountRangeBoundary1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 ToAmt,omitempty"`
	FrToAmt FromToAmountRange    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 FrToAmt,omitempty"`
	EQAmt   float64              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 EQAmt,omitempty"`
	NEQAmt  float64              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 NEQAmt,omitempty"`
}

type InterestType1Choice struct {
	Cd    InterestType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
	Prtry Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}
...
type Party2Choice struct {
	OrgId  OrganisationIdentification2 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 OrgId,omitempty"`
	PrvtId []PersonIdentification3     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 PrvtId,omitempty"`
}
...
type PersonIdentification3 struct {
	DrvrsLicNb      Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 DrvrsLicNb,omitempty"`
	CstmrNb         Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 CstmrNb,omitempty"`
	SclSctyNb       Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 SclSctyNb,omitempty"`
	AlnRegnNb       Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 AlnRegnNb,omitempty"`
	PsptNb          Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 PsptNb,omitempty"`
	TaxIdNb         Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 TaxIdNb,omitempty"`
	IdntyCardNb     Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 IdntyCardNb,omitempty"`
	MplyrIdNb       Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 MplyrIdNb,omitempty"`
	DtAndPlcOfBirth DateAndPlaceOfBirth    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 DtAndPlcOfBirth,omitempty"`
	OthrId          GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 OthrId,omitempty"`
	Issr            Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Issr,omitempty"`
}
...
type Purpose1Choice struct {
	Cd    ExternalPurposeCode `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
	Prtry Max35Text           `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}
...
type RateTypeChoice struct {
	PctgRate float64   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 PctgRate,omitempty"`
	TxtlRate Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 TxtlRate,omitempty"`
}

type ReferredDocumentAmount1Choice struct {
	DuePyblAmt   CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 DuePyblAmt,omitempty"`
	DscntApldAmt CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 DscntApldAmt,omitempty"`
	RmtdAmt      CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 RmtdAmt,omitempty"`
	CdtNoteAmt   CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 CdtNoteAmt,omitempty"`
	TaxAmt       CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 TaxAmt,omitempty"`
}
...
type ReferredDocumentType1 struct {
	Cd    DocumentType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
	Prtry Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
	Issr  Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Issr,omitempty"`
}
...
type ReturnReason1Choice struct {
	Cd    TransactionRejectReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Cd,omitempty"`
	Prtry Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}
...
type SecurityIdentification4Choice struct {
	ISIN  ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 ISIN,omitempty"`
	Prtry AlternateSecurityIdentification2 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}
...
type TransactionPrice1Choice struct {
	DealPric CurrencyAndAmount   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 DealPric,omitempty"`
	Prtry    []ProprietaryPrice1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}

type TransactionQuantities1Choice struct {
	Qty   FinancialInstrumentQuantityChoice `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Qty,omitempty"`
	Prtry ProprietaryQuantity1              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.053.001.01 Prtry,omitempty"`
}
