...
type AccountIdentification4Choice struct {
	IBAN IBAN2007Identifier            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 IBAN,omitempty"`
	Othr GenericAccountIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Othr,omitempty"`
}

type AccountIdentificationSearchCriteria2Choice struct {
	EQ     AccountIdentification4Choice `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 EQ,omitempty"`
	CTTxt  Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 CTTxt,omitempty"`
	NCTTxt Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 NCTTxt,omitempty"`
}

type AccountSchemeName1Choice struct {
	Cd    ExternalAccountIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text                          `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}

type ActiveAmountRange3Choice struct {
	ImpldCcyAndAmtRg ImpliedCurrencyAndAmountRange1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 ImpldCcyAndAmtRg,omitempty"`
	CcyAndAmtRg      ActiveCurrencyAndAmountRange3  `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 CcyAndAmtRg,omitempty"`
}
...
type ActiveOrHistoricAmountRange2Choice struct {
	ImpldCcyAndAmtRg ImpliedCurrencyAndAmountRange1          `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 ImpldCcyAndAmtRg,omitempty"`
	CcyAndAmtRg      ActiveOrHistoricCurrencyAndAmountRange2 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 CcyAndAmtRg,omitempty"`
}
...
type AddressType3Choice struct {
	Cd    AddressType2Code        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type ClearingSystemIdentification2Choice struct {
	Cd    ExternalClearingSystemIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text                                 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}

type ClearingSystemIdentification3Choice struct {
	Cd    ExternalCashClearingSystem1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type DateAndDateTimeSearch3Choice struct {
	DtTmSch DateTimePeriod1Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 DtTmSch,omitempty"`
	DtSch   DatePeriodSearch1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 DtSch,omitempty"`
}
...
type DatePeriodSearch1Choice struct {
	FrDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 FrDt,omitempty"`
	ToDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 ToDt,omitempty"`
	FrToDt DatePeriod2 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 FrToDt,omitempty"`
	EQDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 EQDt,omitempty"`
	NEQDt  ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 NEQDt,omitempty"`
}
...
type DateTimePeriod1Choice struct {
	FrDtTm ISODateTime     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 FrDtTm,omitempty"`
	ToDtTm ISODateTime     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 ToDtTm,omitempty"`
	DtTmRg DateTimePeriod1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 DtTmRg,omitempty"`
}
...
type FinancialIdentificationSchemeName1Choice struct {
	Cd    ExternalFinancialInstitutionIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text                                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type ImpliedCurrencyAmountRange1Choice struct {
	FrAmt   AmountRangeBoundary1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 FrAmt,omitempty"`
	ToAmt   AmountRangeBoundary1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 ToAmt,omitempty"`
	FrToAmt FromToAmountRange1   `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 FrToAmt,omitempty"`
	EQAmt   float64              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 EQAmt,omitempty"`
	NEQAmt  float64              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 NEQAmt,omitempty"`
}
...
type OrganisationIdentificationSchemeName1Choice struct {
	Cd    ExternalOrganisationIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text                               `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type Party38Choice struct {
	OrgId  OrganisationIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 OrgId,omitempty"`
	PrvtId PersonIdentification13       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 PrvtId,omitempty"`
}

type Party40Choice struct {
	Pty PartyIdentification135                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Pty,omitempty"`
	Agt BranchAndFinancialInstitutionIdentification6 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Agt,omitempty"`
}
...
type PaymentIdentification6Choice struct {
	TxId      Max35Text                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 TxId,omitempty"`
	QId       QueueTransactionIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 QId,omitempty"`
	LngBizId  LongPaymentIdentification2      `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 LngBizId,omitempty"`
	ShrtBizId ShortPaymentIdentification2     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 ShrtBizId,omitempty"`
	PrtryId   Max70Text                       `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 PrtryId,omitempty"`
}
...
type PaymentOrigin1Choice struct {
	FINMT    Max3NumericText        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 FINMT,omitempty"`
	XMLMsgNm Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 XMLMsgNm,omitempty"`
	Prtry    Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
	Instrm   PaymentInstrument1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Instrm,omitempty"`
}
...
type PaymentStatusCodeSearch2Choice struct {
	PdgSts       PendingStatus4Code     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 PdgSts,omitempty"`
	FnlSts       FinalStatusCode        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 FnlSts,omitempty"`
	PdgAndFnlSts CashPaymentStatus2Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 PdgAndFnlSts,omitempty"`
}
...
type PaymentType4Choice struct {
	Cd    PaymentType3Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type PersonIdentificationSchemeName1Choice struct {
	Cd    ExternalPersonIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text                         `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type Priority1Choice struct {
	Cd    Priority5Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Cd,omitempty"`
	Prtry Max35Text     `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type RequestType4Choice struct {
	PmtCtrl ExternalPaymentControlRequestType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 PmtCtrl,omitempty"`
	Enqry   ExternalEnquiryRequestType1Code        `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Enqry,omitempty"`
	Prtry   GenericIdentification1                 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 Prtry,omitempty"`
}
...
type TransactionCriteria5Choice struct {
	QryNm   Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 QryNm,omitempty"`
	NewCrit TransactionCriteria8 `xml:"urn:iso:std:iso:20022:tech:xsd:camt.005.001.08 NewCrit,omitempty"`
}
