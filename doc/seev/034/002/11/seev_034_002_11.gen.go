...
type AcceptedReason11Choice struct {
	Cd    AcknowledgementReason7Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}

type AcceptedStatus9Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 NoSpcfdRsn,omitempty"`
	Rsn        []AcceptedStatusReason10 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Rsn,omitempty"`
}
...
type CancelledReason11Choice struct {
	Cd    CancelledStatusReason6Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}

type CancelledStatus15Choice struct {
	NoSpcfdRsn NoReasonCode              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 NoSpcfdRsn,omitempty"`
	Rsn        []CancelledStatusReason14 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Rsn,omitempty"`
}
...
type CashAccountIdentification6Choice struct {
	IBAN  IBAN2007Identifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 IBAN,omitempty"`
	Prtry RestrictedFINX2Max34Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}
...
type CorporateActionEventType90Choice struct {
	Cd    CorporateActionEventType29Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry GenericIdentification47        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}
...
type CorporateActionOption34Choice struct {
	Cd    CorporateActionOption14Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry GenericIdentification47     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}
...
type DocumentIdentification4Choice struct {
	AcctSvcrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 AcctOwnrDocId,omitempty"`
}

type DocumentNumber6Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 LngNb,omitempty"`
	PrtryNb GenericIdentification86           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 PrtryNb,omitempty"`
}
...
type FinancialInstrumentQuantity15Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 AmtsdVal,omitempty"`
}
...
type IdentificationSource4Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry RestrictedFINExact2Text                            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}

type InstructionProcessingStatus39Choice struct {
	Canc               CancelledStatus15Choice     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Canc,omitempty"`
	AccptdForFrthrPrcg AcceptedStatus9Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 AccptdForFrthrPrcg,omitempty"`
	Rjctd              RejectedStatus33Choice      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Rjctd,omitempty"`
	Pdg                PendingStatus60Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Pdg,omitempty"`
	DfltActn           NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 DfltActn,omitempty"`
	StgInstr           NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 StgInstr,omitempty"`
	PrtrySts           ProprietaryStatusAndReason7 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 PrtrySts,omitempty"`
}
...
type OptionFeaturesFormat27Choice struct {
	Cd    OptionFeatures12Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}

type OptionNumber1Choice struct {
	Nb Exact3NumericText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Nb,omitempty"`
	Cd OptionNumber1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
}
...
type PartyIdentification136Choice struct {
	AnyBIC  AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 AnyBIC,omitempty"`
	PrtryId GenericIdentification84 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 PrtryId,omitempty"`
}
...
type PendingReason56Choice struct {
	Cd    PendingReason18Code     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}

type PendingStatus60Choice struct {
	NoSpcfdRsn NoReasonCode            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 NoSpcfdRsn,omitempty"`
	Rsn        []PendingStatusReason20 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Rsn,omitempty"`
}
...
type Quantity10Choice struct {
	Qty             FinancialInstrumentQuantity15Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities4       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 OrgnlAndCurFace,omitempty"`
}

type Quantity21Choice struct {
	Qty      FinancialInstrumentQuantity15Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Qty,omitempty"`
	PrtryQty ProprietaryQuantity9                `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 PrtryQty,omitempty"`
}

type RejectedReason32Choice struct {
	Cd    RejectionReason54Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}

type RejectedStatus33Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 NoSpcfdRsn,omitempty"`
	Rsn        []RejectedStatusReason31 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Rsn,omitempty"`
}
...
type SafekeepingPlaceFormat32Choice struct {
	Id      SafekeepingPlaceTypeAndText9           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Id,omitempty"`
	Ctry    CountryCode                            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 TpAndId,omitempty"`
	Prtry   GenericIdentification85                `xml:"urn:iso:std:iso:20022:tech:xsd:seev.034.002.11 Prtry,omitempty"`
}
