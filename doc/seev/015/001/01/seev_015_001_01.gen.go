...
type AgentCAElectionStatusAdviceV01 struct {
	...
	AgtCAElctnAdvcId      DocumentIdentification8           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 AgtCAElctnAdvcId,omitempty"`
	AgtCAElctnCxlReqId    DocumentIdentification8           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 AgtCAElctnCxlReqId,omitempty"`
	AgtCAElctnAmdmntReqId DocumentIdentification8           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 AgtCAElctnAmdmntReqId,omitempty"`
	CorpActnGnlInf        CorporateActionInformation1       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 CorpActnGnlInf"`
	ElctnAdvcSts          ElectionAdviceStatus1Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 ElctnAdvcSts,omitempty"`
	ElctnCxlReqSts        ElectionCancellationStatus1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 ElctnCxlReqSts,omitempty"`
	ElctnAmdmntReqSts     ElectionAmendmentStatus1Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 ElctnAmdmntReqSts,omitempty"`
}

type AlternateSecurityIdentification3 struct {
	Id         Max70Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Id"`
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 PrtryIdSrc,omitempty"`
}
...
type CorporateActionEventProcessingType1FormatChoice struct {
	Cd    CorporateActionEventProcessingType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}
...
type CorporateActionEventType2FormatChoice struct {
	Cd    CorporateActionEventType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}
...
type CorporateActionMandatoryVoluntary1FormatChoice struct {
	Cd    CorporateActionMandatoryVoluntary1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13                `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}
...
type ElectionAdviceStatus1Choice struct {
	PrcdSts  CorporateActionInstructionProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 PrcdSts,omitempty"`
	RjctdSts CorporateActionInstructionRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 RjctdSts,omitempty"`
}

type ElectionAmendmentStatus1Choice struct {
	PrcdSts  CorporateActionAmendmentProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 PrcdSts,omitempty"`
	RjctdSts CorporateActionAmendmentRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 RjctdSts,omitempty"`
}

type ElectionCancellationStatus1Choice struct {
	PrcdSts  CorporateActionCancellationProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 PrcdSts,omitempty"`
	RjctdSts CorporateActionCancellationRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 RjctdSts,omitempty"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 NmAndAdr,omitempty"`
}
...
type ProcessedStatus3FormatChoice struct {
	Cd    ProcessedStatus3Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}
...
type ProcessedStatus5FormatChoice struct {
	Cd    ProcessedStatus5Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}
...
type RejectionReason18FormatChoice struct {
	Cd    RejectionReason18Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}
...
type RejectionReason8FormatChoice struct {
	Cd    RejectionReason8Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}
...
type RejectionReason9FormatChoice struct {
	Cd    RejectionReason9Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 Prtry,omitempty"`
}

type SecurityIdentification7 struct {
	ISIN   ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 ISIN,omitempty"`
	OthrId AlternateSecurityIdentification3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.015.001.01 OthrId,omitempty"`
