...
type CorporateActionEventType90Choice struct {
	Cd    CorporateActionEventType29Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Cd,omitempty"`
	Prtry GenericIdentification47        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Prtry,omitempty"`
}
...
type DocumentIdentification4Choice struct {
	AcctSvcrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 AcctOwnrDocId,omitempty"`
}

type DocumentNumber6Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 LngNb,omitempty"`
	PrtryNb GenericIdentification86           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 PrtryNb,omitempty"`
}

type EventProcessingStatus6Choice struct {
	Cmplt    NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Cmplt,omitempty"`
	Rcncld   NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Rcncld,omitempty"`
	Pdg      PendingStatus59Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Pdg,omitempty"`
	PrtrySts ProprietaryStatusAndReason7 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 PrtrySts,omitempty"`
}
...
type PendingReason55Choice struct {
	Cd    PendingReason19Code     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Prtry,omitempty"`
}

type PendingStatus59Choice struct {
	NoSpcfdRsn NoReasonCode            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 NoSpcfdRsn,omitempty"`
	Rsn        []PendingStatusReason19 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.07 Rsn,omitempty"`
}
