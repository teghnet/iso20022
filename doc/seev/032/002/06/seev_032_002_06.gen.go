...
type CorporateActionEventType58Choice struct {
	Cd    CorporateActionEventType20Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Cd,omitempty"`
	Prtry GenericIdentification47        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Prtry,omitempty"`
}
...
type DocumentIdentification4Choice struct {
	AcctSvcrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 AcctOwnrDocId,omitempty"`
}

type DocumentNumber6Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 LngNb,omitempty"`
	PrtryNb GenericIdentification86           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 PrtryNb,omitempty"`
}

type EventProcessingStatus4Choice struct {
	Cmplt    NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Cmplt,omitempty"`
	Rcncld   NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Rcncld,omitempty"`
	Pdg      PendingStatus43Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Pdg,omitempty"`
	PrtrySts ProprietaryStatusAndReason7 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 PrtrySts,omitempty"`
}
...
type PendingReason34Choice struct {
	Cd    PendingReason4Code      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Prtry,omitempty"`
}
...
type PendingStatus43Choice struct {
	NoSpcfdRsn NoReasonCode            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 NoSpcfdRsn,omitempty"`
	Rsn        []PendingStatusReason11 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.002.06 Rsn,omitempty"`
}
