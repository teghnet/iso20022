...
type CorporateActionEventType52Choice struct {
	Cd    CorporateActionEventType20Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Cd,omitempty"`
	Prtry GenericIdentification30        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Prtry,omitempty"`
}
...
type DocumentIdentification3Choice struct {
	AcctSvcrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 AcctOwnrDocId,omitempty"`
}
...
type DocumentNumber5Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 LngNb,omitempty"`
	PrtryNb GenericIdentification36           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 PrtryNb,omitempty"`
}

type EventProcessingStatus3Choice struct {
	Cmplt    NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Cmplt,omitempty"`
	Rcncld   NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Rcncld,omitempty"`
	Pdg      PendingStatus41Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Pdg,omitempty"`
	PrtrySts ProprietaryStatusAndReason6 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 PrtrySts,omitempty"`
}
...
type PendingReason32Choice struct {
	Cd    PendingReason4Code      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Prtry,omitempty"`
}
...
type PendingStatus41Choice struct {
	NoSpcfdRsn NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 NoSpcfdRsn,omitempty"`
	Rsn        []PendingStatusReason9 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.06 Rsn,omitempty"`
}
