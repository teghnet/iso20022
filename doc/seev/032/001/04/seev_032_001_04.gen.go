...
type CorporateActionEventType11Choice struct {
	Cd    CorporateActionEventType10Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Cd,omitempty"`
	Prtry GenericIdentification20        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Prtry,omitempty"`
}
...
type DocumentIdentification1Choice struct {
	AcctSvcrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 AcctOwnrDocId,omitempty"`
}
...
type DocumentNumber1Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 LngNb,omitempty"`
	PrtryNb GenericIdentification19           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 PrtryNb,omitempty"`
}

type EventProcessingStatus1Choice struct {
	Cmplt    NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Cmplt,omitempty"`
	Rcncld   NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Rcncld,omitempty"`
	Pdg      PendingStatus2Choice        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Pdg,omitempty"`
	PrtrySts ProprietaryStatusAndReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 PrtrySts,omitempty"`
}
...
type PendingReason4Choice struct {
	Cd    PendingReason4Code      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Prtry,omitempty"`
}
...
type PendingStatus2Choice struct {
	NoSpcfdRsn NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 NoSpcfdRsn,omitempty"`
	Rsn        []PendingStatusReason2 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.04 Rsn,omitempty"`
}
