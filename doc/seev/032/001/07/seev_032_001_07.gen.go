...
type CorporateActionEventType85Choice struct {
	Cd    CorporateActionEventType29Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Cd,omitempty"`
	Prtry GenericIdentification30        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Prtry,omitempty"`
}
...
type DocumentIdentification3Choice struct {
	AcctSvcrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 AcctOwnrDocId,omitempty"`
}
...
type DocumentNumber5Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 LngNb,omitempty"`
	PrtryNb GenericIdentification36           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 PrtryNb,omitempty"`
}

type EventProcessingStatus5Choice struct {
	Cmplt    NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Cmplt,omitempty"`
	Rcncld   NoSpecifiedReason1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Rcncld,omitempty"`
	Pdg      PendingStatus58Choice       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Pdg,omitempty"`
	PrtrySts ProprietaryStatusAndReason6 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 PrtrySts,omitempty"`
}
...
type PendingReason54Choice struct {
	Cd    PendingReason19Code     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Prtry,omitempty"`
}

type PendingStatus58Choice struct {
	NoSpcfdRsn NoReasonCode            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 NoSpcfdRsn,omitempty"`
	Rsn        []PendingStatusReason18 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.032.001.07 Rsn,omitempty"`
}
