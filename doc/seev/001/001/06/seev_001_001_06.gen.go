...
type AdditionalRightCode1Choice struct {
	Cd    AdditionalRight1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prtry,omitempty"`
}

type AdditionalRightThreshold1Choice struct {
	AddtlRghtThrshld     Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 AddtlRghtThrshld,omitempty"`
	AddtlRghtThrshldPctg float64   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 AddtlRghtThrshldPctg,omitempty"`
}
...
type DateAndDateTime2Choice struct {
	...
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 DtTm,omitempty"`
}
...
type DateFormat3Choice struct {
	Dt   ISODate       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Dt,omitempty"`
	DtCd DateType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 DtCd,omitempty"`
}

type DateFormat58Choice struct {
	DtOrDtTm DateAndDateTime2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 DtOrDtTm,omitempty"`
	DtCd     DateType1Code          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 DtCd,omitempty"`
}
...
type Entitlement1Choice struct {
	EntitlmntRatio float64   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 EntitlmntRatio,omitempty"`
	EntitlmntDesc  Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 EntitlmntDesc,omitempty"`
}
...
type FinancialInstrumentQuantity18Choice struct {
	Unit    float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Unit,omitempty"`
	FaceAmt float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 FaceAmt,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prtry,omitempty"`
}

type IdentificationType45Choice struct {
	Cd    TypeOfIdentification4Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification30   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prtry,omitempty"`
}
...
type IncentivePremiumType1Choice struct {
	PerScty    float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 PerScty,omitempty"`
	PerVote    float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 PerVote,omitempty"`
	PerAttndee bool    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 PerAttndee,omitempty"`
}
...
type LocationFormat1Choice struct {
	...
	LctnCd PlaceType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 LctnCd,omitempty"`
}
...
type MeetingEventReference1Choice struct {
	LkdIssrMtgId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 LkdIssrMtgId,omitempty"`
	LkdMtgId     Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 LkdMtgId,omitempty"`
}
...
type MeetingTypeClassification2Choice struct {
	Cd    MeetingTypeClassification2Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification13        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prtry,omitempty"`
}
...
type NumberOrPercentage1Choice struct {
	ThrshldPctg float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 ThrshldPctg,omitempty"`
	ThrshldNb   float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 ThrshldNb,omitempty"`
}
...
type ParticipationMethod1Choice struct {
	Cd    VotingParticipationMethod1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification30        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prtry,omitempty"`
}

type PartyIdentification129Choice struct {
	AnyBIC   AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 AnyBIC,omitempty"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 NmAndAdr,omitempty"`
	LEI      LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 LEI,omitempty"`
}

type PartyIdentification198Choice struct {
	NtlRegnNb Max35Text               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 NtlRegnNb,omitempty"`
	LEI       LEIIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 LEI,omitempty"`
	AnyBIC    AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 AnyBIC,omitempty"`
	ClntId    Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 ClntId,omitempty"`
	PrtryId   GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 PrtryId,omitempty"`
}
...
type PartyIdentification223Choice struct {
	LglPrsn  PartyIdentification221 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 LglPrsn,omitempty"`
	NtrlPrsn PartyIdentification222 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 NtrlPrsn,omitempty"`
}
...
type PartyIdentification227Choice struct {
	LglPrsn  PartyIdentification224   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 LglPrsn,omitempty"`
	NtrlPrsn []PartyIdentification225 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 NtrlPrsn,omitempty"`
}
...
type PriceRateOrAmount3Choice struct {
	Rate float64                                    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Rate,omitempty"`
	Amt  ActiveOrHistoricCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Amt,omitempty"`
}
...
type Proxy3Choice struct {
	Prxy         ProxyAppointmentInformation4 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prxy,omitempty"`
	PrxyNotAllwd ProxyNotAllowed1Code         `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 PrxyNotAllwd,omitempty"`
}
...
type QuorumQuantity1Choice struct {
	QrmQty     Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 QrmQty,omitempty"`
	QrmQtyPctg float64   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 QrmQtyPctg,omitempty"`
}
...
type SafekeepingPlaceFormat28Choice struct {
	Id      SafekeepingPlaceTypeAndText6           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Id,omitempty"`
	Ctry    CountryCode                            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 TpAndId,omitempty"`
	Prtry   GenericIdentification78                `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prtry,omitempty"`
}
...
type VoteInstructionType1Choice struct {
	Tp    VoteInstruction6Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Tp,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.06 Prtry,omitempty"`
}
