...
type AlternateFinancialInstrumentIdentification1 struct {
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max16Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 PrtryIdSrc,omitempty"`
...
type DateFormat2Choice struct {
	Dt   ISODateTime   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 Dt,omitempty"`
	DtCd DateType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 DtCd,omitempty"`
}
...
type IncentivePremium2 struct {
	...
	PerScty    float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 PerScty,omitempty"`
	PerVote    float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 PerVote,omitempty"`
	PerAttndee bool                    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 PerAttndee,omitempty"`
...
type LocationFormat1Choice struct {
	Adr    PostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 Adr,omitempty"`
	LctnCd PlaceType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 LctnCd,omitempty"`
}
...
type PartyIdentification9Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 NmAndAdr,omitempty"`
}

type PersonIdentification2 struct {
	DrvrsLicNb  Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 DrvrsLicNb,omitempty"`
	SclSctyNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 SclSctyNb,omitempty"`
	AlnRegnNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 AlnRegnNb,omitempty"`
	PsptNb      Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 PsptNb,omitempty"`
	TaxIdNb     Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 TaxIdNb,omitempty"`
	IdntyCardNb Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 IdntyCardNb,omitempty"`
	MplyrIdNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 MplyrIdNb,omitempty"`
	OthrId      GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 OthrId,omitempty"`
	Issr        Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 Issr,omitempty"`
}
...
type PriceRateOrAmountChoice struct {
	Rate float64                                    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 Rate,omitempty"`
	Amt  ActiveOrHistoricCurrencyAnd13DecimalAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 Amt,omitempty"`
}
...
type SafekeepingPlaceFormatChoice struct {
	Id       SafekeepingPlaceAsCodeAndPartyIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 Id,omitempty"`
	IdAsDSS  GenericIdentification5                       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 IdAsDSS,omitempty"`
	IdAsCtry CountryCode                                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 IdAsCtry,omitempty"`
}
...
type UnitOrFaceAmountChoice struct {
	Unit    float64           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 Unit,omitempty"`
	FaceAmt CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.001.001.02 FaceAmt,omitempty"`
}
