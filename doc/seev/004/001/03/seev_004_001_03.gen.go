...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Prtry,omitempty"`
}
...
type LongPostalAddress2Choice struct {
	Ustrd Max350Text     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Ustrd,omitempty"`
	Strd  PostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Strd,omitempty"`
}
...
type MeetingTypeClassification1Choice struct {
	Cd    MeetingTypeClassification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Cd,omitempty"`
	Prtry GenericIdentification13        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Prtry,omitempty"`
}
...
type PartyIdentification9Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 NmAndAdr,omitempty"`
}
...
type PersonIdentificationType1Choice struct {
	PsptNb      Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 PsptNb,omitempty"`
	TaxIdNb     Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 TaxIdNb,omitempty"`
	SclSctyNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 SclSctyNb,omitempty"`
	MplyrIdNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 MplyrIdNb,omitempty"`
	DrvrsLicNb  Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 DrvrsLicNb,omitempty"`
	AlnRegnNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 AlnRegnNb,omitempty"`
	IdntyCardNb Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 IdntyCardNb,omitempty"`
	OthrId      GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 OthrId,omitempty"`
}
...
type SafekeepingPlaceFormatChoice struct {
	Id       SafekeepingPlaceAsCodeAndPartyIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Id,omitempty"`
	IdAsDSS  GenericIdentification5                       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 IdAsDSS,omitempty"`
	IdAsCtry CountryCode                                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 IdAsCtry,omitempty"`
}
...
type SecurityIdentification11Choice struct {
	ISIN   ISINIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 ISIN,omitempty"`
	OthrId AlternateIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 OthrId,omitempty"`
}
...
type UnitOrFaceAmountOrCode1Choice struct {
	Unit    float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Unit,omitempty"`
	FaceAmt ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 FaceAmt,omitempty"`
	Cd      Quantity1Code           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Cd,omitempty"`
}

type Vote2Choice struct {
	VoteInstr    []Vote4 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 VoteInstr,omitempty"`
	GblVoteInstr []Vote3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 GblVoteInstr,omitempty"`
}
...
type VoteInstructionForMeetingResolution1Choice struct {
	VoteIndctn VoteInstructionAtMeeting1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 VoteIndctn,omitempty"`
	Shrhldr    NameAndAddress9               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.03 Shrhldr,omitempty"`
}
