...
type AlternateFinancialInstrumentIdentification1 struct {
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max16Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 PrtryIdSrc,omitempty"`
...
type LongPostalAddress2Choice struct {
	Ustrd Max350Text     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 Ustrd,omitempty"`
	Strd  PostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 Strd,omitempty"`
}
...
type PartyIdentification9Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 NmAndAdr,omitempty"`
}

type PersonIdentification2 struct {
	DrvrsLicNb  Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 DrvrsLicNb,omitempty"`
	SclSctyNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 SclSctyNb,omitempty"`
	AlnRegnNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 AlnRegnNb,omitempty"`
	PsptNb      Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 PsptNb,omitempty"`
	TaxIdNb     Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 TaxIdNb,omitempty"`
	IdntyCardNb Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 IdntyCardNb,omitempty"`
	MplyrIdNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 MplyrIdNb,omitempty"`
	OthrId      GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 OthrId,omitempty"`
	Issr        Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 Issr,omitempty"`
}
...
type SafekeepingPlaceFormatChoice struct {
	Id       SafekeepingPlaceAsCodeAndPartyIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 Id,omitempty"`
	IdAsDSS  GenericIdentification5                       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 IdAsDSS,omitempty"`
	IdAsCtry CountryCode                                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 IdAsCtry,omitempty"`
}
...
type UnitOrFaceAmountOrCodeChoice struct {
	Unit    float64           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 Unit,omitempty"`
	FaceAmt CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 FaceAmt,omitempty"`
	Cd      Quantity1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 Cd,omitempty"`
}

type Vote1Choice struct {
	VoteInstr    []Vote4 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 VoteInstr,omitempty"`
	GblVoteInstr []Vote3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 GblVoteInstr,omitempty"`
}
...
type VoteInstructionForMeetingResolution1 struct {
	VoteIndctn VoteInstructionAtMeeting1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 VoteIndctn,omitempty"`
	Shrhldr    NameAndAddress9               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.004.001.02 Shrhldr,omitempty"`
}
