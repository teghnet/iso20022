...
type AlternateFinancialInstrumentIdentification1 struct {
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max16Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 PrtryIdSrc,omitempty"`
...
type CancellationRejectionStatus1 struct {
	Rsn       RejectionReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 Rsn,omitempty"`
	XtndedRsn Extended350Code      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 XtndedRsn,omitempty"`
	AddtlInf  Max350Text           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 AddtlInf,omitempty"`
}

type CancellationStatus1Choice struct {
	PrcgSts  CancellationProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 PrcgSts,omitempty"`
	RjctnSts CancellationRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 RjctnSts,omitempty"`
}
...
type InstructionRejectionStatus1 struct {
	Rsn       RejectionReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 Rsn,omitempty"`
	XtndedRsn Extended350Code      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 XtndedRsn,omitempty"`
	AddtlInf  Max350Text           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 AddtlInf,omitempty"`
}

type InstructionStatus1Choice struct {
	GblInstrSts  InstructionStatus2Choice     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 GblInstrSts,omitempty"`
	DtldInstrSts []DetailedInstructionStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 DtldInstrSts,omitempty"`
}

type InstructionStatus2Choice struct {
	PrcgSts  InstructionProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 PrcgSts,omitempty"`
	RjctnSts InstructionRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 RjctnSts,omitempty"`
}
...
type MeetingInstructionStatusV02 struct {
	...
	InstrId       MessageIdentification      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 InstrId,omitempty"`
	InstrCxlId    MessageIdentification      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 InstrCxlId,omitempty"`
	...
	InstrSts      InstructionStatus1Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 InstrSts,omitempty"`
	CxlSts        CancellationStatus1Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 CxlSts,omitempty"`
}
...
type PartyIdentification9Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.02 NmAndAdr,omitempty"`
}
