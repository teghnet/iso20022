...
type CancellationRejectionStatus1Choice struct {
	Cd    RejectionReason2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Prtry,omitempty"`
}

type CancellationStatus2Choice struct {
	PrcgSts  CancellationProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 PrcgSts,omitempty"`
	RjctnSts AdditionalStatus2             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 RjctnSts,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Prtry,omitempty"`
}
...
type InstructionRejectionStatus1Choice struct {
	Cd    RejectionReason1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Prtry,omitempty"`
}

type InstructionStatus5Choice struct {
	GblInstrSts  InstructionStatus6Choice      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 GblInstrSts,omitempty"`
	DtldInstrSts []DetailedInstructionStatus11 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 DtldInstrSts,omitempty"`
}

type InstructionStatus6Choice struct {
	PrcgSts  InstructionProcessingStatus3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 PrcgSts,omitempty"`
	RjctnSts AdditionalStatus1            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 RjctnSts,omitempty"`
}

type InstructionType1Choice struct {
	InstrId    MessageIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 InstrId,omitempty"`
	InstrCxlId MessageIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 InstrCxlId,omitempty"`
}

type InstructionTypeStatus2Choice struct {
	InstrSts InstructionStatus5Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 InstrSts,omitempty"`
	CxlSts   CancellationStatus2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 CxlSts,omitempty"`
}
...
type MeetingTypeClassification1Choice struct {
	Cd    MeetingTypeClassification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Cd,omitempty"`
	Prtry GenericIdentification13        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.05 Prtry,omitempty"`
}
