...
type CancellationRejectionStatus1Choice struct {
	Cd    RejectionReason2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Prtry,omitempty"`
}

type CancellationStatus2Choice struct {
	PrcgSts  CancellationProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 PrcgSts,omitempty"`
	RjctnSts AdditionalStatus2             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 RjctnSts,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Prtry,omitempty"`
}
...
type InstructionRejectionStatus1Choice struct {
	Cd    RejectionReason1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Prtry,omitempty"`
}

type InstructionStatus3Choice struct {
	GblInstrSts  InstructionStatus4Choice     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 GblInstrSts,omitempty"`
	DtldInstrSts []DetailedInstructionStatus8 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 DtldInstrSts,omitempty"`
}

type InstructionStatus4Choice struct {
	PrcgSts  InstructionProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 PrcgSts,omitempty"`
	RjctnSts AdditionalStatus1            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 RjctnSts,omitempty"`
}

type InstructionType1Choice struct {
	InstrId    MessageIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 InstrId,omitempty"`
	InstrCxlId MessageIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 InstrCxlId,omitempty"`
}

type InstructionTypeStatus1Choice struct {
	InstrSts InstructionStatus3Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 InstrSts,omitempty"`
	CxlSts   CancellationStatus2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 CxlSts,omitempty"`
}
...
type MeetingTypeClassification1Choice struct {
	Cd    MeetingTypeClassification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Cd,omitempty"`
	Prtry GenericIdentification13        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 Prtry,omitempty"`
}
...
type PartyIdentification9Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 NmAndAdr,omitempty"`
}
...
type SecurityIdentification11Choice struct {
	ISIN   ISINIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 ISIN,omitempty"`
	OthrId AlternateIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.006.001.04 OthrId,omitempty"`
}
