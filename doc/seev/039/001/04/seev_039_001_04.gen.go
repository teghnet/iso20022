...
type AccountIdentification13Choice struct {
	ForAllAccts AccountIdentification10   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 ForAllAccts,omitempty"`
	AcctsList   []AccountIdentification15 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 AcctsList,omitempty"`
}
...
type CorporateActionEventType13Choice struct {
	Cd    CorporateActionEventType12Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Cd,omitempty"`
	Prtry GenericIdentification20        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Prtry,omitempty"`
}
...
type CorporateActionMandatoryVoluntary1Choice struct {
	Cd    CorporateActionMandatoryVoluntary1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Cd,omitempty"`
	Prtry GenericIdentification20                `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Prtry,omitempty"`
}
...
type CorporateActionProcessingStatus1Choice struct {
	EvtSts        CorporateActionEventStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 EvtSts,omitempty"`
	ForInfOnlyInd bool                        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 ForInfOnlyInd,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Prtry,omitempty"`
}
...
type PartyIdentification36Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 AnyBIC,omitempty"`
	PrtryId GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 PrtryId,omitempty"`
}

type PartyIdentification46Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 AnyBIC,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 NmAndAdr,omitempty"`
}
...
type SafekeepingPlaceFormat2Choice struct {
	Id      SafekeepingPlaceTypeAndText2             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Id,omitempty"`
	Ctry    CountryCode                              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndAnyBICIdentifier1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 TpAndId,omitempty"`
	Prtry   GenericIdentification21                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.039.001.04 Prtry,omitempty"`
}
