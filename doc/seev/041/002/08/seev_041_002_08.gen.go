...
type CancelledReason10Choice struct {
	Cd    CancelledStatusReason5Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}

type CancelledStatus14Choice struct {
	NoSpcfdRsn NoReasonCode              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 NoSpcfdRsn,omitempty"`
	Rsn        []CancelledStatusReason13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Rsn,omitempty"`
}
...
type CashAccountIdentification6Choice struct {
	IBAN  IBAN2007Identifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 IBAN,omitempty"`
	Prtry RestrictedFINX2Max34Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}
...
type CorporateActionEventType58Choice struct {
	Cd    CorporateActionEventType20Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Cd,omitempty"`
	Prtry GenericIdentification47        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}
...
type CorporateActionOption22Choice struct {
	Cd    CorporateActionOption10Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Cd,omitempty"`
	Prtry GenericIdentification47     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}
...
type DocumentIdentification4Choice struct {
	AcctSvcrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId RestrictedFINXMax16Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 AcctOwnrDocId,omitempty"`
}

type DocumentNumber6Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 LngNb,omitempty"`
	PrtryNb GenericIdentification86           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 PrtryNb,omitempty"`
}
...
type FinancialInstrumentQuantity15Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 AmtsdVal,omitempty"`
}
...
type IdentificationSource4Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Cd,omitempty"`
	Prtry RestrictedFINExact2Text                            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}

type InstructionCancellationRequestStatus12Choice struct {
	CxlCmpltd CancelledStatus14Choice          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 CxlCmpltd,omitempty"`
	Accptd    NoSpecifiedReason1               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Accptd,omitempty"`
	Rjctd     RejectedStatus20Choice           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Rjctd,omitempty"`
	PdgCxl    PendingCancellationStatus8Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 PdgCxl,omitempty"`
	PrtrySts  ProprietaryStatusAndReason7      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 PrtrySts,omitempty"`
}
...
type OptionNumber1Choice struct {
	Nb Exact3NumericText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Nb,omitempty"`
	Cd OptionNumber1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Cd,omitempty"`
}
...
type PartyIdentification103Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 AnyBIC,omitempty"`
	PrtryId GenericIdentification84 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 PrtryId,omitempty"`
}
...
type PendingCancellationReason6Choice struct {
	Cd    PendingCancellationReason5Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Cd,omitempty"`
	Prtry GenericIdentification47        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}

type PendingCancellationStatus8Choice struct {
	NotSpcfdRsn NoReasonCode                       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 NotSpcfdRsn,omitempty"`
	Rsn         []PendingCancellationStatusReason8 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Rsn,omitempty"`
}
...
type Quantity10Choice struct {
	Qty             FinancialInstrumentQuantity15Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities4       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 OrgnlAndCurFace,omitempty"`
}

type Quantity21Choice struct {
	Qty      FinancialInstrumentQuantity15Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Qty,omitempty"`
	PrtryQty ProprietaryQuantity9                `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 PrtryQty,omitempty"`
}

type RejectedReason18Choice struct {
	Cd    RejectionReason45Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}

type RejectedStatus20Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 NoSpcfdRsn,omitempty"`
	Rsn        []RejectedStatusReason19 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Rsn,omitempty"`
}
...
type SafekeepingPlaceFormat11Choice struct {
	Id      SafekeepingPlaceTypeAndText9             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Id,omitempty"`
	Ctry    CountryCode                              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndAnyBICIdentifier1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 TpAndId,omitempty"`
	Prtry   GenericIdentification85                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.002.08 Prtry,omitempty"`
}
