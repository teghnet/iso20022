...
type AcceptedReason1Choice struct {
	Cd    AcknowledgementReason4Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}

type AcceptedStatus1Choice struct {
	NoSpcfdRsn NoReasonCode            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 NoSpcfdRsn,omitempty"`
	Rsn        []AcceptedStatusReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Rsn,omitempty"`
}
...
type CancelledReason1Choice struct {
	Cd    CancelledStatusReason6Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}

type CancelledStatus1Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 NoSpcfdRsn,omitempty"`
	Rsn        []CancelledStatusReason4 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Rsn,omitempty"`
}
...
type CashAccountIdentification5Choice struct {
	IBAN  IBAN2007Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 IBAN,omitempty"`
	Prtry Max34Text          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}
...
type CorporateActionEventType3Choice struct {
	Cd    CorporateActionEventType6Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Cd,omitempty"`
	Prtry GenericIdentification20       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}
...
type CorporateActionOption5Choice struct {
	Cd    CorporateActionOption6Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 DtTm,omitempty"`
}
...
type DocumentIdentification1Choice struct {
	AcctSvcrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 AcctSvcrDocId,omitempty"`
	AcctOwnrDocId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 AcctOwnrDocId,omitempty"`
}
...
type DocumentNumber1Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 LngNb,omitempty"`
	PrtryNb GenericIdentification19           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 PrtryNb,omitempty"`
}
...
type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 AmtsdVal,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}

type InstructionCancellationRequestStatus1Choice struct {
	CxlCmpltd CancelledStatus1Choice           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 CxlCmpltd,omitempty"`
	Accptd    AcceptedStatus1Choice            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Accptd,omitempty"`
	Rjctd     RejectedStatus1Choice            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Rjctd,omitempty"`
	PdgCxl    PendingCancellationStatus1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 PdgCxl,omitempty"`
	PrtrySts  ProprietaryStatusAndReason1      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 PrtrySts,omitempty"`
}
...
type OptionNumber1Choice struct {
	Nb Exact3NumericText `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Nb,omitempty"`
	Cd OptionNumber1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Cd,omitempty"`
}
...
type PartyIdentification10Choice struct {
	BICOrBEI AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 NmAndAdr,omitempty"`
}
...
type PendingCancellationReason1Choice struct {
	Cd    PendingCancellationReason4Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Cd,omitempty"`
	Prtry GenericIdentification20        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}
...
type PendingCancellationStatus1Choice struct {
	NotSpcfdRsn NoReasonCode                       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 NotSpcfdRsn,omitempty"`
	Rsn         []PendingCancellationStatusReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Rsn,omitempty"`
}
...
type Quantity2Choice struct {
	Qty      FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Qty,omitempty"`
	PrtryQty ProprietaryQuantity2               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 PrtryQty,omitempty"`
}

type Quantity6Choice struct {
	Qty             FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities1      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 OrgnlAndCurFace,omitempty"`
}

type RejectedReason1Choice struct {
	Cd    RejectionReason17Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}

type RejectedStatus1Choice struct {
	NoSpcfdRsn NoReasonCode            `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 NoSpcfdRsn,omitempty"`
	Rsn        []RejectedStatusReason8 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Rsn,omitempty"`
}
...
type SafekeepingPlaceFormat2Choice struct {
	Id      SafekeepingPlaceTypeAndText2             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Id,omitempty"`
	Ctry    CountryCode                              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndAnyBICIdentifier1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 TpAndId,omitempty"`
	Prtry   GenericIdentification21                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 Prtry,omitempty"`
}
...
type SecurityIdentification11Choice struct {
	ISIN   ISINIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 ISIN,omitempty"`
	OthrId AlternateIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 OthrId,omitempty"`
}
...
type StatusOrQuantityToReceive1Choice struct {
	StsQty   Quantity6Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 StsQty,omitempty"`
	QtyToRcv Quantity6Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.041.001.01 QtyToRcv,omitempty"`
}
