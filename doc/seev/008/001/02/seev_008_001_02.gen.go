...
type AlternateFinancialInstrumentIdentification1 struct {
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max16Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 PrtryIdSrc,omitempty"`
...
type PartyIdentification9Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 NmAndAdr,omitempty"`
}
...
type SafekeepingPlaceFormatChoice struct {
	Id       SafekeepingPlaceAsCodeAndPartyIdentification `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 Id,omitempty"`
	IdAsDSS  GenericIdentification5                       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 IdAsDSS,omitempty"`
	IdAsCtry CountryCode                                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 IdAsCtry,omitempty"`
}
...
type UnitOrFaceAmountChoice struct {
	Unit    float64           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 Unit,omitempty"`
	FaceAmt CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.008.001.02 FaceAmt,omitempty"`
}
