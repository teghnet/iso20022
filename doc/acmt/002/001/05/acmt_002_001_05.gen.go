...
type AccountParties7Choice struct {
	PmryOwnr   InvestmentAccountOwnershipInformation10   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 PmryOwnr,omitempty"`
	Trstee     []InvestmentAccountOwnershipInformation10 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Trstee,omitempty"`
	CtdnForMnr InvestmentAccountOwnershipInformation10   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CtdnForMnr,omitempty"`
	Nmnee      InvestmentAccountOwnershipInformation10   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Nmnee,omitempty"`
	JntOwnr    []InvestmentAccountOwnershipInformation9  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 JntOwnr,omitempty"`
}
...
type AccountType1Choice struct {
	Cd    FundCashAccount3Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}

type AccountUsageType1Choice struct {
	Cd    AccountUsageType1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 PrtryIdSrc,omitempty"`
}
...
type BlockedReason1Choice struct {
	Rsn   BlockedReason1Code      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Rsn,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type CashAccountIdentification1Choice struct {
	IBAN     IBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 IBAN,omitempty"`
	BBAN     BBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 BBAN,omitempty"`
	UPIC     UPICIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 UPIC,omitempty"`
	DmstAcct SimpleIdentificationInformation `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 DmstAcct,omitempty"`
}
...
type CertificationType1Choice struct {
	Cd    CertificateType2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type ClearingSystemMemberIdentificationChoice struct {
	USCHU  CHIPSUniversalIdentifier                       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 USCHU,omitempty"`
	NZNCC  NewZealandNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 NZNCC,omitempty"`
	IENSC  IrishNSCIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 IENSC,omitempty"`
	GBSC   UKDomesticSortCodeIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 GBSC,omitempty"`
	USCH   CHIPSParticipantIdentifier                     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 USCH,omitempty"`
	CHBC   SwissBCIdentifier                              `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CHBC,omitempty"`
	USFW   FedwireRoutingNumberIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 USFW,omitempty"`
	PTNCC  PortugueseNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 PTNCC,omitempty"`
	RUCB   RussianCentralBankIdentificationCodeIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 RUCB,omitempty"`
	ITNCC  ItalianDomesticIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 ITNCC,omitempty"`
	ATBLZ  AustrianBankleitzahlIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 ATBLZ,omitempty"`
	CACPA  CanadianPaymentsARNIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CACPA,omitempty"`
	CHSIC  SwissSICIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CHSIC,omitempty"`
	DEBLZ  GermanBankleitzahlIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 DEBLZ,omitempty"`
	ESNCC  SpanishDomesticInterbankingIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 ESNCC,omitempty"`
	ZANCC  SouthAfricanNCCIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 ZANCC,omitempty"`
	HKNCC  HongKongBankIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 HKNCC,omitempty"`
	AUBSBx ExtensiveBranchNetworkIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 AUBSBx,omitempty"`
	AUBSBs SmallNetworkIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 AUBSBs,omitempty"`
}
...
type CommunicationMethod3Choice struct {
	Cd    CommunicationMethod1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type CustomerConductClassification1Choice struct {
	Cd    ConductClassification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 DtTm,omitempty"`
}

type DeMinimus1Choice struct {
	DeMnmsAplbl    DeMinimusApplicable1    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 DeMnmsAplbl,omitempty"`
	DeMnmsNotAplbl DeMinimusNotApplicable1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 DeMnmsNotAplbl,omitempty"`
}
...
type FATCAForm1Choice struct {
	Cd    FATCAFormType1Code      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type FATCASource1Choice struct {
	Cd    FATCASourceStatus1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type FATCAStatus1Choice struct {
	Cd    FATCAStatus1Code        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type FinancialInstitutionIdentification3Choice struct {
	NmAndAdr    NameAndAddress5                          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 NmAndAdr,omitempty"`
	BIC         BICIdentifier                            `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 BIC,omitempty"`
	ClrSysMmbId ClearingSystemMemberIdentificationChoice `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 ClrSysMmbId,omitempty"`
	PrtryId     SimpleIdentificationInformation          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 PrtryId,omitempty"`
}
...
type Frequency20Choice struct {
	Cd    EventFrequency8Code     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type FundOrderType1Choice struct {
	Tp    FundOrderType6Code      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Tp,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type InsuranceType1Choice struct {
	Cd    Insurance1Code          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification41 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type InvestmentAccountCategory1Choice struct {
	Cd    InvestmentAccountCategory1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type InvestmentAccountType1Choice struct {
	Cd    FundCashAccount2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type KYCCheckType1Choice struct {
	Cd    KnowYourCustomerCheckType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Strd,omitempty"`
}
...
type MoneyLaunderingCheck1Choice struct {
	Cd    MoneyLaunderingCheck1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type NamePrefix1Choice struct {
	Cd    NamePrefix1Code         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type OtherIdentification1Choice struct {
	Cd    PersonIdentificationType5Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}

type OtherIdentification2Choice struct {
	Cd    PersonIdentificationType6Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification29       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}

type OwnershipType1Choice struct {
	Cd    AccountOwnershipType3Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}

type Party16Choice struct {
	Org      Organisation13     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Org,omitempty"`
	IndvPrsn IndividualPerson22 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 IndvPrsn,omitempty"`
}

type Party23Choice struct {
	Org      Organisation16     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Org,omitempty"`
	IndvPrsn IndividualPerson23 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 IndvPrsn,omitempty"`
}

type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 NmAndAdr,omitempty"`
}
...
type PartyRole2Choice struct {
	Cd    InvestmentFundRole6Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}

type PartyRole4Choice struct {
	Cd    InvestmentFundRole7Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type PaymentInstrument16Choice struct {
	CshAcctDtls  []CashAccount26 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CshAcctDtls,omitempty"`
	ChqDtls      Cheque4         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 ChqDtls,omitempty"`
	BkrsDrftDtls Cheque4         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 BkrsDrftDtls,omitempty"`
}

type PaymentInstrument17Choice struct {
	CshAcctDtls []CashAccount26     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CshAcctDtls,omitempty"`
	PmtCardDtls PaymentCard2        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 PmtCardDtls,omitempty"`
	DrctDbtDtls DirectDebitMandate4 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 DrctDbtDtls,omitempty"`
	Chq         bool                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Chq,omitempty"`
	BkrsDrft    bool                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 BkrsDrft,omitempty"`
}
...
type PlanStatus1Choice struct {
	Cd    PlanStatus1Code         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type PoliticalExposureType1Choice struct {
	Cd    PoliticalExposureType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type RiskLevel1Choice struct {
	Cd    RiskLevel1Code          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification41 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 OthrPrtryId,omitempty"`
}
...
type StatementFrequencyReason1Choice struct {
	Cd    EventFrequency1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type TaxExemptionReason1Choice struct {
	Cd    TaxExemptReason1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type TaxIdentificationType1Choice struct {
	Cd    TaxIdentificationNumberType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type TransactionChannelType1Choice struct {
	Cd    TransactionChannel2Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Prtry,omitempty"`
}
...
type UnitsOrAmount1Choice struct {
	Amt  ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Amt,omitempty"`
	Unit float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.002.001.05 Unit,omitempty"`
}
