...
type AccountParties1Choice struct {
	PmryOwnr   InvestmentAccountOwnershipInformation6   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 PmryOwnr,omitempty"`
	Trstee     []InvestmentAccountOwnershipInformation6 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Trstee,omitempty"`
	CtdnForMnr InvestmentAccountOwnershipInformation6   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CtdnForMnr,omitempty"`
	Nmnee      InvestmentAccountOwnershipInformation6   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Nmnee,omitempty"`
	JntOwnr    []InvestmentAccountOwnershipInformation6 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 JntOwnr,omitempty"`
}
...
type AccountType1Choice struct {
	Cd    FundCashAccount3Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}

type AccountUsageType1Choice struct {
	Cd    AccountUsageType1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 PrtryIdSrc,omitempty"`
}
...
type BlockedReason1Choice struct {
	Rsn   BlockedReason1Code      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Rsn,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type CashAccountIdentification1Choice struct {
	IBAN     IBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 IBAN,omitempty"`
	BBAN     BBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 BBAN,omitempty"`
	UPIC     UPICIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 UPIC,omitempty"`
	DmstAcct SimpleIdentificationInformation `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 DmstAcct,omitempty"`
}
...
type CertificationType1Choice struct {
	Cd    CertificateType2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type ClearingSystemMemberIdentificationChoice struct {
	USCHU  CHIPSUniversalIdentifier                       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 USCHU,omitempty"`
	NZNCC  NewZealandNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 NZNCC,omitempty"`
	IENSC  IrishNSCIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 IENSC,omitempty"`
	GBSC   UKDomesticSortCodeIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 GBSC,omitempty"`
	USCH   CHIPSParticipantIdentifier                     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 USCH,omitempty"`
	CHBC   SwissBCIdentifier                              `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CHBC,omitempty"`
	USFW   FedwireRoutingNumberIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 USFW,omitempty"`
	PTNCC  PortugueseNCCIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 PTNCC,omitempty"`
	RUCB   RussianCentralBankIdentificationCodeIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 RUCB,omitempty"`
	ITNCC  ItalianDomesticIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 ITNCC,omitempty"`
	ATBLZ  AustrianBankleitzahlIdentifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 ATBLZ,omitempty"`
	CACPA  CanadianPaymentsARNIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CACPA,omitempty"`
	CHSIC  SwissSICIdentifier                             `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CHSIC,omitempty"`
	DEBLZ  GermanBankleitzahlIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 DEBLZ,omitempty"`
	ESNCC  SpanishDomesticInterbankingIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 ESNCC,omitempty"`
	ZANCC  SouthAfricanNCCIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 ZANCC,omitempty"`
	HKNCC  HongKongBankIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 HKNCC,omitempty"`
	AUBSBx ExtensiveBranchNetworkIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 AUBSBx,omitempty"`
	AUBSBs SmallNetworkIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 AUBSBs,omitempty"`
}
...
type CustomerConductClassification1Choice struct {
	Cd    ConductClassification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}

type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 DtTm,omitempty"`
}
...
type DocumentToSend1 struct {
	...
	MtdOfTrnsmssn       CommunicationMethod1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 MtdOfTrnsmssn,omitempty"`
	XtndedMtdOfTrnsmssn Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 XtndedMtdOfTrnsmssn,omitempty"`
}
...
type FinancialInstitutionIdentification3Choice struct {
	NmAndAdr    NameAndAddress5                          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 NmAndAdr,omitempty"`
	BIC         BICIdentifier                            `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 BIC,omitempty"`
	ClrSysMmbId ClearingSystemMemberIdentificationChoice `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 ClrSysMmbId,omitempty"`
	PrtryId     SimpleIdentificationInformation          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 PrtryId,omitempty"`
}
...
type Frequency19Choice struct {
	Cd    EventFrequency1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type FundOrderType1Choice struct {
	Tp    FundOrderType6Code      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Tp,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type InsuranceType1Choice struct {
	Cd    Insurance1Code          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification41 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type InvestmentAccountType1Choice struct {
	Cd    FundCashAccount2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type MoneyLaunderingCheck1Choice struct {
	Cd    MoneyLaunderingCheck1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type NamePrefix1Choice struct {
	Cd    NamePrefix1Code         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type OtherIdentification1Choice struct {
	Cd    PersonIdentificationType5Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}

type OwnershipType1Choice struct {
	Cd    AccountOwnershipType3Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}

type Party14Choice struct {
	Org      Organisation13     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Org,omitempty"`
	IndvPrsn IndividualPerson20 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 IndvPrsn,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 NmAndAdr,omitempty"`
}
...
type PaymentInstrument16Choice struct {
	CshAcctDtls  []CashAccount26 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CshAcctDtls,omitempty"`
	ChqDtls      Cheque4         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 ChqDtls,omitempty"`
	BkrsDrftDtls Cheque4         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 BkrsDrftDtls,omitempty"`
}

type PaymentInstrument17Choice struct {
	CshAcctDtls []CashAccount26     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CshAcctDtls,omitempty"`
	PmtCardDtls PaymentCard2        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 PmtCardDtls,omitempty"`
	DrctDbtDtls DirectDebitMandate4 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 DrctDbtDtls,omitempty"`
	Chq         bool                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Chq,omitempty"`
	BkrsDrft    bool                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 BkrsDrft,omitempty"`
}
...
type RiskLevel1Choice struct {
	Cd    RiskLevel1Code          `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification41 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 OthrPrtryId,omitempty"`
}
...
type TaxExemptionReason1Choice struct {
	Cd    TaxExemptReason1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Prtry,omitempty"`
}
...
type UnitsOrAmount1Choice struct {
	Amt  ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Amt,omitempty"`
	Unit float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.001.001.03 Unit,omitempty"`
}
