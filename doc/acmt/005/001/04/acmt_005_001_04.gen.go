...
type IndividualPersonIdentification2Choice struct {
	IdNb   GenericIdentification81 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 IdNb,omitempty"`
	PrsnNm IndividualPerson30      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 PrsnNm,omitempty"`
}
...
type LinkedMessage3Choice struct {
	PrvsRef AdditionalReference6 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 PrvsRef,omitempty"`
	OthrRef AdditionalReference6 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 OthrRef,omitempty"`
}
...
type OtherIdentification3Choice struct {
	Cd    PartyIdentificationType7Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 Cd,omitempty"`
	Prtry GenericIdentification47      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 Prtry,omitempty"`
}

type OwnerIdentification2Choice struct {
	IndvOwnrId IndividualPersonIdentification2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 IndvOwnrId,omitempty"`
	OrgOwnrId  PartyIdentification95                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 OrgOwnrId,omitempty"`
}

type PartyIdentification70Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.04 NmAndAdr,omitempty"`
}
