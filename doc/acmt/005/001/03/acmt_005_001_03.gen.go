...
type GenericIdentification10 struct {
	Id         Max35Text                     `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 Id"`
	IdTp       PersonIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 IdTp,omitempty"`
	XtndedIdTp Extended350Code               `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 XtndedIdTp,omitempty"`
}
...
type IndividualPersonIdentificationChoice struct {
	IdNb   GenericIdentification10 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 IdNb,omitempty"`
	PrsnNm IndividualPerson4       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 PrsnNm,omitempty"`
}
...
type LinkedMessage2Choice struct {
	PrvsRef AdditionalReference3 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 PrvsRef,omitempty"`
	OthrRef AdditionalReference3 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 OthrRef,omitempty"`
}
...
type OwnerIdentification1Choice struct {
	IndvOwnrId IndividualPersonIdentificationChoice `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 IndvOwnrId,omitempty"`
	OrgOwnrId  PartyIdentification5Choice           `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 OrgOwnrId,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 NmAndAdr,omitempty"`
}
...
type PartyIdentification5Choice struct {
	...
	PrtryId   GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 PrtryId,omitempty"`
	NmAndAdr  NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 NmAndAdr,omitempty"`
	TaxIdNb   Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 TaxIdNb,omitempty"`
	NtlRegnNb Max35Text              `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.03 NtlRegnNb,omitempty"`
}
