...
type IndividualPersonIdentification2Choice struct {
	IdNb   GenericIdentification81 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 IdNb,omitempty"`
	PrsnNm IndividualPerson30      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 PrsnNm,omitempty"`
}
...
type LinkedMessage5Choice struct {
	PrvsRef AdditionalReference13 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 PrvsRef,omitempty"`
	OthrRef AdditionalReference13 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 OthrRef,omitempty"`
}
...
type OtherIdentification3Choice struct {
	Cd    PartyIdentificationType7Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 Cd,omitempty"`
	Prtry GenericIdentification47      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 Prtry,omitempty"`
}

type OwnerIdentification3Choice struct {
	IndvOwnrId IndividualPersonIdentification2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 IndvOwnrId,omitempty"`
	OrgOwnrId  PartyIdentification139                `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 OrgOwnrId,omitempty"`
}

type PartyIdentification125Choice struct {
	AnyBIC   AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1  `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.06 NmAndAdr,omitempty"`
}
