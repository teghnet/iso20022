...
type IndividualPersonIdentification2Choice struct {
	IdNb   GenericIdentification81 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 IdNb,omitempty"`
	PrsnNm IndividualPerson30      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 PrsnNm,omitempty"`
}
...
type LinkedMessage4Choice struct {
	PrvsRef AdditionalReference6 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 PrvsRef,omitempty"`
	OthrRef AdditionalReference6 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 OthrRef,omitempty"`
}
...
type OtherIdentification3Choice struct {
	Cd    PartyIdentificationType7Code `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 Cd,omitempty"`
	Prtry GenericIdentification47      `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 Prtry,omitempty"`
}

type OwnerIdentification2Choice struct {
	IndvOwnrId IndividualPersonIdentification2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 IndvOwnrId,omitempty"`
	OrgOwnrId  PartyIdentification95                 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 OrgOwnrId,omitempty"`
}

type PartyIdentification70Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:acmt.005.001.05 NmAndAdr,omitempty"`
}
