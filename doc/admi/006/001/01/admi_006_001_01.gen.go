...
type SequenceRange1Choice struct {
	...
	FrToSeq []SequenceRange1 `xml:"urn:iso:std:iso:20022:tech:xsd:admi.006.001.01 FrToSeq,omitempty"`
	EQSeq   []Max35Text      `xml:"urn:iso:std:iso:20022:tech:xsd:admi.006.001.01 EQSeq,omitempty"`
	NEQSeq  []Max35Text      `xml:"urn:iso:std:iso:20022:tech:xsd:admi.006.001.01 NEQSeq,omitempty"`
}
