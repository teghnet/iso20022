...
type AccountIdentification3Choice struct {
	IBAN      IBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 IBAN,omitempty"`
	BBAN      BBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 BBAN,omitempty"`
	UPIC      UPICIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 UPIC,omitempty"`
	PrtryAcct SimpleIdentificationInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 PrtryAcct,omitempty"`
}
...
type Adjustment4 struct {
	Tp             AdjustmentType2Code      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Tp,omitempty"`
	OthrAdjstmntTp Max35Text                `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrAdjstmntTp,omitempty"`
...
type AirportName1Choice struct {
	AirprtCd       Max6Text            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 AirprtCd,omitempty"`
	OthrAirprtDesc AirportDescription1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrAirprtDesc,omitempty"`
}
...
type CashAccountType2 struct {
	Cd    CashAccountType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Cd,omitempty"`
	Prtry Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Prtry,omitempty"`
}
...
type CertifiedCharacteristics1Choice struct {
	Orgn             CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Orgn,omitempty"`
	Qlty             Max70Text   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Qlty,omitempty"`
	Anlys            Max70Text   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Anlys,omitempty"`
	Wght             Quantity4   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Wght,omitempty"`
	Qty              Quantity4   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Qty,omitempty"`
	HlthIndctn       bool        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 HlthIndctn,omitempty"`
	PhytosntryIndctn bool        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 PhytosntryIndctn,omitempty"`
}
...
type ChargesDetails2 struct {
	Tp          ChargeType8Code   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Tp,omitempty"`
	OthrChrgsTp Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrChrgsTp,omitempty"`
	Amt         CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Amt"`
}
...
type FinancialInstitutionIdentification4Choice struct {
	BIC      BICIdentifier   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 BIC,omitempty"`
	NmAndAdr NameAndAddress6 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 NmAndAdr,omitempty"`
}
...
type Incoterms2 struct {
	Cd   Incoterms1Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Cd,omitempty"`
	Othr Max35Text      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Othr,omitempty"`
...
type PartyIdentification29Choice struct {
	BIC      BICIdentifier         `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 BIC,omitempty"`
	NmAndAdr PartyIdentification26 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 NmAndAdr,omitempty"`
}
...
type PaymentTerms1 struct {
	OthrPmtTerms Max140Text        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrPmtTerms,omitempty"`
	PmtCd        PaymentPeriod1    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 PmtCd,omitempty"`
	Pctg         float64           `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Pctg,omitempty"`
	Amt          CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Amt,omitempty"`
}
...
type ProductCategory1Choice struct {
	StrdPdctCtgy ProductCategory1       `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 StrdPdctCtgy,omitempty"`
	OthrPdctCtgy GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrPdctCtgy,omitempty"`
}
...
type ProductCharacteristics1Choice struct {
	StrdPdctChrtcs ProductCharacteristics1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 StrdPdctChrtcs,omitempty"`
	OthrPdctChrtcs GenericIdentification4  `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrPdctChrtcs,omitempty"`
}
...
type ProductIdentifier2Choice struct {
	StrdPdctIdr ProductIdentifier2     `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 StrdPdctIdr,omitempty"`
	OthrPdctIdr GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrPdctIdr,omitempty"`
}
...
type Quantity3 struct {
	UnitOfMeasrCd   UnitOfMeasure4Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 UnitOfMeasrCd,omitempty"`
	OthrUnitOfMeasr Max35Text          `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrUnitOfMeasr,omitempty"`
...
type Tax12 struct {
	Tp        TaxType9Code      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Tp,omitempty"`
	OthrTaxTp Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 OthrTaxTp,omitempty"`
	Amt       CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Amt"`
}
...
type TransportDetails2 struct {
	...
	PropsdShipmntDt ISODate                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 PropsdShipmntDt,omitempty"`
	ActlShipmntDt   ISODate                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 ActlShipmntDt,omitempty"`
	Incotrms        Incoterms2                `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 Incotrms,omitempty"`
	FrghtChrgs      Charge13                  `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.03 FrghtChrgs,omitempty"`
}
