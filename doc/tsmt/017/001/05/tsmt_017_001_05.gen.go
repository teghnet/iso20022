...
type AccountIdentification4Choice struct {
	IBAN IBAN2007Identifier            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 IBAN,omitempty"`
	Othr GenericAccountIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Othr,omitempty"`
}

type AccountSchemeName1Choice struct {
	Cd    ExternalAccountIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Cd,omitempty"`
	Prtry Max35Text                          `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Prtry,omitempty"`
}
...
type AdjustmentType1Choice struct {
	Tp             AdjustmentType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Tp,omitempty"`
	OthrAdjstmntTp Max35Text           `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrAdjstmntTp,omitempty"`
}
...
type AirportName1Choice struct {
	AirprtCd       Max6Text            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 AirprtCd,omitempty"`
	OthrAirprtDesc AirportDescription1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrAirprtDesc,omitempty"`
}

type AmountOrPercentage2Choice struct {
	Amt  ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Amt,omitempty"`
	Pctg float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Pctg,omitempty"`
}
...
type CashAccountType2Choice struct {
	Cd    ExternalCashAccountType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Cd,omitempty"`
	Prtry Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Prtry,omitempty"`
}
...
type CertifiedCharacteristics2Choice struct {
	Orgn             CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Orgn,omitempty"`
	Qlty             Max70Text   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Qlty,omitempty"`
	Anlys            Max70Text   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Anlys,omitempty"`
	Wght             Quantity9   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Wght,omitempty"`
	Qty              Quantity9   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Qty,omitempty"`
	HlthIndctn       bool        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 HlthIndctn,omitempty"`
	PhytosntryIndctn bool        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 PhytosntryIndctn,omitempty"`
}
...
type ChargesType1Choice struct {
	Tp          ChargeType8Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Tp,omitempty"`
	OthrChrgsTp Max35Text       `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrChrgsTp,omitempty"`
}
...
type FinancialInstitutionIdentification4Choice struct {
	BIC      BICIdentifier   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 BIC,omitempty"`
	NmAndAdr NameAndAddress6 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 NmAndAdr,omitempty"`
}
...
type Incoterms4Choice struct {
	Cd    ExternalIncoterms1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Cd,omitempty"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Prtry,omitempty"`
}
...
type PartyIdentification29Choice struct {
	BIC      BICIdentifier         `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 BIC,omitempty"`
	NmAndAdr PartyIdentification26 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 NmAndAdr,omitempty"`
}

type PaymentCodeOrOther1Choice struct {
	PmtCd        PaymentPeriod3 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 PmtCd,omitempty"`
	PmtDueDt     ISODate        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 PmtDueDt,omitempty"`
	OthrPmtTerms Max140Text     `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrPmtTerms,omitempty"`
}
...
type ProductCategory1Choice struct {
	StrdPdctCtgy ProductCategory1       `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 StrdPdctCtgy,omitempty"`
	OthrPdctCtgy GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrPdctCtgy,omitempty"`
}
...
type ProductCharacteristics1Choice struct {
	StrdPdctChrtcs ProductCharacteristics1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 StrdPdctChrtcs,omitempty"`
	OthrPdctChrtcs GenericIdentification4  `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrPdctChrtcs,omitempty"`
}
...
type ProductIdentifier2Choice struct {
	StrdPdctIdr ProductIdentifier2     `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 StrdPdctIdr,omitempty"`
	OthrPdctIdr GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrPdctIdr,omitempty"`
}
...
type ShipmentDate1Choice struct {
	PropsdShipmntDt ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 PropsdShipmntDt,omitempty"`
	ActlShipmntDt   ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 ActlShipmntDt,omitempty"`
}
...
type TaxType2Choice struct {
	Tp        TaxType9Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 Tp,omitempty"`
	OthrTaxTp Max35Text    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrTaxTp,omitempty"`
}
...
type UnitOfMeasure3Choice struct {
	UnitOfMeasrCd   UnitOfMeasure4Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 UnitOfMeasrCd,omitempty"`
	OthrUnitOfMeasr Max35Text          `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.017.001.05 OthrUnitOfMeasr,omitempty"`
}
