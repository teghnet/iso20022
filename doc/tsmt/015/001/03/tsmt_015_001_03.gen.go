...
type ComparisonResult2 struct {
	...
	Rplcmnt   Replacement2 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.015.001.03 Rplcmnt,omitempty"`
	Deltn     Deletion2    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.015.001.03 Deltn,omitempty"`
	Addtn     Addition2    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.015.001.03 Addtn,omitempty"`
}
