...
type AccountIdentification4Choice struct {
	IBAN IBAN2007Identifier            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 IBAN,omitempty"`
	Othr GenericAccountIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 Othr,omitempty"`
}

type AccountSchemeName1Choice struct {
	Cd    ExternalAccountIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 Cd,omitempty"`
	Prtry Max35Text                          `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 Prtry,omitempty"`
}
...
type AdjustmentType1Choice struct {
	Tp             AdjustmentType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 Tp,omitempty"`
	OthrAdjstmntTp Max35Text           `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 OthrAdjstmntTp,omitempty"`
}
...
type BreakDown1Choice struct {
	ByPurchsOrdr ReportLine5 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 ByPurchsOrdr,omitempty"`
	ByComrclInvc ReportLine6 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 ByComrclInvc,omitempty"`
}
...
type CashAccountType2Choice struct {
	Cd    ExternalCashAccountType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 Cd,omitempty"`
	Prtry Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 Prtry,omitempty"`
}
...
type FinancialInstitutionIdentification4Choice struct {
	BIC      BICIdentifier   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 BIC,omitempty"`
	NmAndAdr NameAndAddress6 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.02 NmAndAdr,omitempty"`
}
