...
type AccountIdentification3Choice struct {
	IBAN      IBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 IBAN,omitempty"`
	BBAN      BBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 BBAN,omitempty"`
	UPIC      UPICIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 UPIC,omitempty"`
	PrtryAcct SimpleIdentificationInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 PrtryAcct,omitempty"`
}

type Adjustment4 struct {
	Tp             AdjustmentType2Code      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 Tp,omitempty"`
	OthrAdjstmntTp Max35Text                `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 OthrAdjstmntTp,omitempty"`
...
type CashAccountType2 struct {
	Cd    CashAccountType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 Cd,omitempty"`
	Prtry Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 Prtry,omitempty"`
}
...
type FinancialInstitutionIdentification4Choice struct {
	BIC      BICIdentifier   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 BIC,omitempty"`
	NmAndAdr NameAndAddress6 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 NmAndAdr,omitempty"`
}
...
type IntentToPay1 struct {
	ByPurchsOrdr ReportLine3      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 ByPurchsOrdr,omitempty"`
	ByComrclInvc ReportLine4      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.044.001.01 ByComrclInvc,omitempty"`
