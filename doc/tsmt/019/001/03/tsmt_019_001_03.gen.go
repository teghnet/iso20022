...
type AccountIdentification3Choice struct {
	IBAN      IBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 IBAN,omitempty"`
	BBAN      BBANIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 BBAN,omitempty"`
	UPIC      UPICIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 UPIC,omitempty"`
	PrtryAcct SimpleIdentificationInformation2 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 PrtryAcct,omitempty"`
}

type Adjustment3 struct {
	Tp             AdjustmentType2Code      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Tp,omitempty"`
	OthrAdjstmntTp Max35Text                `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrAdjstmntTp,omitempty"`
	Amt            CurrencyAndAmount        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Amt,omitempty"`
	Rate           float64                  `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Rate,omitempty"`
...
type AirportName1Choice struct {
	AirprtCd       Max6Text            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 AirprtCd,omitempty"`
	OthrAirprtDesc AirportDescription1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrAirprtDesc,omitempty"`
}
...
type CashAccountType2 struct {
	Cd    CashAccountType4Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Cd,omitempty"`
	Prtry Max35Text            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Prtry,omitempty"`
}
...
type ChargesDetails1 struct {
	Tp          ChargeType8Code   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Tp,omitempty"`
	OthrChrgsTp Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrChrgsTp,omitempty"`
	Amt         CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Amt,omitempty"`
	Rate        float64           `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Rate,omitempty"`
}
...
type FinancialInstitutionIdentification4Choice struct {
	BIC      BICIdentifier   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 BIC,omitempty"`
	NmAndAdr NameAndAddress6 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 NmAndAdr,omitempty"`
}
...
type Incoterms1 struct {
	Cd   Incoterms1Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Cd,omitempty"`
	Othr Max35Text      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Othr,omitempty"`
...
type InitialBaselineSubmissionV03 struct {
	...
	BuyrBkCtctPrsn  []ContactIdentification1        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 BuyrBkCtctPrsn,omitempty"`
	SellrBkCtctPrsn []ContactIdentification1        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 SellrBkCtctPrsn,omitempty"`
...
type PaymentObligation1 struct {
	...
	Amt        CurrencyAndAmount  `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Amt,omitempty"`
	Pctg       float64            `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Pctg,omitempty"`
...
type PaymentTerms1 struct {
	OthrPmtTerms Max140Text        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrPmtTerms,omitempty"`
	PmtCd        PaymentPeriod1    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 PmtCd,omitempty"`
	Pctg         float64           `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Pctg,omitempty"`
	Amt          CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Amt,omitempty"`
}
...
type PaymentTerms2 struct {
	OthrPmtTerms Max140Text        `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrPmtTerms,omitempty"`
	PmtCd        PaymentPeriod2    `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 PmtCd,omitempty"`
	Pctg         float64           `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Pctg,omitempty"`
	Amt          CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Amt,omitempty"`
}
...
type ProductCategory1Choice struct {
	StrdPdctCtgy ProductCategory1       `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 StrdPdctCtgy,omitempty"`
	OthrPdctCtgy GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrPdctCtgy,omitempty"`
}
...
type ProductCharacteristics1Choice struct {
	StrdPdctChrtcs ProductCharacteristics1 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 StrdPdctChrtcs,omitempty"`
	OthrPdctChrtcs GenericIdentification4  `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrPdctChrtcs,omitempty"`
}
...
type ProductIdentifier2Choice struct {
	StrdPdctIdr ProductIdentifier2     `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 StrdPdctIdr,omitempty"`
	OthrPdctIdr GenericIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrPdctIdr,omitempty"`
}
...
type Quantity4 struct {
	UnitOfMeasrCd   UnitOfMeasure4Code `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 UnitOfMeasrCd,omitempty"`
	OthrUnitOfMeasr Max35Text          `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrUnitOfMeasr,omitempty"`
...
type ShipmentSchedule1Choice struct {
	ShipmntDtRg     ShipmentDateRange1   `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 ShipmntDtRg,omitempty"`
	ShipmntSubSchdl []ShipmentDateRange2 `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 ShipmntSubSchdl,omitempty"`
}
...
type Tax13 struct {
	Tp        TaxType9Code      `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Tp,omitempty"`
	OthrTaxTp Max35Text         `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 OthrTaxTp,omitempty"`
	Amt       CurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Amt,omitempty"`
	Rate      float64           `xml:"urn:iso:std:iso:20022:tech:xsd:tsmt.019.001.03 Rate,omitempty"`
}
