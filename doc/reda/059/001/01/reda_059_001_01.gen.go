...
type ClassificationType1Choice struct {
	ClssfctnFinInstrm CFIOct2015Identifier   `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 ClssfctnFinInstrm,omitempty"`
	AltrnClssfctn     GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 AltrnClssfctn,omitempty"`
}
...
type MarketIdentificationOrCashPurpose1Choice struct {
	SttlmInstrMktId MarketIdentification87    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 SttlmInstrMktId,omitempty"`
	CshSSIPurp      []ExternalMarketArea1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 CshSSIPurp,omitempty"`
}
...
type PartyIdentification75Choice struct {
	AnyBIC   AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 AnyBIC,omitempty"`
	NmAndAdr NameAndAddress5  `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 NmAndAdr,omitempty"`
	Ctry     CountryCode      `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 Ctry,omitempty"`
}

type PartyOrCurrency1Choice struct {
	Dpstry   PartyIdentification63 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 Dpstry,omitempty"`
	SttlmCcy ActiveCurrencyCode    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 SttlmCcy,omitempty"`
}
...
type Purpose3Choice struct {
	SctiesPurpCd ExternalSecuritiesPurpose1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 SctiesPurpCd,omitempty"`
	Prtry        GenericIdentification1         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.059.001.01 Prtry,omitempty"`
}
