...
type AccountIdentification5Choice struct {
	IBAN       IBANIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 IBAN,omitempty"`
	BBAN       BBANIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 BBAN,omitempty"`
	DmstAcct   Max35Text      `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 DmstAcct,omitempty"`
	DpstryAcct Max35Text      `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 DpstryAcct,omitempty"`
}
...
type AlternateSecurityIdentification3 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 PrtryIdSrc,omitempty"`
}
...
type SecurityIdentification7 struct {
	ISIN   ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 ISIN,omitempty"`
	OthrId AlternateSecurityIdentification3 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 OthrId,omitempty"`
...
type TimeFrame4Choice struct {
	TPlus float64 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 TPlus,omitempty"`
	RPlus float64 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 RPlus,omitempty"`
}

type TimeFrame5Choice struct {
	TPlus  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 TPlus,omitempty"`
	Prepmt bool    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.004.001.02 Prepmt,omitempty"`
}
