...
type KEKIdentifier1 struct {
	...
	KeyVrsn   string          `xml:"urn:iso:std:iso:20022:tech:xsd:caaa.002.001.03 KeyVrsn"`
...
type Recipient3Choice struct {
	KeyTrnsprt KeyTransport3  `xml:"urn:iso:std:iso:20022:tech:xsd:caaa.002.001.03 KeyTrnsprt,omitempty"`
	KEK        KEK3           `xml:"urn:iso:std:iso:20022:tech:xsd:caaa.002.001.03 KEK,omitempty"`
	KeyIdr     KEKIdentifier1 `xml:"urn:iso:std:iso:20022:tech:xsd:caaa.002.001.03 KeyIdr,omitempty"`
}
