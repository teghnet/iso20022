...
type AgreementFramework1Choice struct {
	AgrmtFrmwk AgreementFramework1Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 AgrmtFrmwk,omitempty"`
	PrtryId    GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 PrtryId,omitempty"`
}
...
type CollateralAccountIdentificationType2Choice struct {
	...
	Prtry GenericIdentification36    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 Prtry,omitempty"`
}
...
type CollateralPurpose1Choice struct {
	Cd    CollateralPurpose1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 DtTm,omitempty"`
}
...
type InterestRate1Choice struct {
	FxdIntrstRate   float64               `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 FxdIntrstRate,omitempty"`
	VarblIntrstRate VariableInterest1Rate `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 VarblIntrstRate,omitempty"`
}
...
type PartyIdentification100Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 AnyBIC,omitempty"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress6         `xml:"urn:iso:std:iso:20022:tech:xsd:colr.013.001.04 NmAndAdr,omitempty"`
}
