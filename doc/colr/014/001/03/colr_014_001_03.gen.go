...
type AgreementFramework1Choice struct {
	AgrmtFrmwk AgreementFramework1Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 AgrmtFrmwk,omitempty"`
	PrtryId    GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 PrtryId,omitempty"`
}
...
type CollateralAccountIdentificationType1Choice struct {
	...
	Prtry GenericIdentification29    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 Prtry,omitempty"`
}
...
type CollateralPurpose1Choice struct {
	Cd    CollateralPurpose1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 DtTm,omitempty"`
}
...
type InterestRate1Choice struct {
	FxdIntrstRate   float64               `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 FxdIntrstRate,omitempty"`
	VarblIntrstRate VariableInterest1Rate `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 VarblIntrstRate,omitempty"`
}
...
type PartyIdentification33Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 AnyBIC,omitempty"`
	PrtryId  GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress6         `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 NmAndAdr,omitempty"`
}
...
type RejectionReason21FormatChoice struct {
	Cd    InterestRejectionReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 Cd,omitempty"`
	Prtry GenericIdentification30      `xml:"urn:iso:std:iso:20022:tech:xsd:colr.014.001.03 Prtry,omitempty"`
}
