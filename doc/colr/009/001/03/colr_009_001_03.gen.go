...
type CollateralAccountIdentificationType1Choice struct {
	...
	Prtry GenericIdentification29    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 DtTm,omitempty"`
}
...
type DisputeNotification1Choice struct {
	DsptNtfctnDtls          DisputeNotification1                `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 DsptNtfctnDtls,omitempty"`
	SgrtdIndpdntAmtDsptDtls SegregatedIndependentAmountDispute1 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 SgrtdIndpdntAmtDsptDtls,omitempty"`
}

type DisputeResolutionType1Choice struct {
	Cd      DisputeResolutionType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 Cd,omitempty"`
	PrtryId GenericIdentification30    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 PrtryId,omitempty"`
}
...
type DisputeResolutionType2Choice struct {
	Cd      DisputeResolutionType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 Cd,omitempty"`
	PrtryId GenericIdentification30    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 PrtryId,omitempty"`
}
...
type PartyIdentification33Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 AnyBIC,omitempty"`
	PrtryId  GenericIdentification29 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress6         `xml:"urn:iso:std:iso:20022:tech:xsd:colr.009.001.03 NmAndAdr,omitempty"`
}
