...
type CollateralAccountIdentificationType2Choice struct {
	...
	Prtry GenericIdentification36    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 Prtry,omitempty"`
}
...
type CollateralCancellationType1Choice struct {
	Cd    CollateralManagementCancellationReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 Cd,omitempty"`
	Prtry GenericIdentification30                     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 DtTm,omitempty"`
}
...
type PartyIdentification100Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 AnyBIC,omitempty"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress6         `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 NmAndAdr,omitempty"`
}
...
type Reference2Choice struct {
	MrgnCallReqId     Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 MrgnCallReqId,omitempty"`
	MrgnCallRspnId    Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 MrgnCallRspnId,omitempty"`
	CollPrpslId       Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 CollPrpslId,omitempty"`
	CollPrpslRspnId   Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 CollPrpslRspnId,omitempty"`
	DsptNtfctnId      Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 DsptNtfctnId,omitempty"`
	CollSbstitnReqId  Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 CollSbstitnReqId,omitempty"`
	CollSbstitnRspnId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 CollSbstitnRspnId,omitempty"`
	CollSbstitnConfId Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 CollSbstitnConfId,omitempty"`
	IntrstPmtReqId    Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 IntrstPmtReqId,omitempty"`
	IntrstPmtRspnId   Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 IntrstPmtRspnId,omitempty"`
	IntrstPmtStmtId   Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:colr.005.001.04 IntrstPmtStmtId,omitempty"`
}
