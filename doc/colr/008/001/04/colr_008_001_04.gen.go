...
type AccountIdentification4Choice struct {
	IBAN IBAN2007Identifier            `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 IBAN,omitempty"`
	Othr GenericAccountIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 Othr,omitempty"`
}

type AccountSchemeName1Choice struct {
	Cd    ExternalAccountIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 Cd,omitempty"`
	Prtry Max35Text                          `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 Prtry,omitempty"`
}
...
type CollateralAccountIdentificationType2Choice struct {
	...
	Prtry GenericIdentification36    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 Prtry,omitempty"`
}
...
type CollateralProposalResponse2Choice struct {
	CollPrpsl       CollateralProposalResponse2     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 CollPrpsl,omitempty"`
	SgrtdIndpdntAmt CollateralProposalResponseType2 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 SgrtdIndpdntAmt,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 DtTm,omitempty"`
}
...
type PartyIdentification100Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 AnyBIC,omitempty"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress6         `xml:"urn:iso:std:iso:20022:tech:xsd:colr.008.001.04 NmAndAdr,omitempty"`
}
