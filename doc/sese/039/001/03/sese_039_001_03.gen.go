...
type AcknowledgedAcceptedStatus14Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []AcknowledgementReason7 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Rsn,omitempty"`
}
...
type AcknowledgementReason9Choice struct {
	Cd    AcknowledgementReason6Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 DtTm,omitempty"`
}
...
type DeniedReason7Choice struct {
	Cd    DeniedReason6Code       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification40 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}

type DeniedStatus10Choice struct {
	NoSpcfdRsn NoReasonCode    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []DeniedReason5 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Rsn,omitempty"`
}
...
type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 AmtsdVal,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
...
type ModificationProcessingStatus4Choice struct {
	AckdAccptd AcknowledgedAcceptedStatus14Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 AckdAccptd,omitempty"`
	PdgPrcg    PendingProcessingStatus7Choice     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 PdgPrcg,omitempty"`
	Dnd        DeniedStatus10Choice               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Dnd,omitempty"`
	Rjctd      RejectionStatus8Choice             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Rjctd,omitempty"`
	Rprd       RepairStatus8Choice                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Rprd,omitempty"`
	Modfd      ModificationStatus2Choice          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Modfd,omitempty"`
	Prtry      ProprietaryStatusAndReason1        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
...
type ModificationReason2Choice struct {
	Cd    ModifiedStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification20   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
...
type PartyIdentification36Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 AnyBIC,omitempty"`
	PrtryId GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 PrtryId,omitempty"`
}

type PartyIdentification37Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 AnyBIC,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 NmAndAdr,omitempty"`
	Ctry     CountryCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Ctry,omitempty"`
}
...
type PendingProcessingReason5Choice struct {
	Cd    PendingProcessingReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification20      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}

type PendingProcessingStatus7Choice struct {
	NoSpcfdRsn NoReasonCode               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []PendingProcessingReason5 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Rsn,omitempty"`
}
...
type Quantity6Choice struct {
	Qty             FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities1      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 OrgnlAndCurFace,omitempty"`
}
...
type RejectionReason11Choice struct {
	Cd    RejectionReason31Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
...
type RejectionStatus8Choice struct {
	NoSpcfdRsn NoReasonCode        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionReason11 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Rsn,omitempty"`
}

type RepairReason1Choice struct {
	Cd    RepairReason4Code       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
...
type RepairStatus8Choice struct {
	NoSpcfdRsn NoReasonCode    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []RepairReason6 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Rsn,omitempty"`
}
...
type SettlementDate2Choice struct {
	Dt   DateAndDateTimeChoice     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Dt,omitempty"`
	DtCd SettlementDateCode2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 DtCd,omitempty"`
}

type SettlementDateCode2Choice struct {
	Cd    DateType4Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
...
type TradeDate1Choice struct {
	Dt   DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Dt,omitempty"`
	DtCd TradeDateCode1Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 DtCd,omitempty"`
}

type TradeDateCode1Choice struct {
	Cd    DateType3Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.039.001.03 Prtry,omitempty"`
}
