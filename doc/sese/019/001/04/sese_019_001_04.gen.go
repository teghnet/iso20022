...
type CurrentYearType2Choice struct {
	CurYrTp       ISAType2Code    `xml:"urn:swift:xsd:sese.019.001.04 CurYrTp,omitempty"`
	XtndedCurYrTp Extended350Code `xml:"urn:swift:xsd:sese.019.001.04 XtndedCurYrTp,omitempty"`
}
...
type ISAPortfolio3Choice struct {
	ISA   ISAYearsOfIssue6 `xml:"urn:swift:xsd:sese.019.001.04 ISA,omitempty"`
	Prtfl Portfolio1       `xml:"urn:swift:xsd:sese.019.001.04 Prtfl,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:swift:xsd:sese.019.001.04 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:swift:xsd:sese.019.001.04 Prtry,omitempty"`
}
...
type PartyIdentification70Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:swift:xsd:sese.019.001.04 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:swift:xsd:sese.019.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:swift:xsd:sese.019.001.04 NmAndAdr,omitempty"`
}
...
type PreviousYearChoice struct {
	AllPrvsYrs   PreviousAll `xml:"urn:swift:xsd:sese.019.001.04 AllPrvsYrs,omitempty"`
	SpcfcPrvsYrs []ISOYear   `xml:"urn:swift:xsd:sese.019.001.04 SpcfcPrvsYrs,omitempty"`
}
...
type SecurityIdentification23Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:swift:xsd:sese.019.001.04 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:swift:xsd:sese.019.001.04 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:swift:xsd:sese.019.001.04 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:swift:xsd:sese.019.001.04 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:swift:xsd:sese.019.001.04 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:swift:xsd:sese.019.001.04 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:swift:xsd:sese.019.001.04 CTA,omitempty"`
	QUICK       string                                `xml:"urn:swift:xsd:sese.019.001.04 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:swift:xsd:sese.019.001.04 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:swift:xsd:sese.019.001.04 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:swift:xsd:sese.019.001.04 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:swift:xsd:sese.019.001.04 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:swift:xsd:sese.019.001.04 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:swift:xsd:sese.019.001.04 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification7      `xml:"urn:swift:xsd:sese.019.001.04 OthrPrtryId,omitempty"`
}
