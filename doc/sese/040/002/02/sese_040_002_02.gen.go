...
type ConsentOrRejectionReason5Choice struct {
	Cd    CounterpartyResponseStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Cd,omitempty"`
	Prtry GenericIdentification47               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Prtry,omitempty"`
}
...
type ConsentStatus5Choice struct {
	NoSpcfdRsn NoReasonCode     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 NoSpcfdRsn,omitempty"`
	Rsn        []ConsentReason5 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Rsn,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 DtTm,omitempty"`
}
...
type FinancialInstrumentQuantity15Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 AmtsdVal,omitempty"`
}
...
type IdentificationSource4Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Cd,omitempty"`
	Prtry RestrictedFINExact2Text                            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Prtry,omitempty"`
}
...
type PartyIdentification104Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 AnyBIC,omitempty"`
	PrtryId  GenericIdentification84 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress12        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 NmAndAdr,omitempty"`
}
...
type PartyIdentification115Choice struct {
	...
	PrtryId  GenericIdentification84 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress12        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 NmAndAdr,omitempty"`
	Ctry     CountryCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Ctry,omitempty"`
}
...
type PendingStatus20Choice struct {
	Fwdd        NoSpecifiedReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Fwdd,omitempty"`
	UdrInvstgtn NoSpecifiedReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 UdrInvstgtn,omitempty"`
}

type Quantity10Choice struct {
	Qty             FinancialInstrumentQuantity15Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities4       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 OrgnlAndCurFace,omitempty"`
}
...
type RejectionStatus27Choice struct {
	NoSpcfdRsn NoReasonCode      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 NoSpcfdRsn,omitempty"`
	Rsn        RejectionReason40 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Rsn,omitempty"`
}

type ResponseStatus8Choice struct {
	Cnsntd ConsentStatus5Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Cnsntd,omitempty"`
	Rjctd  RejectionStatus27Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Rjctd,omitempty"`
	Pdg    PendingStatus20Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Pdg,omitempty"`
}
...
type SettlementDate15Choice struct {
	Dt   DateAndDateTimeChoice      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Dt,omitempty"`
	DtCd SettlementDateCode11Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 DtCd,omitempty"`
}

type SettlementDateCode11Choice struct {
	Cd    DateType4Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Prtry,omitempty"`
}
...
type TradeDate6Choice struct {
	Dt   DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Dt,omitempty"`
	DtCd TradeDateCode4Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 DtCd,omitempty"`
}

type TradeDateCode4Choice struct {
	Cd    DateType3Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.002.02 Prtry,omitempty"`
}
