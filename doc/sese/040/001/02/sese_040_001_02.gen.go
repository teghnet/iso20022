...
type ConsentOrRejectionReason4Choice struct {
	Cd    CounterpartyResponseStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Cd,omitempty"`
	Prtry GenericIdentification30               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Prtry,omitempty"`
}
...
type ConsentStatus4Choice struct {
	NoSpcfdRsn NoReasonCode     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 NoSpcfdRsn,omitempty"`
	Rsn        []ConsentReason4 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Rsn,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 DtTm,omitempty"`
}
...
type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 AmtsdVal,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Prtry,omitempty"`
}
...
type PartyIdentification44Choice struct {
	AnyBIC   AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 AnyBIC,omitempty"`
	NmAndAdr NameAndAddress5  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 NmAndAdr,omitempty"`
	Ctry     CountryCode      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Ctry,omitempty"`
}

type PartyIdentification71Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 AnyBIC,omitempty"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 NmAndAdr,omitempty"`
}
...
type PendingStatus20Choice struct {
	Fwdd        NoSpecifiedReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Fwdd,omitempty"`
	UdrInvstgtn NoSpecifiedReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 UdrInvstgtn,omitempty"`
}
...
type Quantity6Choice struct {
	Qty             FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities1      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 OrgnlAndCurFace,omitempty"`
}
...
type RejectionStatus20Choice struct {
	NoSpcfdRsn NoReasonCode      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 NoSpcfdRsn,omitempty"`
	Rsn        RejectionReason29 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Rsn,omitempty"`
}

type ResponseStatus6Choice struct {
	Cnsntd ConsentStatus4Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Cnsntd,omitempty"`
	Rjctd  RejectionStatus20Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Rjctd,omitempty"`
	Pdg    PendingStatus20Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Pdg,omitempty"`
}
...
type SettlementDate10Choice struct {
	Dt   DateAndDateTimeChoice     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Dt,omitempty"`
	DtCd SettlementDateCode8Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 DtCd,omitempty"`
}

type SettlementDateCode8Choice struct {
	Cd    DateType4Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Prtry,omitempty"`
}
...
type TradeDate5Choice struct {
	Dt   DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Dt,omitempty"`
	DtCd TradeDateCode3Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 DtCd,omitempty"`
}

type TradeDateCode3Choice struct {
	Cd    DateType3Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.02 Prtry,omitempty"`
}
