...
type ConsentOrRejectionReason2Choice struct {
	Cd    CounterpartyResponseStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Cd,omitempty"`
	Prtry GenericIdentification20               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Prtry,omitempty"`
}
...
type ConsentStatus2Choice struct {
	NoSpcfdRsn NoReasonCode     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 NoSpcfdRsn,omitempty"`
	Rsn        []ConsentReason2 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Rsn,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 DtTm,omitempty"`
}
...
type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 AmtsdVal,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Prtry,omitempty"`
}
...
type PartyIdentification37Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 AnyBIC,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 NmAndAdr,omitempty"`
	Ctry     CountryCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Ctry,omitempty"`
}
...
type PendingStatus20Choice struct {
	Fwdd        NoSpecifiedReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Fwdd,omitempty"`
	UdrInvstgtn NoSpecifiedReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 UdrInvstgtn,omitempty"`
}
...
type Quantity6Choice struct {
	Qty             FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities1      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 OrgnlAndCurFace,omitempty"`
}
...
type RejectionStatus7Choice struct {
	NoSpcfdRsn NoReasonCode      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 NoSpcfdRsn,omitempty"`
	Rsn        RejectionReason12 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Rsn,omitempty"`
}

type ResponseStatus3Choice struct {
	Cnsntd ConsentStatus2Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Cnsntd,omitempty"`
	Rjctd  RejectionStatus7Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Rjctd,omitempty"`
	Pdg    PendingStatus20Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Pdg,omitempty"`
}
...
type SettlementDate2Choice struct {
	Dt   DateAndDateTimeChoice     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Dt,omitempty"`
	DtCd SettlementDateCode2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 DtCd,omitempty"`
}

type SettlementDateCode2Choice struct {
	Cd    DateType4Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Prtry,omitempty"`
}
...
type TradeDate1Choice struct {
	Dt   DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Dt,omitempty"`
	DtCd TradeDateCode1Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 DtCd,omitempty"`
}

type TradeDateCode1Choice struct {
	Cd    DateType3Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.040.001.01 Prtry,omitempty"`
}
