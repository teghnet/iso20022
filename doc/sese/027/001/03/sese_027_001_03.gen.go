...
type AcknowledgedAcceptedStatus12Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []AcknowledgementReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rsn,omitempty"`
}
...
type AcknowledgementReason1Choice struct {
	Cd    AcknowledgementReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}
...
type CancellationReason3Choice struct {
	Cd    CancelledStatusReason5Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}

type CancellationStatus9Choice struct {
	NoSpcfdRsn NoReasonCode          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []CancellationReason2 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rsn,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 DtTm,omitempty"`
}
...
type DeniedReason2Choice struct {
	Cd    DeniedReason4Code       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}
...
type DeniedStatus6Choice struct {
	NoSpcfdRsn NoReasonCode    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []DeniedReason2 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rsn,omitempty"`
}
...
type DocumentNumber1Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 LngNb,omitempty"`
	PrtryNb GenericIdentification19           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 PrtryNb,omitempty"`
}
...
type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 AmtsdVal,omitempty"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}
...
type PartyIdentification36Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 AnyBIC,omitempty"`
	PrtryId GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 PrtryId,omitempty"`
}

type PartyIdentification37Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 AnyBIC,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 NmAndAdr,omitempty"`
	Ctry     CountryCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Ctry,omitempty"`
}
...
type PendingReason15Choice struct {
	Cd    PendingReason9Code      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}
...
type PendingStatus11Choice struct {
	NoSpcfdRsn NoReasonCode     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []PendingReason7 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rsn,omitempty"`
}
...
type ProcessingStatus20Choice struct {
	PdgCxl     PendingStatus11Choice              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 PdgCxl,omitempty"`
	Rjctd      RejectionOrRepairStatus25Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rjctd,omitempty"`
	Rpr        RejectionOrRepairStatus14Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rpr,omitempty"`
	AckdAccptd AcknowledgedAcceptedStatus12Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 AckdAccptd,omitempty"`
	Prtry      ProprietaryStatusAndReason1        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
	Dnd        DeniedStatus6Choice                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Dnd,omitempty"`
	Canc       CancellationStatus9Choice          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Canc,omitempty"`
}
...
type Quantity6Choice struct {
	Qty             FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities1      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 OrgnlAndCurFace,omitempty"`
}
...
type References22Choice struct {
	OthrTxId        GenericDocumentIdentification1    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 OthrTxId,omitempty"`
	SctiesFincgTxId SettlementTypeAndIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 SctiesFincgTxId,omitempty"`
	SctiesSttlmTxId SettlementTypeAndIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 SctiesSttlmTxId,omitempty"`
	IntraPosMvmntId Max35Text                         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 IntraPosMvmntId,omitempty"`
}

type RejectionAndRepairReason13Choice struct {
	Cd    RejectionReason27Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}

type RejectionAndRepairReason18Choice struct {
	Cd    RejectionReason32Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}
...
type RejectionOrRepairStatus14Choice struct {
	NoSpcfdRsn NoReasonCode                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionOrRepairReason13 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rsn,omitempty"`
}

type RejectionOrRepairStatus25Choice struct {
	NoSpcfdRsn NoReasonCode                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionOrRepairReason18 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Rsn,omitempty"`
}
...
type SettlementDate2Choice struct {
	Dt   DateAndDateTimeChoice     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Dt,omitempty"`
	DtCd SettlementDateCode2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 DtCd,omitempty"`
}

type SettlementDateCode2Choice struct {
	Cd    DateType4Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}
...
type TradeDate1Choice struct {
	Dt   DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Dt,omitempty"`
	DtCd TradeDateCode1Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 DtCd,omitempty"`
}

type TradeDateCode1Choice struct {
	Cd    DateType3Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.03 Prtry,omitempty"`
}
