...
type AcknowledgedAcceptedStatus1Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 NoSpcfdRsn,omitempty"`
...
type AcknowledgementReason1Choice struct {
	Cd    AcknowledgementReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
...
type CancellationReason3Choice struct {
	Cd    CancelledStatusReason5Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 DtTm,omitempty"`
}
...
type DeniedReason2Choice struct {
	Cd    DeniedReason4Code       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
...
type DocumentNumber1Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 LngNb,omitempty"`
	PrtryNb GenericIdentification19           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 PrtryNb,omitempty"`
}
...
type FinancialInstrumentQuantity1Choice struct {
	Unit     float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Unit,omitempty"`
	FaceAmt  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 FaceAmt,omitempty"`
	AmtsdVal float64 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 AmtsdVal,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
...
type PartyIdentification10Choice struct {
	BICOrBEI AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 NmAndAdr,omitempty"`
}

type PartyIdentification12Choice struct {
	BICOrBEI AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 BICOrBEI,omitempty"`
	NmAndAdr NameAndAddress5  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 NmAndAdr,omitempty"`
	Ctry     CountryCode      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Ctry,omitempty"`
}
...
type PendingReason2Choice struct {
	Cd    PendingReason6Code      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
...
type ProcessingStatus2Choice struct {
	PdgCxl     PendingStatus4Choice              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 PdgCxl,omitempty"`
	Rjctd      RejectionOrRepairStatus6Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Rjctd,omitempty"`
	Rpr        RejectionOrRepairStatus6Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Rpr,omitempty"`
	AckdAccptd AcknowledgedAcceptedStatus1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 AckdAccptd,omitempty"`
	Prtry      ProprietaryStatusAndReason1       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
	Dnd        DeniedStatus2Choice               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Dnd,omitempty"`
	Canc       CancellationStatus3Choice         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Canc,omitempty"`
}
...
type Quantity6Choice struct {
	Qty             FinancialInstrumentQuantity1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Qty,omitempty"`
	OrgnlAndCurFace OriginalAndCurrentQuantities1      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 OrgnlAndCurFace,omitempty"`
}
...
type References4Choice struct {
	OthrTxId        GenericDocumentIdentification1   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 OthrTxId,omitempty"`
	SctiesFincgTxId SettlementTypeAndIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 SctiesFincgTxId,omitempty"`
	SctiesSttlmTxId SettlementTypeAndIdentification4 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 SctiesSttlmTxId,omitempty"`
	IntraPosMvmntId Max35Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 IntraPosMvmntId,omitempty"`
}

type RejectionAndRepairReason1Choice struct {
	Cd    RejectionReason21Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
...
type SecurityIdentification11Choice struct {
	ISIN   ISINIdentifier           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 ISIN,omitempty"`
	OthrId AlternateIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 OthrId,omitempty"`
}

type SettlementDate2Choice struct {
	Dt   DateAndDateTimeChoice     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Dt,omitempty"`
	DtCd SettlementDateCode2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 DtCd,omitempty"`
}

type SettlementDateCode2Choice struct {
	Cd    DateType4Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
...
type TradeDate1Choice struct {
	Dt   DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Dt,omitempty"`
	DtCd TradeDateCode1Choice  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 DtCd,omitempty"`
}

type TradeDateCode1Choice struct {
	Cd    DateType3Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.027.001.01 Prtry,omitempty"`
}
