...
type CancellationPendingStatus7Choice struct {
	...
	DataSrcSchme GenericIdentification1 `xml:"urn:swift:xsd:sese.011.001.05 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode           `xml:"urn:swift:xsd:sese.011.001.05 NoSpcfdRsn,omitempty"`
}

type CancelledStatus13Choice struct {
	NoSpcfdRsn   NoReasonCode               `xml:"urn:swift:xsd:sese.011.001.05 NoSpcfdRsn,omitempty"`
	Rsn          CancelledStatusReason3Code `xml:"urn:swift:xsd:sese.011.001.05 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:swift:xsd:sese.011.001.05 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:swift:xsd:sese.011.001.05 DataSrcSchme,omitempty"`
}
...
type PartyIdentification70Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:swift:xsd:sese.011.001.05 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:swift:xsd:sese.011.001.05 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:swift:xsd:sese.011.001.05 NmAndAdr,omitempty"`
}
...
type PartyIdentification97Choice struct {
	AnyBIC     AnyBICIdentifier       `xml:"urn:swift:xsd:sese.011.001.05 AnyBIC,omitempty"`
	LglNttyIdr LEIIdentifier          `xml:"urn:swift:xsd:sese.011.001.05 LglNttyIdr,omitempty"`
	NmAndAdr   NameAndAddress5        `xml:"urn:swift:xsd:sese.011.001.05 NmAndAdr,omitempty"`
	PrtryId    GenericIdentification1 `xml:"urn:swift:xsd:sese.011.001.05 PrtryId,omitempty"`
}

type PendingSettlementStatus3Choice struct {
	Rsn          PendingSettlementStatusReason2Code `xml:"urn:swift:xsd:sese.011.001.05 Rsn,omitempty"`
	XtndedRsn    Extended350Code                    `xml:"urn:swift:xsd:sese.011.001.05 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1             `xml:"urn:swift:xsd:sese.011.001.05 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode                       `xml:"urn:swift:xsd:sese.011.001.05 NoSpcfdRsn,omitempty"`
}
...
type References49Choice struct {
	RltdRef []AdditionalReference6 `xml:"urn:swift:xsd:sese.011.001.05 RltdRef,omitempty"`
	OthrRef []AdditionalReference6 `xml:"urn:swift:xsd:sese.011.001.05 OthrRef,omitempty"`
}

type RejectedReason15Choice struct {
	Cd    TransferRejectedStatusReason2Code `xml:"urn:swift:xsd:sese.011.001.05 Cd,omitempty"`
	Prtry GenericIdentification36           `xml:"urn:swift:xsd:sese.011.001.05 Prtry,omitempty"`
}
...
type TransferStatus2Choice struct {
	Sts        TransferInstructionStatus4       `xml:"urn:swift:xsd:sese.011.001.05 Sts,omitempty"`
	PdgSttlm   PendingSettlementStatus3Choice   `xml:"urn:swift:xsd:sese.011.001.05 PdgSttlm,omitempty"`
	Umtchd     TransferUnmatchedStatus3Choice   `xml:"urn:swift:xsd:sese.011.001.05 Umtchd,omitempty"`
	InRpr      InRepairStatus4Choice            `xml:"urn:swift:xsd:sese.011.001.05 InRpr,omitempty"`
	Rjctd      []RejectionReason32              `xml:"urn:swift:xsd:sese.011.001.05 Rjctd,omitempty"`
	FaildSttlm FailedSettlementStatus2Choice    `xml:"urn:swift:xsd:sese.011.001.05 FaildSttlm,omitempty"`
	Canc       CancelledStatus13Choice          `xml:"urn:swift:xsd:sese.011.001.05 Canc,omitempty"`
	Rvsd       ReversedStatus2Choice            `xml:"urn:swift:xsd:sese.011.001.05 Rvsd,omitempty"`
	CxlPdg     CancellationPendingStatus7Choice `xml:"urn:swift:xsd:sese.011.001.05 CxlPdg,omitempty"`
}
...
type TransferUnmatchedStatus3Choice struct {
	NoSpcfdRsn   NoReasonCode                 `xml:"urn:swift:xsd:sese.011.001.05 NoSpcfdRsn,omitempty"`
	Rsn          TransferUnmatchedReason2Code `xml:"urn:swift:xsd:sese.011.001.05 Rsn,omitempty"`
	XtndedRsn    Extended350Code              `xml:"urn:swift:xsd:sese.011.001.05 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1       `xml:"urn:swift:xsd:sese.011.001.05 DataSrcSchme,omitempty"`
}
