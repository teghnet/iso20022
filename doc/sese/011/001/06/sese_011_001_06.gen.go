...
type CancellationPendingStatus7Choice struct {
	...
	DataSrcSchme GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 NoSpcfdRsn,omitempty"`
}

type CancelledStatus13Choice struct {
	NoSpcfdRsn   NoReasonCode               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 NoSpcfdRsn,omitempty"`
	Rsn          CancelledStatusReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 DataSrcSchme,omitempty"`
}
...
type ChargeBasis2Choice struct {
	Cd    TaxationBasis5Code      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}
...
type ChargeType5Choice struct {
	Cd    InvestmentFundFee1Code  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}
...
type OtherAmountType1Choice struct {
	Cd      OtherAmountType1Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	PrtryCd GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 PrtryCd,omitempty"`
}
...
type PartyIdentification90Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 NmAndAdr,omitempty"`
}

type PartyIdentification97Choice struct {
	AnyBIC     AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 AnyBIC,omitempty"`
	LglNttyIdr LEIIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 LglNttyIdr,omitempty"`
	NmAndAdr   NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 NmAndAdr,omitempty"`
	PrtryId    GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 PrtryId,omitempty"`
}

type PendingSettlementStatus3Choice struct {
	Rsn          PendingSettlementStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Rsn,omitempty"`
	XtndedRsn    Extended350Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode                       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 NoSpcfdRsn,omitempty"`
}
...
type References61Choice struct {
	RltdRef []AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 RltdRef,omitempty"`
	OthrRef []AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 OthrRef,omitempty"`
}

type RejectedReason15Choice struct {
	Cd    TransferRejectedStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification36           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}
...
type TaxBasis1Choice struct {
	Cd    TaxationBasis2Code      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}
...
type TaxType3Choice struct {
	Cd    TaxType17Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}

type TaxableIncomePerShareCalculated2Choice struct {
	Cd    TaxableIncomePerShareCalculated2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification47              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}
...
type TransferStatus2Choice struct {
	Sts        TransferInstructionStatus4       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Sts,omitempty"`
	PdgSttlm   PendingSettlementStatus3Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 PdgSttlm,omitempty"`
	Umtchd     TransferUnmatchedStatus3Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Umtchd,omitempty"`
	InRpr      InRepairStatus4Choice            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 InRpr,omitempty"`
	Rjctd      []RejectionReason32              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Rjctd,omitempty"`
	FaildSttlm FailedSettlementStatus2Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 FaildSttlm,omitempty"`
	Canc       CancelledStatus13Choice          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Canc,omitempty"`
	Rvsd       ReversedStatus2Choice            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Rvsd,omitempty"`
	CxlPdg     CancellationPendingStatus7Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 CxlPdg,omitempty"`
}
...
type TransferUnmatchedStatus3Choice struct {
	NoSpcfdRsn   NoReasonCode                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 NoSpcfdRsn,omitempty"`
	Rsn          TransferUnmatchedReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Rsn,omitempty"`
	XtndedRsn    Extended350Code              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 DataSrcSchme,omitempty"`
}
...
type TypeOfPrice46Choice struct {
	Cd    TypeOfPrice10Code       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}
...
type WaivingInstruction2Choice struct {
	Cd    WaivingInstruction1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.06 Prtry,omitempty"`
}
