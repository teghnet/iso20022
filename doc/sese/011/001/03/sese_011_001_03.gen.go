...
type CancellationPendingStatus1 struct {
	...
	DataSrcSchme GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 NoSpcfdRsn,omitempty"`
}

type CancelledStatus3 struct {
	NoSpcfdRsn   NoReasonCode               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 NoSpcfdRsn,omitempty"`
	Rsn          CancelledStatusReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 DataSrcSchme,omitempty"`
}
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Strd,omitempty"`
}
...
type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 NmAndAdr,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 NmAndAdr,omitempty"`
}

type PendingSettlementStatus2 struct {
	Rsn          PendingSettlementStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Rsn,omitempty"`
	XtndedRsn    Extended350Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode                       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 NoSpcfdRsn,omitempty"`
}
...
type RejectedStatus8Choice struct {
	Rsn          TransferRejectedStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Rsn,omitempty"`
	XtndedRsn    Extended350Code                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 XtndedRsn,omitempty"`
	DataSrcSchme []GenericIdentification1          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 DataSrcSchme,omitempty"`
}
...
type TransferStatusAndReason2 struct {
	...
	Sts        TransferInstructionStatus2 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Sts,omitempty"`
	PdgSttlm   PendingSettlementStatus2   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 PdgSttlm,omitempty"`
	Umtchd     TransferUnmatchedStatus2   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Umtchd,omitempty"`
	InRpr      InRepairStatus3            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 InRpr,omitempty"`
	Rjctd      RejectedStatus8Choice      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Rjctd,omitempty"`
	FaildSttlm FailedSettlementStatus1    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 FaildSttlm,omitempty"`
	Canc       CancelledStatus3           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Canc,omitempty"`
	Rvsd       ReversedStatus1            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Rvsd,omitempty"`
	CxlPdg     CancellationPendingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 CxlPdg,omitempty"`
...
type TransferUnmatchedStatus2 struct {
	NoSpcfdRsn   NoReasonCode                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 NoSpcfdRsn,omitempty"`
	Rsn          TransferUnmatchedReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 Rsn,omitempty"`
	XtndedRsn    Extended350Code              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.03 DataSrcSchme,omitempty"`
}
