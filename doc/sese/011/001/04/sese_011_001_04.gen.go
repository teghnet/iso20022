...
type CancellationPendingStatus1 struct {
	...
	DataSrcSchme GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 NoSpcfdRsn,omitempty"`
}

type CancelledStatus3 struct {
	NoSpcfdRsn   NoReasonCode               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 NoSpcfdRsn,omitempty"`
	Rsn          CancelledStatusReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 DataSrcSchme,omitempty"`
}
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Strd,omitempty"`
}
...
type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 NmAndAdr,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 NmAndAdr,omitempty"`
}

type PendingSettlementStatus2 struct {
	Rsn          PendingSettlementStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Rsn,omitempty"`
	XtndedRsn    Extended350Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode                       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 NoSpcfdRsn,omitempty"`
}
...
type References40Choice struct {
	RltdRef []AdditionalReference3 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 RltdRef,omitempty"`
	OthrRef []AdditionalReference3 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 OthrRef,omitempty"`
}

type RejectedStatus8Choice struct {
	Rsn          TransferRejectedStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Rsn,omitempty"`
	XtndedRsn    Extended350Code                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 XtndedRsn,omitempty"`
	DataSrcSchme []GenericIdentification1          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 DataSrcSchme,omitempty"`
}
...
type TransferStatus1Choice struct {
	Sts        TransferInstructionStatus3 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Sts,omitempty"`
	PdgSttlm   PendingSettlementStatus2   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 PdgSttlm,omitempty"`
	Umtchd     TransferUnmatchedStatus2   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Umtchd,omitempty"`
	InRpr      InRepairStatus3            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 InRpr,omitempty"`
	Rjctd      []RejectedStatus8Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Rjctd,omitempty"`
	FaildSttlm FailedSettlementStatus1    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 FaildSttlm,omitempty"`
	Canc       CancelledStatus3           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Canc,omitempty"`
	Rvsd       ReversedStatus1            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Rvsd,omitempty"`
	CxlPdg     CancellationPendingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 CxlPdg,omitempty"`
}
...
type TransferUnmatchedStatus2 struct {
	NoSpcfdRsn   NoReasonCode                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 NoSpcfdRsn,omitempty"`
	Rsn          TransferUnmatchedReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 Rsn,omitempty"`
	XtndedRsn    Extended350Code              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.04 DataSrcSchme,omitempty"`
}
