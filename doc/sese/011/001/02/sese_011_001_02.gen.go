...
type CancellationPendingStatus1 struct {
	...
	DataSrcSchme GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 NoSpcfdRsn,omitempty"`
}

type CancelledStatus3 struct {
	NoSpcfdRsn   NoReasonCode               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 NoSpcfdRsn,omitempty"`
	Rsn          CancelledStatusReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 DataSrcSchme,omitempty"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 NmAndAdr,omitempty"`
}

type PendingSettlementStatus2 struct {
	Rsn          PendingSettlementStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Rsn,omitempty"`
	XtndedRsn    Extended350Code                    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 DataSrcSchme,omitempty"`
	NoSpcfdRsn   NoReasonCode                       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 NoSpcfdRsn,omitempty"`
}
...
type RejectedStatus8Choice struct {
	Rsn          TransferRejectedStatusReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Rsn,omitempty"`
	XtndedRsn    Extended350Code                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 XtndedRsn,omitempty"`
	DataSrcSchme []GenericIdentification1          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 DataSrcSchme,omitempty"`
}
...
type TransferStatusAndReason2 struct {
	...
	Sts        TransferInstructionStatus2 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Sts,omitempty"`
	PdgSttlm   PendingSettlementStatus2   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 PdgSttlm,omitempty"`
	Umtchd     TransferUnmatchedStatus2   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Umtchd,omitempty"`
	InRpr      InRepairStatus3            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 InRpr,omitempty"`
	Rjctd      RejectedStatus8Choice      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Rjctd,omitempty"`
	FaildSttlm FailedSettlementStatus1    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 FaildSttlm,omitempty"`
	Canc       CancelledStatus3           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Canc,omitempty"`
	Rvsd       ReversedStatus1            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Rvsd,omitempty"`
	CxlPdg     CancellationPendingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 CxlPdg,omitempty"`
...
type TransferUnmatchedStatus2 struct {
	NoSpcfdRsn   NoReasonCode                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 NoSpcfdRsn,omitempty"`
	Rsn          TransferUnmatchedReason2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 Rsn,omitempty"`
	XtndedRsn    Extended350Code              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.011.001.02 DataSrcSchme,omitempty"`
}
