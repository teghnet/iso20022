...
type PartyIdentification90Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 NmAndAdr,omitempty"`
}
...
type References63Choice struct {
	PrvsRef AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 PrvsRef,omitempty"`
	OthrRef AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 OthrRef,omitempty"`
}
...
type Role4Choice struct {
	Cd    InvestmentFundRole2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 Prtry,omitempty"`
}
...
type SafekeepingPlaceFormat8Choice struct {
	Id      SafekeepingPlaceTypeAndText6             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 Id,omitempty"`
	Ctry    CountryCode                              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndAnyBICIdentifier1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 TpAndId,omitempty"`
	Prtry   GenericIdentification78                  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.009.001.06 Prtry,omitempty"`
}
