...
type CancellationStatusAndReason2 struct {
	...
	Sts      TransferCancellationStatus2                  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Sts,omitempty"`
	Rjctd    TransferCancellationRejectedStatus1          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Rjctd,omitempty"`
	Cmplt    TransferCancellationCompleteStatusAndReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Cmplt,omitempty"`
	Pdg      TransferCancellationPendingStatus1           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Pdg,omitempty"`
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Strd,omitempty"`
}
...
type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 NmAndAdr,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 NmAndAdr,omitempty"`
}
...
type TransferCancellationCompleteStatusAndReason1 struct {
	Rsn          CancelledStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 DataSrcSchme,omitempty"`
}
...
type TransferCancellationRejectedStatus1 struct {
	Rsn          CancellationRejectedReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 Rsn,omitempty"`
	XtndedRsn    Extended350Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 XtndedRsn,omitempty"`
	DataSrcSchme []GenericIdentification1        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.03 DataSrcSchme,omitempty"`
}
