...
type CancellationCompleteReason1Choice struct {
	Cd    CancelledStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Cd,omitempty"`
	Prtry GenericIdentification36    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Prtry,omitempty"`
}
...
type PartyIdentification90Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 NmAndAdr,omitempty"`
}

type PartyIdentification97Choice struct {
	AnyBIC     AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 AnyBIC,omitempty"`
	LglNttyIdr LEIIdentifier          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 LglNttyIdr,omitempty"`
	NmAndAdr   NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 NmAndAdr,omitempty"`
	PrtryId    GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 PrtryId,omitempty"`
}
...
type References61Choice struct {
	RltdRef []AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 RltdRef,omitempty"`
	OthrRef []AdditionalReference8 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 OthrRef,omitempty"`
}

type RejectedReason17Choice struct {
	Cd    CancellationRejectedReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Cd,omitempty"`
	Prtry GenericIdentification36         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Prtry,omitempty"`
}
...
type Status21Choice struct {
	Sts   TransferCancellationStatus2        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Sts,omitempty"`
	Rjctd RejectionReason33                  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Rjctd,omitempty"`
	Cmplt CancelledCompleteReason1           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Cmplt,omitempty"`
	Pdg   TransferCancellationPendingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.06 Pdg,omitempty"`
}
