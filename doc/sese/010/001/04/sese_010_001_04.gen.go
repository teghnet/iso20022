...
type CancellationStatusAndReason2 struct {
	...
	Sts      TransferCancellationStatus2                  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Sts,omitempty"`
	Rjctd    TransferCancellationRejectedStatus1          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Rjctd,omitempty"`
	Cmplt    TransferCancellationCompleteStatusAndReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Cmplt,omitempty"`
	Pdg      TransferCancellationPendingStatus1           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Pdg,omitempty"`
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Strd,omitempty"`
}
...
type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 NmAndAdr,omitempty"`
}

type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 NmAndAdr,omitempty"`
}
...
type References40Choice struct {
	RltdRef []AdditionalReference3 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 RltdRef,omitempty"`
	OthrRef []AdditionalReference3 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 OthrRef,omitempty"`
}
...
type TransferCancellationCompleteStatusAndReason1 struct {
	Rsn          CancelledStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 DataSrcSchme,omitempty"`
}
...
type TransferCancellationRejectedStatus1 struct {
	Rsn          CancellationRejectedReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 Rsn,omitempty"`
	XtndedRsn    Extended350Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 XtndedRsn,omitempty"`
	DataSrcSchme []GenericIdentification1        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.04 DataSrcSchme,omitempty"`
}
