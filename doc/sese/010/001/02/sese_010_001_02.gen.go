...
type CancellationStatusAndReason2 struct {
	...
	Sts      TransferCancellationStatus2                  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 Sts,omitempty"`
	Rjctd    TransferCancellationRejectedStatus1          `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 Rjctd,omitempty"`
	Cmplt    TransferCancellationCompleteStatusAndReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 Cmplt,omitempty"`
	Pdg      TransferCancellationPendingStatus1           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 Pdg,omitempty"`
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 NmAndAdr,omitempty"`
}
...
type TransferCancellationCompleteStatusAndReason1 struct {
	Rsn          CancelledStatusReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 Rsn,omitempty"`
	XtndedRsn    Extended350Code            `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 XtndedRsn,omitempty"`
	DataSrcSchme GenericIdentification1     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 DataSrcSchme,omitempty"`
}
...
type TransferCancellationRejectedStatus1 struct {
	Rsn          CancellationRejectedReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 Rsn,omitempty"`
	XtndedRsn    Extended350Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 XtndedRsn,omitempty"`
	DataSrcSchme []GenericIdentification1        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.010.001.02 DataSrcSchme,omitempty"`
}
