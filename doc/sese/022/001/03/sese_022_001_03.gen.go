...
type AcknowledgedAcceptedStatus12Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []AcknowledgementReason1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Rsn,omitempty"`
}
...
type AcknowledgementReason1Choice struct {
	Cd    AcknowledgementReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Prtry,omitempty"`
}
...
type DocumentNumber1Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 LngNb,omitempty"`
	PrtryNb GenericIdentification19           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 PrtryNb,omitempty"`
}
...
type PartyIdentification36Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 AnyBIC,omitempty"`
	PrtryId GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 PrtryId,omitempty"`
}

type ProcessingStatus22Choice struct {
	AckdAccptd AcknowledgedAcceptedStatus12Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 AckdAccptd,omitempty"`
	Rjctd      RejectionOrRepairStatus18Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Rjctd,omitempty"`
	Prtry      ProprietaryStatusAndReason1        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Prtry,omitempty"`
}
...
type RejectionAndRepairReason2Choice struct {
	Cd    RejectionReason24Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Prtry,omitempty"`
}
...
type RejectionOrRepairStatus18Choice struct {
	NoSpcfdRsn NoReasonCode               `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionOrRepairReason2 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Rsn,omitempty"`
}
...
type StatusOrStatement5Choice struct {
	StsAdvc DocumentNumber9 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 StsAdvc,omitempty"`
	Stmt    DocumentNumber1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.03 Stmt,omitempty"`
}
