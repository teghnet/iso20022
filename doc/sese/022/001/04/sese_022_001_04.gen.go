...
type AcknowledgedAcceptedStatus24Choice struct {
	NoSpcfdRsn NoReasonCode              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 NoSpcfdRsn,omitempty"`
	Rsn        []AcknowledgementReason12 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Rsn,omitempty"`
}
...
type AcknowledgementReason15Choice struct {
	Cd    AcknowledgementReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Cd,omitempty"`
	Prtry GenericIdentification30    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Prtry,omitempty"`
}
...
type DocumentNumber5Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 LngNb,omitempty"`
	PrtryNb GenericIdentification36           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 PrtryNb,omitempty"`
}
...
type PartyIdentification92Choice struct {
	AnyBIC  AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 AnyBIC,omitempty"`
	PrtryId GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 PrtryId,omitempty"`
}
...
type ProcessingStatus55Choice struct {
	AckdAccptd AcknowledgedAcceptedStatus24Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 AckdAccptd,omitempty"`
	Rjctd      RejectionOrRepairStatus32Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Rjctd,omitempty"`
	Prtry      ProprietaryStatusAndReason6        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Prtry,omitempty"`
}
...
type RejectionAndRepairReason26Choice struct {
	Cd    RejectionReason24Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Cd,omitempty"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Prtry,omitempty"`
}
...
type RejectionOrRepairStatus32Choice struct {
	NoSpcfdRsn NoReasonCode                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionOrRepairReason26 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Rsn,omitempty"`
}
...
type StatusOrStatement7Choice struct {
	StsAdvc DocumentNumber12 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 StsAdvc,omitempty"`
	Stmt    DocumentNumber13 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.04 Stmt,omitempty"`
}
