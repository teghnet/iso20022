...
type AcknowledgedAcceptedStatus1Choice struct {
	NoSpcfdRsn NoReasonCode             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 NoSpcfdRsn,omitempty"`
...
type AcknowledgementReason1Choice struct {
	Cd    AcknowledgementReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Cd,omitempty"`
	Prtry GenericIdentification20    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 DtTm,omitempty"`
}
...
type DocumentNumber1Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 LngNb,omitempty"`
	PrtryNb GenericIdentification19           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 PrtryNb,omitempty"`
}
...
type PartyIdentification10Choice struct {
	BICOrBEI AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 NmAndAdr,omitempty"`
}
...
type ProcessingStatus4Choice struct {
	AckdAccptd AcknowledgedAcceptedStatus1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 AckdAccptd,omitempty"`
	Rjctd      RejectionOrRepairStatus5Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Rjctd,omitempty"`
	Prtry      ProprietaryStatusAndReason1       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Prtry,omitempty"`
}
...
type RejectionAndRepairReason2Choice struct {
	Cd    RejectionReason24Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Cd,omitempty"`
	Prtry GenericIdentification20 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Prtry,omitempty"`
}
...
type StatusOrStatement1Choice struct {
	StsAdvc DocumentNumber2 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 StsAdvc,omitempty"`
	Stmt    DocumentNumber1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.001.01 Stmt,omitempty"`
}
