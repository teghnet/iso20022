...
type AcknowledgedAcceptedStatus31Choice struct {
	NoSpcfdRsn NoReasonCode              `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 NoSpcfdRsn,omitempty"`
	Rsn        []AcknowledgementReason19 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Rsn,omitempty"`
}
...
type AcknowledgementReason22Choice struct {
	Cd    AcknowledgementReason3Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Cd,omitempty"`
	Prtry GenericIdentification47    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Prtry,omitempty"`
}
...
type DocumentNumber6Choice struct {
	ShrtNb  Exact3NumericText                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 ShrtNb,omitempty"`
	LngNb   ISO20022MessageIdentificationText `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 LngNb,omitempty"`
	PrtryNb GenericIdentification86           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 PrtryNb,omitempty"`
}
...
type PartyIdentification136Choice struct {
	AnyBIC  AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 AnyBIC,omitempty"`
	PrtryId GenericIdentification84 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 PrtryId,omitempty"`
}
...
type ProcessingStatus64Choice struct {
	AckdAccptd AcknowledgedAcceptedStatus31Choice `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 AckdAccptd,omitempty"`
	Rjctd      RejectionOrRepairStatus37Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Rjctd,omitempty"`
	Prtry      ProprietaryStatusAndReason7        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Prtry,omitempty"`
}
...
type RejectionAndRepairReason31Choice struct {
	Cd    RejectionReason24Code   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Prtry,omitempty"`
}
...
type RejectionOrRepairStatus37Choice struct {
	NoSpcfdRsn NoReasonCode                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 NoSpcfdRsn,omitempty"`
	Rsn        []RejectionOrRepairReason31 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Rsn,omitempty"`
}
...
type StatusOrStatement10Choice struct {
	StsAdvc DocumentNumber17 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 StsAdvc,omitempty"`
	Stmt    DocumentNumber14 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.022.002.05 Stmt,omitempty"`
}
