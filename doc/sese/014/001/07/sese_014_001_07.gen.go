...
type AccountIdentification4Choice struct {
	IBAN IBAN2007Identifier            `xml:"urn:swift:xsd:sese.014.001.07 IBAN,omitempty"`
	Othr GenericAccountIdentification1 `xml:"urn:swift:xsd:sese.014.001.07 Othr,omitempty"`
}
...
type AccountSchemeName1Choice struct {
	Cd    ExternalAccountIdentification1Code `xml:"urn:swift:xsd:sese.014.001.07 Cd,omitempty"`
	Prtry Max35Text                          `xml:"urn:swift:xsd:sese.014.001.07 Prtry,omitempty"`
}
...
type Cancellation11Choice struct {
	CxlByTrfInstrDtls ISATransfer24      `xml:"urn:swift:xsd:sese.014.001.07 CxlByTrfInstrDtls,omitempty"`
	CxlByRef          TransferReference7 `xml:"urn:swift:xsd:sese.014.001.07 CxlByRef,omitempty"`
}
...
type ClearingSystemMemberIdentificationChoice struct {
	USCHU  CHIPSUniversalIdentifier                       `xml:"urn:swift:xsd:sese.014.001.07 USCHU,omitempty"`
	NZNCC  NewZealandNCCIdentifier                        `xml:"urn:swift:xsd:sese.014.001.07 NZNCC,omitempty"`
	IENSC  IrishNSCIdentifier                             `xml:"urn:swift:xsd:sese.014.001.07 IENSC,omitempty"`
	GBSC   UKDomesticSortCodeIdentifier                   `xml:"urn:swift:xsd:sese.014.001.07 GBSC,omitempty"`
	USCH   CHIPSParticipantIdentifier                     `xml:"urn:swift:xsd:sese.014.001.07 USCH,omitempty"`
	CHBC   SwissBCIdentifier                              `xml:"urn:swift:xsd:sese.014.001.07 CHBC,omitempty"`
	USFW   FedwireRoutingNumberIdentifier                 `xml:"urn:swift:xsd:sese.014.001.07 USFW,omitempty"`
	PTNCC  PortugueseNCCIdentifier                        `xml:"urn:swift:xsd:sese.014.001.07 PTNCC,omitempty"`
	RUCB   RussianCentralBankIdentificationCodeIdentifier `xml:"urn:swift:xsd:sese.014.001.07 RUCB,omitempty"`
	ITNCC  ItalianDomesticIdentifier                      `xml:"urn:swift:xsd:sese.014.001.07 ITNCC,omitempty"`
	ATBLZ  AustrianBankleitzahlIdentifier                 `xml:"urn:swift:xsd:sese.014.001.07 ATBLZ,omitempty"`
	CACPA  CanadianPaymentsARNIdentifier                  `xml:"urn:swift:xsd:sese.014.001.07 CACPA,omitempty"`
	CHSIC  SwissSICIdentifier                             `xml:"urn:swift:xsd:sese.014.001.07 CHSIC,omitempty"`
	DEBLZ  GermanBankleitzahlIdentifier                   `xml:"urn:swift:xsd:sese.014.001.07 DEBLZ,omitempty"`
	ESNCC  SpanishDomesticInterbankingIdentifier          `xml:"urn:swift:xsd:sese.014.001.07 ESNCC,omitempty"`
	ZANCC  SouthAfricanNCCIdentifier                      `xml:"urn:swift:xsd:sese.014.001.07 ZANCC,omitempty"`
	HKNCC  HongKongBankIdentifier                         `xml:"urn:swift:xsd:sese.014.001.07 HKNCC,omitempty"`
	AUBSBx ExtensiveBranchNetworkIdentifier               `xml:"urn:swift:xsd:sese.014.001.07 AUBSBx,omitempty"`
	AUBSBs SmallNetworkIdentifier                         `xml:"urn:swift:xsd:sese.014.001.07 AUBSBs,omitempty"`
}
...
type CurrentYearType1Choice struct {
	CurYrTp       ISAType1Code    `xml:"urn:swift:xsd:sese.014.001.07 CurYrTp,omitempty"`
	XtndedCurYrTp Extended350Code `xml:"urn:swift:xsd:sese.014.001.07 XtndedCurYrTp,omitempty"`
}

type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:swift:xsd:sese.014.001.07 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:swift:xsd:sese.014.001.07 DtTm,omitempty"`
}

type DateFormat1Choice struct {
	Dt   ISODate             `xml:"urn:swift:xsd:sese.014.001.07 Dt,omitempty"`
	Cd   SettlementDate1Code `xml:"urn:swift:xsd:sese.014.001.07 Cd,omitempty"`
	DtTm ISODateTime         `xml:"urn:swift:xsd:sese.014.001.07 DtTm,omitempty"`
}
...
type FinancialInstitutionIdentification7Choice struct {
	NmAndAdr    NameAndAddress5                          `xml:"urn:swift:xsd:sese.014.001.07 NmAndAdr,omitempty"`
	BICFI       BICFIIdentifier                          `xml:"urn:swift:xsd:sese.014.001.07 BICFI,omitempty"`
	ClrSysMmbId ClearingSystemMemberIdentificationChoice `xml:"urn:swift:xsd:sese.014.001.07 ClrSysMmbId,omitempty"`
	PrtryId     SimpleIdentificationInformation4         `xml:"urn:swift:xsd:sese.014.001.07 PrtryId,omitempty"`
}
...
type ISAPortfolio1Choice struct {
	ISA   ISAYearsOfIssue4 `xml:"urn:swift:xsd:sese.014.001.07 ISA,omitempty"`
	Prtfl Portfolio1       `xml:"urn:swift:xsd:sese.014.001.07 Prtfl,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:swift:xsd:sese.014.001.07 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:swift:xsd:sese.014.001.07 Prtry,omitempty"`
}
...
type PartyIdentification70Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:swift:xsd:sese.014.001.07 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:swift:xsd:sese.014.001.07 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:swift:xsd:sese.014.001.07 NmAndAdr,omitempty"`
}
...
type PartyIdentification97Choice struct {
	AnyBIC     AnyBICIdentifier       `xml:"urn:swift:xsd:sese.014.001.07 AnyBIC,omitempty"`
	LglNttyIdr LEIIdentifier          `xml:"urn:swift:xsd:sese.014.001.07 LglNttyIdr,omitempty"`
	NmAndAdr   NameAndAddress5        `xml:"urn:swift:xsd:sese.014.001.07 NmAndAdr,omitempty"`
	PrtryId    GenericIdentification1 `xml:"urn:swift:xsd:sese.014.001.07 PrtryId,omitempty"`
}
...
type PreviousYear1Choice struct {
	AllPrvsYrs   PreviousAll `xml:"urn:swift:xsd:sese.014.001.07 AllPrvsYrs,omitempty"`
	SpcfcPrvsYrs []ISOYear   `xml:"urn:swift:xsd:sese.014.001.07 SpcfcPrvsYrs,omitempty"`
}
...
type Role4Choice struct {
	Cd    InvestmentFundRole2Code `xml:"urn:swift:xsd:sese.014.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.014.001.07 Prtry,omitempty"`
}
...
type SecurityIdentification23Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:swift:xsd:sese.014.001.07 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:swift:xsd:sese.014.001.07 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:swift:xsd:sese.014.001.07 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:swift:xsd:sese.014.001.07 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:swift:xsd:sese.014.001.07 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:swift:xsd:sese.014.001.07 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:swift:xsd:sese.014.001.07 CTA,omitempty"`
	QUICK       string                                `xml:"urn:swift:xsd:sese.014.001.07 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:swift:xsd:sese.014.001.07 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:swift:xsd:sese.014.001.07 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:swift:xsd:sese.014.001.07 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:swift:xsd:sese.014.001.07 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:swift:xsd:sese.014.001.07 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:swift:xsd:sese.014.001.07 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification7      `xml:"urn:swift:xsd:sese.014.001.07 OthrPrtryId,omitempty"`
}
