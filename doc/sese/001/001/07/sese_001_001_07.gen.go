...
type ChargeBasisType1Choice struct {
	Cd    TaxationBasis2Code      `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type ChargePaymentMethod1Choice struct {
	Cd    ChargePaymentMethod1Code `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47  `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type ChargeType4Choice struct {
	Cd    ChargeType12Code        `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type CommissionBasis1Choice struct {
	Cd    TaxationBasis4Code      `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}

type CommissionType3Choice struct {
	Cd    CommissionType7Code     `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:swift:xsd:sese.001.001.07 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:swift:xsd:sese.001.001.07 DtTm,omitempty"`
}

type DateFormat1Choice struct {
	Dt   ISODate             `xml:"urn:swift:xsd:sese.001.001.07 Dt,omitempty"`
	Cd   SettlementDate1Code `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	DtTm ISODateTime         `xml:"urn:swift:xsd:sese.001.001.07 DtTm,omitempty"`
}
...
type ExemptionReason1Choice struct {
	Cd    TaxExemptReason1Code    `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:swift:xsd:sese.001.001.07 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type PartyIdentification70Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:swift:xsd:sese.001.001.07 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:swift:xsd:sese.001.001.07 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:swift:xsd:sese.001.001.07 NmAndAdr,omitempty"`
}
...
type PartyIdentification97Choice struct {
	AnyBIC     AnyBICIdentifier       `xml:"urn:swift:xsd:sese.001.001.07 AnyBIC,omitempty"`
	LglNttyIdr LEIIdentifier          `xml:"urn:swift:xsd:sese.001.001.07 LglNttyIdr,omitempty"`
	NmAndAdr   NameAndAddress5        `xml:"urn:swift:xsd:sese.001.001.07 NmAndAdr,omitempty"`
	PrtryId    GenericIdentification1 `xml:"urn:swift:xsd:sese.001.001.07 PrtryId,omitempty"`
}
...
type Quantity13Choice struct {
	TtlUnitsNb      FinancialInstrumentQuantity1 `xml:"urn:swift:xsd:sese.001.001.07 TtlUnitsNb,omitempty"`
	PrtflTrfOutRate float64                      `xml:"urn:swift:xsd:sese.001.001.07 PrtflTrfOutRate,omitempty"`
}
...
type Role4Choice struct {
	Cd    InvestmentFundRole2Code `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type SafekeepingPlaceFormat8Choice struct {
	Id      SafekeepingPlaceTypeAndText6             `xml:"urn:swift:xsd:sese.001.001.07 Id,omitempty"`
	Ctry    CountryCode                              `xml:"urn:swift:xsd:sese.001.001.07 Ctry,omitempty"`
	TpAndId SafekeepingPlaceTypeAndAnyBICIdentifier1 `xml:"urn:swift:xsd:sese.001.001.07 TpAndId,omitempty"`
	Prtry   GenericIdentification78                  `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type SecurityIdentification23Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:swift:xsd:sese.001.001.07 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:swift:xsd:sese.001.001.07 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:swift:xsd:sese.001.001.07 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:swift:xsd:sese.001.001.07 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:swift:xsd:sese.001.001.07 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:swift:xsd:sese.001.001.07 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:swift:xsd:sese.001.001.07 CTA,omitempty"`
	QUICK       string                                `xml:"urn:swift:xsd:sese.001.001.07 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:swift:xsd:sese.001.001.07 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:swift:xsd:sese.001.001.07 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:swift:xsd:sese.001.001.07 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:swift:xsd:sese.001.001.07 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:swift:xsd:sese.001.001.07 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:swift:xsd:sese.001.001.07 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification7      `xml:"urn:swift:xsd:sese.001.001.07 OthrPrtryId,omitempty"`
}
...
type TaxType1Choice struct {
	Cd    TaxType16Code           `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type TransferReason1 struct {
	Cd    TransferReason1Code     `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification27 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type TypeOfPrice31Choice struct {
	Cd    TypeOfPrice12Code       `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
...
type WaivingInstruction1Choice struct {
	Cd    WaivingInstruction1Code `xml:"urn:swift:xsd:sese.001.001.07 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:sese.001.001.07 Prtry,omitempty"`
}
