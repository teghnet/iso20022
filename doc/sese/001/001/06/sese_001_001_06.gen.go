...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 DmstIdSrc,omitempty"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 PrtryIdSrc,omitempty"`
}
...
type ChargeBasisType1Choice struct {
	Cd    TaxationBasis2Code      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type ChargePaymentMethod1Choice struct {
	Cd    ChargePaymentMethod1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47  `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type ChargeType4Choice struct {
	Cd    ChargeType12Code        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type CommissionBasis1Choice struct {
	Cd    TaxationBasis4Code      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}

type CommissionType3Choice struct {
	Cd    CommissionType7Code     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Dt,omitempty"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 DtTm,omitempty"`
}

type DateFormat1Choice struct {
	Dt   ISODate             `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Dt,omitempty"`
	Cd   SettlementDate1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	DtTm ISODateTime         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 DtTm,omitempty"`
}
...
type ExemptionReason1Choice struct {
	Cd    TaxExemptReason1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type LongPostalAddress1Choice struct {
	Ustrd Max140Text                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Ustrd,omitempty"`
	Strd  StructuredLongPostalAddress1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Strd,omitempty"`
}
...
type PartyIdentification1Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 PrtryId,omitempty"`
	NmAndAdr NameAndAddress2        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 NmAndAdr,omitempty"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 BICOrBEI,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 NmAndAdr,omitempty"`
}
...
type Quantity13Choice struct {
	TtlUnitsNb      FinancialInstrumentQuantity1 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 TtlUnitsNb,omitempty"`
	PrtflTrfOutRate float64                      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 PrtflTrfOutRate,omitempty"`
}
...
type Role4Choice struct {
	Cd    InvestmentFundRole2Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 CTA,omitempty"`
	QUICK       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 OthrPrtryId,omitempty"`
}
...
type TaxType1Choice struct {
	Cd    TaxType16Code           `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type TransferReason1 struct {
	Cd    TransferReason1Code     `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification27 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
...
type UnitPrice12 struct {
	Tp              TypeOfPrice12Code                 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Tp,omitempty"`
	XtndedTp        Extended350Code                   `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 XtndedTp,omitempty"`
...
type WaivingInstruction1Choice struct {
	Cd    WaivingInstruction1Code `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Cd,omitempty"`
	Prtry GenericIdentification47 `xml:"urn:iso:std:iso:20022:tech:xsd:sese.001.001.06 Prtry,omitempty"`
}
