...
type CurrentYearType1Choice struct {
	CurYrTp       ISAType1Code    `xml:"urn:swift:xsd:sese.018.001.05 CurYrTp,omitempty"`
	XtndedCurYrTp Extended350Code `xml:"urn:swift:xsd:sese.018.001.05 XtndedCurYrTp,omitempty"`
}
...
type ISAPortfolio1Choice struct {
	ISA   ISAYearsOfIssue4 `xml:"urn:swift:xsd:sese.018.001.05 ISA,omitempty"`
	Prtfl Portfolio1       `xml:"urn:swift:xsd:sese.018.001.05 Prtfl,omitempty"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:swift:xsd:sese.018.001.05 Dmst,omitempty"`
	Prtry Max35Text   `xml:"urn:swift:xsd:sese.018.001.05 Prtry,omitempty"`
}
...
type PartyIdentification70Choice struct {
	AnyBIC   AnyBICIdentifier       `xml:"urn:swift:xsd:sese.018.001.05 AnyBIC,omitempty"`
	PrtryId  GenericIdentification1 `xml:"urn:swift:xsd:sese.018.001.05 PrtryId,omitempty"`
	NmAndAdr NameAndAddress5        `xml:"urn:swift:xsd:sese.018.001.05 NmAndAdr,omitempty"`
}
...
type PreviousYear1Choice struct {
	AllPrvsYrs   PreviousAll `xml:"urn:swift:xsd:sese.018.001.05 AllPrvsYrs,omitempty"`
	SpcfcPrvsYrs []ISOYear   `xml:"urn:swift:xsd:sese.018.001.05 SpcfcPrvsYrs,omitempty"`
}
...
type SecurityIdentification23Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:swift:xsd:sese.018.001.05 ISIN,omitempty"`
	SEDOL       string                                `xml:"urn:swift:xsd:sese.018.001.05 SEDOL,omitempty"`
	CUSIP       string                                `xml:"urn:swift:xsd:sese.018.001.05 CUSIP,omitempty"`
	RIC         RICIdentifier                         `xml:"urn:swift:xsd:sese.018.001.05 RIC,omitempty"`
	TckrSymb    TickerIdentifier                      `xml:"urn:swift:xsd:sese.018.001.05 TckrSymb,omitempty"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:swift:xsd:sese.018.001.05 Blmbrg,omitempty"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:swift:xsd:sese.018.001.05 CTA,omitempty"`
	QUICK       string                                `xml:"urn:swift:xsd:sese.018.001.05 QUICK,omitempty"`
	Wrtppr      string                                `xml:"urn:swift:xsd:sese.018.001.05 Wrtppr,omitempty"`
	Dtch        string                                `xml:"urn:swift:xsd:sese.018.001.05 Dtch,omitempty"`
	Vlrn        string                                `xml:"urn:swift:xsd:sese.018.001.05 Vlrn,omitempty"`
	SCVM        string                                `xml:"urn:swift:xsd:sese.018.001.05 SCVM,omitempty"`
	Belgn       string                                `xml:"urn:swift:xsd:sese.018.001.05 Belgn,omitempty"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:swift:xsd:sese.018.001.05 Cmon,omitempty"`
	OthrPrtryId AlternateSecurityIdentification7      `xml:"urn:swift:xsd:sese.018.001.05 OthrPrtryId,omitempty"`
}
