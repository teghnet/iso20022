...
type MarketIdentification1Choice struct {
	MktIdrCd MICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.038.001.01 MktIdrCd,omitempty"`
	Desc     Max35Text     `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.038.001.01 Desc,omitempty"`
}
...
type MarketType13Choice struct {
	Cd    MarketType8Code        `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.038.001.01 Cd,omitempty"`
